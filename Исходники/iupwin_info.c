...
{
  //zero 17-jun-2010 - breaks win9x, change to late bound
  HMODULE kernel32 = LoadLibrary("kernel32.dll");
  typedef LANGID (WINAPI *getSystemDefaultUILanguageProc)();
  getSystemDefaultUILanguageProc getSystemDefaultUILanguage = (getSystemDefaultUILanguageProc)GetProcAddress(kernel32,"GetSystemDefaultUILanguage");
  LANGID id;
  char *lang = "Language Unknown in Win9X";
