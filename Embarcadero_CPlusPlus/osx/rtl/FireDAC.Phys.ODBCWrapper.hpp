...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.ODBCWrapper.pas' rev: 34.00 (MacOS)
...
#else /* __x86_64__ */
	__property unsigned long TransID = {read=FTransID, write=FTransID};
#endif /* __x86_64__ */
