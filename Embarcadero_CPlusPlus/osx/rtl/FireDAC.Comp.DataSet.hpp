...
// (DO NOT EDIT: machine generated header) 'FireDAC.Comp.DataSet.pas' rev: 34.00 (MacOS)
...
public:
	...
	virtual long __fastcall Write(const System::DynamicArray<System::Byte> ABuffer, long AOffset, long ACount)/* overload */;
#endif /* __x86_64__ */
	/* Hoisted overloads: */
