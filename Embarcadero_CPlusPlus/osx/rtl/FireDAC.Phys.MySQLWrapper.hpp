...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.MySQLWrapper.pas' rev: 34.00 (MacOS)
...
#else /* __x86_64__ */
	void __fastcall Connect(const System::UnicodeString host, const System::UnicodeString user, const System::UnicodeString passwd, const System::UnicodeString db, unsigned port, unsigned long clientflag);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	unsigned long __fastcall EscapeString(char * szTo, const char * szFrom, unsigned long length)/* overload */;
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	__property unsigned long Flags = {read=FFlags};
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	__property unsigned long MaxStringSize = {read=FMaxStringSize, write=FMaxStringSize};
#endif /* __x86_64__ */
public:
...
#else /* __x86_64__ */
	void __fastcall GetInfo(char * &name, char * &srcname, char * &table, char * &db, System::Byte &type_, unsigned long &length, unsigned long &flags, unsigned long &decimals, unsigned long &charsetnr, bool AMaxLenValid);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	bool __fastcall GetFieldData(int AIndex, /* out */ void * &ApData, /* out */ unsigned long &ALen);
	bool __fastcall GetData(int AIndex, void * &ApData, /* out */ unsigned long &ALen, Firedac::Stan::Intf::TFDDataType AType, Firedac::Stan::Intf::TFDDataAttributes AAttrs);
#endif /* __x86_64__ */
...
private:
	...
	void __fastcall SetDataSize(const unsigned long AValue);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	void __fastcall SetBuffer(System::PByte ABuff, unsigned long ALength);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	bool __fastcall GetData(void * &ApData, /* out */ unsigned long &ALen, bool AByRef = false)/* overload */;
	void __fastcall SetData(void * ApData, unsigned long ALen)/* overload */;
	unsigned long __fastcall GetDataTypeSize(int AType, unsigned long ASize);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	__property unsigned long DataSize = {read=GetDataSize, write=SetDataSize};
#endif /* __x86_64__ */
...
private:
	...
	unsigned FBlobOff;
#else /* __x86_64__ */
	unsigned long FDataOff;
	unsigned long FDataLen;
	unsigned long FBlobOff;
#endif /* __x86_64__ */
	System::Byte *FBuff;
#ifndef __x86_64__
	unsigned FBuffSize;
...
public:
	...
	long __fastcall ReadStr(void * ABuff, long ALen, Firedac::Stan::Intf::TFDDataType AType);
	long __fastcall WriteStr(void * ABuff, long ALen, Firedac::Stan::Intf::TFDDataType AType);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	unsigned long __fastcall GetParamCount();
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	unsigned long __fastcall GetLongAttr(const int AIndex);
	void __fastcall SetLongAttr(const int AIndex, const unsigned long AValue);
#endif /* __x86_64__ */
...
#else /* __x86_64__ */
	__property unsigned long ParamCount = {read=GetParamCount};
#endif /* __x86_64__ */
	__property unsigned FieldCount = {read=GetFieldCount, nodefault};
...
#else /* __x86_64__ */
	__property unsigned long CURSOR_TYPE = {read=GetLongAttr, write=SetLongAttr, index=1};
	__property unsigned long PREFETCH_ROWS = {read=GetLongAttr, write=SetLongAttr, index=2};
#endif /* __x86_64__ */
};
