...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.SQLiteWrapper.pas' rev: 34.00 (MacOS)
...
private:
	__CFLocale *FLocaleID;
#ifndef __x86_64__
	unsigned FFlags;
#else /* __x86_64__ */
	unsigned long FFlags;
#endif /* __x86_64__ */
	CFLocaleRef __fastcall GetLocaleID();
	void __fastcall SetLocaleID(const CFLocaleRef AValue);
...
public:
	...
	__property CFLocaleRef LocaleID = {read=GetLocaleID, write=SetLocaleID};
#ifndef __x86_64__
	__property unsigned Flags = {read=FFlags, write=FFlags, nodefault};
#else /* __x86_64__ */
	__property unsigned long Flags = {read=FFlags, write=FFlags};
#endif /* __x86_64__ */
public:
