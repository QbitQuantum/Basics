...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.MSSQLWrapper.pas' rev: 34.00 (MacOS)
...
#else /* __x86_64__ */
	__fastcall TMSSQLFileStream(TMSSQLToolLib* ALib, const System::UnicodeString ABlobPath, const System::RawByteString AToken, Firedac::Stan::Intf::TFDStreamMode AMode, unsigned long AOptions, System::TObject* AOwningObj)/* overload */;
#endif /* __x86_64__ */
