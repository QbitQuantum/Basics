...
// (DO NOT EDIT: machine generated header) 'Xml.Internal.WideStringUtils.pas' rev: 34.00 (Android)
...
#else /* __aarch64__ */
	virtual void __fastcall AddUCS4Char(const long CodePoint);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	virtual void __fastcall SetCapacity(long NewCapacity);
	virtual void __fastcall SetSize(const __int64 NewSize)/* overload */;
	void __fastcall SetStringPosition(long Value);
	long __fastcall GetStringPosition();
	void __fastcall SetStringLength(long Value);
	long __fastcall GetStringLength();
#endif /* __aarch64__ */
...
public:
	...
	System::WideString __fastcall ReadString(long Count);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	__property long Capacity = {read=FCapacity, write=SetCapacity};
	__property long StringLength = {read=GetStringLength, write=SetStringLength};
	__property long StringPosition = {read=GetStringPosition, write=SetStringPosition};
#endif /* __aarch64__ */
