...
// (DO NOT EDIT: machine generated header) 'IdMessageCoder.pas' rev: 34.00 (Android)
...
public:
	...
	System::UnicodeString __fastcall ReadLn(const System::UnicodeString ATerminator = u"\n", Idglobal::_di_IIdTextEncoding AByteEncoding = Idglobal::_di_IIdTextEncoding());
