...
// (DO NOT EDIT: machine generated header) 'TestFramework.pas' rev: 34.00 (Android)
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetPackageName(void);
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetApplicationLabel(void);
