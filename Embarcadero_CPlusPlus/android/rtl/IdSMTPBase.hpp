...
// (DO NOT EDIT: machine generated header) 'IdSMTPBase.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr bool DEF_SMTP_PIPELINE = false;
static constexpr bool IdDEF_UseEhlo = true;
static constexpr bool IdDEF_UseVerp = false;
#define CAPAPIPELINE u"PIPELINING"
#define CAPAVERP u"VERP"
#define XMAILER_HEADER u"X-Mailer"
...
#define RSET_CMD u"RSET"
#define MAILFROM_CMD u"MAIL FROM:"
#define RCPTTO_CMD u"RCPT TO:"
#define DATA_CMD u"DATA"
}	/* namespace Idsmtpbase */
