...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.DSProxyCpp.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Firedac_Phys_Dsproxycpp);
}	/* namespace Dsproxycpp */
}	/* namespace Phys */
}	/* namespace Firedac */
...
//-- var, const, procedure ---------------------------------------------------
#define sCPlusPlusBuilderFireDACProxyWriter u"C++Builder FireDAC"
}	/* namespace Dsproxycpp */
}	/* namespace Phys */
}	/* namespace Firedac */
