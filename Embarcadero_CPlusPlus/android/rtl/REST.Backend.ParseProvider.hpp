...
// (DO NOT EDIT: machine generated header) 'REST.Backend.ParseProvider.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Rest_Backend_Parseprovider);
}	/* namespace Parseprovider */
}	/* namespace Backend */
}	/* namespace Rest */
...
public:
	...
	private:
		#define TCustomParseConnectionInfo_TAndroidPush_cDefaultGCMAppID u"1076345567071"
...
public:
	#define TCustomParseProvider_ProviderID u"Parse"
