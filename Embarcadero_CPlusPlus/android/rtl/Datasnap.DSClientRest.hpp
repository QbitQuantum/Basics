...
// (DO NOT EDIT: machine generated header) 'Datasnap.DSClientRest.pas' rev: 34.00 (Android)
...
public:
	#define TDSCustomRestConnection_sCacheContext u"cache/"
	
	#define TDSCustomRestConnection_sRESTContext u"rest/"
	
	#define TDSCustomRestConnection_sContext u"datasnap/"
	
	#define TDSCustomRestConnection_sHttp u"http"
