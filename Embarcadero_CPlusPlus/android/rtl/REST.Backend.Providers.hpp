...
// (DO NOT EDIT: machine generated header) 'REST.Backend.Providers.pas' rev: 34.00 (Android)
...
namespace Providers
{
  _INIT_UNIT(Rest_Backend_Providers);
}	/* namespace Providers */
}	/* namespace Backend */
}	/* namespace Rest */
...
template<typename TI, typename T> class DELPHICLASS _TBackendServiceComponent__2_Create_ActRec;
template<typename T> class DELPHICLASS _TBackendAPIThread__1_CreateThread_ActRec;
//-- type declarations -------------------------------------------------------
