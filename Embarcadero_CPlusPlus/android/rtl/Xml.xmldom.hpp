...
// (DO NOT EDIT: machine generated header) 'Xml.xmldom.pas' rev: 34.00 (Android)
...
__interface  INTERFACE_UUID("{2BF4C0F1-096E-11D4-83DA-00C04F60B2DD}") IDOMPersist  : public System::IInterface 
{
	...
	virtual HRESULT __safecall loadFromStream(const System::Types::_di_IStream stream, System::WordBool &__loadFromStream_result) = 0 /* overload */;
	virtual HRESULT __safecall saveToStream(const System::Types::_di_IStream stream) = 0 /* overload */;
	#pragma option push -w-inl
	/* safecall wrapper */ inline System::UnicodeString _scw_get_xml() { System::UnicodeString __r; HRESULT __hr = get_xml(__r); System::CheckSafecallResult(__hr); return __r; }
	#pragma option pop
	__property System::UnicodeString xml = {read=_scw_get_xml};
