...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Intf.pas' rev: 34.00 (Android)
...
public:
	...
	static constexpr System::Int8 Oracle = System::Int8(0x1);
	
	static constexpr System::Int8 MSSQL = System::Int8(0x2);
	
	static constexpr System::Int8 MSAccess = System::Int8(0x3);
	
	static constexpr System::Int8 MySQL = System::Int8(0x4);
	
	static constexpr System::Int8 DB2 = System::Int8(0x5);
	
	static constexpr System::Int8 SQLAnywhere = System::Int8(0x6);
	
	static constexpr System::Int8 Advantage = System::Int8(0x7);
	
	static constexpr System::Int8 Interbase = System::Int8(0x8);
	
	static constexpr System::Int8 Firebird = System::Int8(0x9);
	
	static constexpr System::Int8 SQLite = System::Int8(0xa);
	
	static constexpr System::Int8 PostgreSQL = System::Int8(0xb);
	
	static constexpr System::Int8 NexusDB = System::Int8(0xc);
	
	static constexpr System::Int8 DataSnap = System::Int8(0xd);
	
	static constexpr System::Int8 Informix = System::Int8(0xe);
	
	static constexpr System::Int8 Teradata = System::Int8(0xf);
	
	static constexpr System::Int8 MongoDB = System::Int8(0x10);
	
	static constexpr System::Int8 Other = System::Int8(0x11);
...
_DECLARE_ARITH_TYPE_ALIAS(int, TFDRDBMSKind);
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word varFDAString = System::Word(0x100);
extern DELPHI_PACKAGE __int64 C_FD_MaxInt64;
extern DELPHI_PACKAGE __int64 C_FD_MinInt64;
static constexpr System::Int8 C_FD_MaxUTF8Len = System::Int8(0x3);
static constexpr System::Int8 C_FD_Alignment = System::Int8(0x4);
static constexpr System::Word C_FD_MonitorPort = System::Word(0x1f72);
static constexpr System::Word C_FD_MonitorTimeout = System::Word(0xbb8);
#define C_FD_MonitorFileName u"$(TEMP)/trace$(NEXT).txt"
static constexpr bool C_FD_MonitorAppend = false;
...
static constexpr System::Int8 C_FD_MonitorEncoding = System::Int8(0x0);
