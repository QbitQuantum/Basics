...
// (DO NOT EDIT: machine generated header) 'System.IniFiles.pas' rev: 34.00 (Android)
...
#pragma pack(push,4)
#endif /* not __aarch64__ */
class PASCALIMPLEMENTATION TIniFile : public TMemIniFile
{
	typedef TMemIniFile inherited;
	
public:
	__fastcall virtual TIniFile(const System::UnicodeString FileName, System::Sysutils::TEncoding* const Encoding, bool CaseSensitive, bool UseLocale)/* overload */;
public:
	/* TMemIniFile.Create */ inline __fastcall TIniFile(const System::UnicodeString FileName)/* overload */ : TMemIniFile(FileName) { }
	/* TMemIniFile.Create */ inline __fastcall TIniFile(const System::UnicodeString FileName, System::Sysutils::TEncoding* const Encoding)/* overload */ : TMemIniFile(FileName, Encoding) { }
	/* TMemIniFile.Create */ inline __fastcall TIniFile(const System::UnicodeString FileName, System::Sysutils::TEncoding* const Encoding, bool CaseSensitive)/* overload */ : TMemIniFile(FileName, Encoding, CaseSensitive) { }
	/* TMemIniFile.Create */ inline __fastcall virtual TIniFile(System::Classes::TStream* Stream, System::Sysutils::TEncoding* const Encoding, bool CaseSensitive, bool UseLocale)/* overload */ : TMemIniFile(Stream, Encoding, CaseSensitive, UseLocale) { }
	/* TMemIniFile.Destroy */ inline __fastcall virtual ~TIniFile() { }
