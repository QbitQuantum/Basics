...
// (DO NOT EDIT: machine generated header) 'System.TimeSpan.pas' rev: 34.00 (Android)
...
private:
	...
	static constexpr System::Word MillisPerSecond = System::Word(0x3e8);
	
	static constexpr System::Word MillisPerMinute = System::Word(0xea60);
	
	static constexpr int MillisPerHour = int(0x36ee80);
	
	static constexpr int MillisPerDay = int(0x5265c00);
	
	static constexpr __int64 MaxSeconds = 0x000000d6bf94d5e5LL;
	
	static constexpr __int64 MinSeconds = -0x000000d6bf94d5e5LL;
	
	static constexpr __int64 MaxMilliseconds = 0x000346dc5d638865LL;
	
	static constexpr __int64 MinMilliseconds = -0x000346dc5d638865LL;
	
	
public:
	static constexpr System::Word TicksPerMillisecond = System::Word(0x2710);
	
	static constexpr __int64 TicksPerSecond = 0x0000000000989680LL;
	
	static constexpr __int64 TicksPerMinute = 0x0000000023c34600LL;
	
	static constexpr __int64 TicksPerHour = 0x0000000861c46800LL;
	
	static constexpr __int64 TicksPerDay = 0x000000c92a69c000LL;
