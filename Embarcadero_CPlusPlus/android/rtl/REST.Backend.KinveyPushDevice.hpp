...
// (DO NOT EDIT: machine generated header) 'REST.Backend.KinveyPushDevice.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Rest_Backend_Kinveypushdevice);
}	/* namespace Kinveypushdevice */
}	/* namespace Backend */
}	/* namespace Rest */
...
private:
	#define TKinveyPushDeviceAPI_sKinvey u"Kinvey"
