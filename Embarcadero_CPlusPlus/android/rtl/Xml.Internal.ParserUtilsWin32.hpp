...
// (DO NOT EDIT: machine generated header) 'Xml.Internal.ParserUtilsWin32.pas' rev: 34.00 (Android)
...
#ifndef __aarch64__
	virtual bool __fastcall Read(void *Buf, const int Count);
#else /* __aarch64__ */
...
protected:
	...
	virtual void __fastcall SetPosition(__int64 Value);
#ifndef __aarch64__
	virtual void __fastcall Write(const void *Buf, const int Count);
#else /* __aarch64__ */
...
#ifndef __aarch64__
	virtual void __fastcall ReadEventHandler(System::TObject* const Sender, void *Buf, int Count, bool &Ok);
#else /* __aarch64__ */
...
protected:
	bool FBusy;
#ifndef __aarch64__
	virtual void __fastcall CodecReadEventHandler(System::TObject* const Sender, void *Buf, int Count, bool &Ok);
	virtual void __fastcall CodecWriteEventHandler(System::TObject* const Sender, const void *Buf, int Count);
#else /* __aarch64__ */
