...
// (DO NOT EDIT: machine generated header) 'IdRawBase.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Int8 Id_TIdRawBase_Port = System::Int8(0x0);
static constexpr System::Word Id_TIdRawBase_BufferSize = System::Word(0x2000);
static constexpr System::Int8 GReceiveTimeout = System::Int8(0x0);
static constexpr System::Byte GFTTL = System::Byte(0x80);
}	/* namespace Idrawbase */
