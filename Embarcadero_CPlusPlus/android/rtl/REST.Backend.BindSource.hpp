...
// (DO NOT EDIT: machine generated header) 'REST.Backend.BindSource.pas' rev: 34.00 (Android)
...
template<typename TI, typename T> class DELPHICLASS _TBackendBindSourceComponent__2_Create_ActRec;
//-- type declarations -------------------------------------------------------
#ifndef __aarch64__
#pragma pack(push,4)
