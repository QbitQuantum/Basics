...
// (DO NOT EDIT: machine generated header) 'Datasnap.DSProxyWriter.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
#define sDSProxyDelphiLanguage u"Delphi"
#define sDSProxyCppLanguage u"C++"
#define sDSProxyJavaScriptLanguage u"Java Script"
}	/* namespace Dsproxywriter */
}	/* namespace Datasnap */
