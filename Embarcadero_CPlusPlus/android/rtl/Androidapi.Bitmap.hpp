...
// (DO NOT EDIT: machine generated header) 'Androidapi.Bitmap.pas' rev: 34.00 (Android)

#ifndef Androidapi_BitmapHPP
#define Androidapi_BitmapHPP
...
//-- type declarations -------------------------------------------------------
typedef AndroidBitmapInfo *PAndroidBitmapInfo;
...
static constexpr System::Int8 ANDROID_BITMAP_RESUT_SUCCESS = System::Int8(0x0);
}	/* namespace Bitmap */
}	/* namespace Androidapi */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ANDROIDAPI_BITMAP)
using namespace Androidapi::Bitmap;
#endif
