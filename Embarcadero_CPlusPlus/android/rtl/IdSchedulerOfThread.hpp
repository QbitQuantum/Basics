...
// (DO NOT EDIT: machine generated header) 'IdSchedulerOfThread.pas' rev: 34.00 (Android)
...
protected:
	int FMaxThreads;
	Idglobal::TIdThreadPriority FThreadPriority;
...
__published:
	...
	__property Idglobal::TIdThreadPriority ThreadPriority = {read=FThreadPriority, write=FThreadPriority, default=0};
public:
