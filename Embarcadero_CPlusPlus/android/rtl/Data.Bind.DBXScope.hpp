...
// (DO NOT EDIT: machine generated header) 'Data.Bind.DBXScope.pas' rev: 34.00 (Android)
...
template<typename T> class DELPHICLASS _TCustomParamsAdapter_MakeParamField_ActRec__1;
//-- type declarations -------------------------------------------------------
#ifndef __aarch64__
#pragma pack(push,4)
