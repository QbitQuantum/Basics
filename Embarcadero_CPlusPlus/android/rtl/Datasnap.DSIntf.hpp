...
// (DO NOT EDIT: machine generated header) 'Datasnap.DSIntf.pas' rev: 34.00 (Android)
...
_DECLARE_ARITH_TYPE_ALIAS(System::Byte, DSAttr);
...
_DECLARE_ARITH_TYPE_ALIAS(int, hDSAggregate);
...
_DECLARE_ARITH_TYPE_ALIAS(int, SAVEPOINT);
...
public:
	...
	MIDASPATH szName;
	System::StaticArray<System::Byte, 3> szMorePad;
};
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Int8 dsRecUnmodified = System::Int8(0x0);
static constexpr System::Int8 dsRecOrg = System::Int8(0x1);
static constexpr System::Int8 dsRecDeleted = System::Int8(0x2);
static constexpr System::Int8 dsRecNew = System::Int8(0x4);
static constexpr System::Int8 dsRecModified = System::Int8(0x8);
static constexpr System::Int8 dsUnused = System::Int8(0x20);
static constexpr System::Int8 dsDetUpd = System::Int8(0x40);
static constexpr System::Int8 dsIsNotVisible = System::Int8(0x23);
static constexpr System::Int8 dsIsVisible = System::Int8(-36);
static constexpr System::Int8 fldAttrHIDDEN = System::Int8(0x1);
static constexpr System::Int8 fldAttrREADONLY = System::Int8(0x2);
static constexpr System::Int8 fldAttrREQUIRED = System::Int8(0x4);
static constexpr System::Int8 fldAttrLINK = System::Int8(0x8);
static constexpr System::Int8 BLANK_NULL = System::Int8(0x1);
static constexpr System::Int8 BLANK_NOTCHANGED = System::Int8(0x2);
static constexpr System::Int8 MAXKEYFIELDS = System::Int8(0x10);
static constexpr System::Int8 mdCASCADEDEL = System::Int8(0x4);
static constexpr System::Int8 mdCASCADEMOD = System::Int8(0x8);
static constexpr System::Int8 mdALLOWLINKCHANGE = System::Int8(0x10);
static constexpr System::Int8 dscbrSKIP = System::Int8(0x1);
static constexpr System::Int8 dscbrABORT = System::Int8(0x2);
static constexpr System::Int8 dscbrMERGE = System::Int8(0x3);
static constexpr System::Int8 dscbrAPPLY = System::Int8(0x4);
static constexpr System::Int8 dscbrIGNORE = System::Int8(0x5);
static constexpr System::Int8 dscbrCORRECT = System::Int8(0x4);
static constexpr System::Int8 dscbrCANCEL = System::Int8(0x5);
static constexpr System::Int8 dscbrREFRESH = System::Int8(0x6);
static constexpr System::Int8 xmlUNTYPED = System::Int8(0x1);
static constexpr System::Int8 xmlXMLDATATYPED = System::Int8(0x2);
static constexpr System::Int8 xmlXMLSCHEMA = System::Int8(0x4);
static constexpr System::Int8 xmlXMLUTF8 = System::Int8(0x8);
static constexpr System::Int8 xmlON = System::Int8(0x5);
static constexpr System::Int8 xmlUTF8 = System::Int8(0xd);
static constexpr System::Int8 xmlOFF = System::Int8(0x0);
#define szUNIQUE_KEY u"UNIQUE_KEY"
#define szPRIMARY_KEY u"PRIMARY_KEY"
#define szDEFAULT_ORDER u"DEFAULT_ORDER"
#define szCHANGEINDEX u"CHANGEINDEX"
#define szCHANGE_LOG u"CHANGE_LOG"
#define szSERVER_COL u"SERVER_COL"
#define szCONSTRAINTS u"CONSTRAINTS"
#define szDATASET_CONTEXT u"DATASET_CONTEXT"
#define szDATASET_DELTA u"DATASET_DELTA"
#define szREADONLY u"READONLY"
#define szSUBTYPE u"SUBTYPE"
#define szDECIMALS u"DECIMALS"
#define szWIDTH u"WIDTH"
#define szFIELDNAME u"FIELDNAME"
#define szLCID u"LCID"
#define szBDEDOMX u"BDEDOMAIN_X"
#define szBDERECX u"BDERECORD_X"
#define szBDEDEFX u"BDEDEFAULT_X"
#define szAUTOINCVALUE u"AUTOINCVALUE"
#define szELEMENTS u"ELEMENTS"
#define szTABLE_NAME u"TABLE_NAME"
#define szMD_FIELDLINKS u"MD_FIELDLINKS"
#define szTYPENAME u"TYPENAME"
#define szUPDATEMODE u"UPDATEMODE"
#define szFIELDPROPS u"FIELDPROPS"
#define szPROVFLAGS u"PROVFLAGS"
#define szORIGIN u"ORIGIN"
#define szMD_SEMANTICS u"MD_SEMANTICS"
#define szSERVERCALC u"SERVER_CALC"
#define szBDEDOMCL u"BDEDOMAIN_CL"
#define szBDERECCL u"BDERECORD_CL"
#define szBDEDEFCL u"BDEDEFAULT_CL"
#define szDISABLE_INSERTS u"DISABLE_INSERTS"
#define szDISABLE_DELETES u"DISABLE_DELETES"
#define szDISABLE_EDITS u"DISABLE_EDITS"
#define szNO_RESET_CALL u"NO_RESET_CALL"
#define szMINVALUE u"MINVALUE"
#define szMAXVALUE u"MAXVALUE"
#define szstMEMO u"Text"
#define szstWideMEMO u"WideText"
#define szstBINARY u"Binary"
#define szstFMTMEMO u"Formatted"
#define szstOLEOBJ u"Ole"
#define szstGRAPHIC u"Graphics"
#define szstDBSOLEOBJ u"dBASEOle"
#define szstTYPEDBINARY u"TypedBinary"
#define szstMONEY u"Money"
#define szstAUTOINC u"Autoinc"
#define szstADTNESTEDTABLE u"ADTNestedTable"
#define szstFIXEDCHAR u"FixedChar"
#define szstREFNESTEDTABLE u"Reference"
#define szstGUID u"Guid"
#define szstACCOLEOBJ u"AccessOle"
#define szstHMEMO u"HMemo"
#define szstHBINARY u"HBinary"
static constexpr System::Int8 fldstReference = System::Int8(0x46);
static constexpr System::Int8 dsfldUNKNOWN = System::Int8(0x0);
static constexpr System::Int8 dsfldINT = System::Int8(0x1);
static constexpr System::Int8 dsfldUINT = System::Int8(0x2);
static constexpr System::Int8 dsfldBOOL = System::Int8(0x3);
static constexpr System::Int8 dsfldFLOATIEEE = System::Int8(0x4);
static constexpr System::Int8 dsfldBCD = System::Int8(0x5);
static constexpr System::Int8 dsfldDATE = System::Int8(0x6);
static constexpr System::Int8 dsfldTIME = System::Int8(0x7);
static constexpr System::Int8 dsfldTIMESTAMP = System::Int8(0x8);
static constexpr System::Int8 dsfldZSTRING = System::Int8(0x9);
static constexpr System::Int8 dsfldUNICODE = System::Int8(0xa);
static constexpr System::Int8 dsfldBYTES = System::Int8(0xb);
static constexpr System::Int8 dsfldADT = System::Int8(0xc);
static constexpr System::Int8 dsfldARRAY = System::Int8(0xd);
static constexpr System::Int8 dsfldEMBEDDEDTBL = System::Int8(0xe);
static constexpr System::Int8 dsfldREF = System::Int8(0xf);
static constexpr System::Int8 dsfldDATETIME = System::Int8(0x11);
static constexpr System::Int8 dsfldFMTBCD = System::Int8(0x12);
static constexpr System::Int8 dsfldSINGLE = System::Int8(0x1b);
static constexpr System::Int8 dsfldDATETIMEOFFSET = System::Int8(0x24);
static constexpr System::Int8 dsSizeBitsLen = System::Int8(0x10);
static constexpr System::Word dsSizeBitsMask = System::Word(0xffff);
static constexpr int dsTypeBitsMask = int(0x3f0000);
static constexpr int dsVaryingFldType = int(0x400000);
static constexpr int dsArrayFldType = int(0x800000);
static constexpr int dsPseudoFldType = int(0x1000000);
static constexpr int dsCompArrayFldType = int(0x2000000);
static constexpr int dsEmbeddedFldType = int(0x4000000);
static constexpr unsigned dsIncInDelta = unsigned(0x80000000);
static constexpr System::Word dskeyCASEINSENSITIVE = System::Word(0x4000);
static constexpr System::Word dskeyDESCENDING = System::Word(0x8000);
static constexpr unsigned dsDELAYEDBIT = unsigned(0x80000000);
static constexpr System::Int8 PACKETVERSION_1 = System::Int8(0x1);
static constexpr System::Int8 PACKETVERSION_2 = System::Int8(0x2);
static constexpr System::Int8 PACKETVERSION_3 = System::Int8(0x3);
static constexpr System::Int8 dsCASCADEDELETES = System::Int8(0x1);
static constexpr System::Int8 dsCASCADEUPDATES = System::Int8(0x2);
static constexpr System::Int8 fldUNKNOWN = System::Int8(0x0);
static constexpr System::Int8 fldZSTRING = System::Int8(0x1);
static constexpr System::Int8 fldDATE = System::Int8(0x2);
static constexpr System::Int8 fldBLOB = System::Int8(0x3);
static constexpr System::Int8 fldBOOL = System::Int8(0x4);
static constexpr System::Int8 fldINT16 = System::Int8(0x5);
static constexpr System::Int8 fldINT32 = System::Int8(0x6);
static constexpr System::Int8 fldFLOAT = System::Int8(0x7);
static constexpr System::Int8 fldBCD = System::Int8(0x8);
static constexpr System::Int8 fldBYTES = System::Int8(0x9);
static constexpr System::Int8 fldTIME = System::Int8(0xa);
static constexpr System::Int8 fldTIMESTAMP = System::Int8(0xb);
static constexpr System::Int8 fldUINT16 = System::Int8(0xc);
static constexpr System::Int8 fldUINT32 = System::Int8(0xd);
static constexpr System::Int8 fldFLOATIEEE = System::Int8(0xe);
static constexpr System::Int8 fldVARBYTES = System::Int8(0xf);
static constexpr System::Int8 fldLOCKINFO = System::Int8(0x10);
static constexpr System::Int8 fldCURSOR = System::Int8(0x11);
static constexpr System::Int8 fldINT64 = System::Int8(0x12);
static constexpr System::Int8 fldUINT64 = System::Int8(0x13);
static constexpr System::Int8 fldADT = System::Int8(0x14);
static constexpr System::Int8 fldARRAY = System::Int8(0x15);
static constexpr System::Int8 fldREF = System::Int8(0x16);
static constexpr System::Int8 fldTABLE = System::Int8(0x17);
static constexpr System::Int8 fldDATETIME = System::Int8(0x18);
static constexpr System::Int8 fldFMTBCD = System::Int8(0x19);
static constexpr System::Int8 fldWIDESTRING = System::Int8(0x1a);
static constexpr System::Int8 MAXLOGFLDTYPES = System::Int8(0x1b);
static constexpr System::Word fldUNICODE = System::Word(0x1007);
static constexpr System::Int8 fldINT8 = System::Int8(0x1c);
static constexpr System::Int8 fldUINT8 = System::Int8(0x1d);
static constexpr System::Int8 fldSINGLE = System::Int8(0x1b);
static constexpr System::Int8 fldDATETIMEOFFSET = System::Int8(0x24);
static constexpr System::Int8 fldstMONEY = System::Int8(0x15);
static constexpr System::Int8 fldstMEMO = System::Int8(0x16);
static constexpr System::Int8 fldstBINARY = System::Int8(0x17);
static constexpr System::Int8 fldstFMTMEMO = System::Int8(0x18);
static constexpr System::Int8 fldstOLEOBJ = System::Int8(0x19);
static constexpr System::Int8 fldstGRAPHIC = System::Int8(0x1a);
static constexpr System::Int8 fldstDBSOLEOBJ = System::Int8(0x1b);
static constexpr System::Int8 fldstTYPEDBINARY = System::Int8(0x1c);
static constexpr System::Int8 fldstACCOLEOBJ = System::Int8(0x1e);
static constexpr System::Int8 fldstWIDEMEMO = System::Int8(0x20);
static constexpr System::Int8 fldstHMEMO = System::Int8(0x21);
static constexpr System::Int8 fldstHBINARY = System::Int8(0x22);
static constexpr System::Int8 fldstBFILE = System::Int8(0x24);
static constexpr System::Int8 fldstPASSWORD = System::Int8(0x1);
static constexpr System::Int8 fldstFIXED = System::Int8(0x1f);
static constexpr System::Int8 fldstGUID = System::Int8(0x26);
static constexpr System::Int8 fldstORAINTERVAL = System::Int8(0x28);
static constexpr System::Int8 fldstORATIMESTAMP = System::Int8(0x27);
static constexpr System::Int8 fldstAUTOINC = System::Int8(0x1d);
...
static constexpr System::Int8 DBERR_NONE = System::Int8(0x0);
static constexpr System::Word DBERR_BOF = System::Word(0x2201);
static constexpr System::Word DBERR_EOF = System::Word(0x2202);
static constexpr System::Word DBERR_NOSUCHINDEX = System::Word(0x270d);
static constexpr System::Int8 ERRCAT_ALC = System::Int8(0x40);
static constexpr System::Word ERRBASE_ALC = System::Word(0x4000);
static constexpr System::Int8 ERRCODE_DELTAISEMPTY = System::Int8(0x1);
static constexpr System::Int8 ERRCODE_NOTHINGTOUNDO = System::Int8(0x2);
static constexpr System::Int8 ERRCODE_NOMETADATA = System::Int8(0x3);
static constexpr System::Int8 ERRCODE_CANNOTAPPEND = System::Int8(0x4);
static constexpr System::Int8 ERRCODE_DATAPACKETMISMATCH = System::Int8(0x5);
static constexpr System::Int8 ERRCODE_ABORTED = System::Int8(0x6);
static constexpr System::Int8 ERRCODE_CANCELLED = System::Int8(0x7);
static constexpr System::Int8 ERRCODE_NEWERVERSIONREQ = System::Int8(0x8);
static constexpr System::Int8 ERRCODE_BLOBNOTFETCHED = System::Int8(0x9);
static constexpr System::Int8 ERRCODE_DETAILSNOTFETCHED = System::Int8(0xa);
static constexpr System::Int8 ERRCODE_NOMASTERRECORD = System::Int8(0xb);
static constexpr System::Int8 ERRCODE_LINKFIELDSNOTUNIQUE = System::Int8(0xc);
static constexpr System::Int8 ERRCODE_FLYAWAY_WRONGORDER = System::Int8(0xd);
static constexpr System::Int8 ERRCODE_NOCASCADEDUPDATES = System::Int8(0xe);
static constexpr System::Word DBERR_DELTAISEMPTY = System::Word(0x4001);
static constexpr System::Word DBERR_NOTHINGTOUNDO = System::Word(0x4002);
static constexpr System::Word DBERR_NOMETADATA = System::Word(0x4003);
static constexpr System::Word DBERR_CANNOTAPPEND = System::Word(0x4004);
static constexpr System::Word DBERR_DATAPACKETMISMATCH = System::Word(0x4005);
static constexpr System::Word DBERR_ABORTED = System::Word(0x4006);
static constexpr System::Word DBERR_CANCELLED = System::Word(0x4007);
static constexpr System::Word DBERR_NEWERVERSIONREQ = System::Word(0x4008);
static constexpr System::Word DBERR_BLOBNOTFETCHED = System::Word(0x4009);
static constexpr System::Word DBERR_DETAILSNOTFETCHED = System::Word(0x400a);
static constexpr System::Word DBERR_NOMASTERRECORD = System::Word(0x400b);
static constexpr System::Word DBERR_LINKFIELDSNOTUNIQUE = System::Word(0x400c);
static constexpr System::Word DBERR_FLYAWAY_WRONGORDER = System::Word(0x400d);
static constexpr System::Word DBERR_NOCASCADEDUPDATES = System::Word(0x400e);
static constexpr System::Word ERRBASE_INVALIDREQ = System::Word(0x2700);
static constexpr System::Int8 ERRCODE_OUTOFRANGE = System::Int8(0x1);
static constexpr System::Word DBERR_OUTOFRANGE = System::Word(0x2701);
static constexpr HRESULT CLASS_E_CLASSNOTAVAILABLE = HRESULT(-2147221231);
static constexpr System::Int8 ERRCODE_OUTOFMEMORY = System::Int8(0x1);
static constexpr System::Int8 ERRCODE_INVALIDARG = System::Int8(0x2);
static constexpr System::Int8 ERRCODE_UNABLETOLOADICU = System::Int8(0x5);
