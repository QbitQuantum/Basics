...
// (DO NOT EDIT: machine generated header) 'IdSMTPRelay.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr bool DEF_OneConnectionPerDomain = true;
static const TIdSSLSupport DEF_SSL_SUPPORT = (TIdSSLSupport)(0);
static constexpr bool DEF_TRY_IMPLICITTLS = false;
static constexpr System::Int8 DEF_REPLY_CODE = System::Int8(0x0);
static constexpr bool DEF_SENT = false;
}	/* namespace Idsmtprelay */
