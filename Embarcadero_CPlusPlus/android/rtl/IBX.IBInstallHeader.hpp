...
// (DO NOT EDIT: machine generated header) 'IBX.IBInstallHeader.pas' rev: 34.00 (Android)
...
#ifndef __aarch64__
typedef int __fastcall (*FP_ERROR)(int IscCode, void * UserContext, const System::PByte ActionDescription);
#else /* __aarch64__ */
typedef int __fastcall (*FP_ERROR)(long IscCode, void * UserContext, const System::PByte ActionDescription);
#endif /* __aarch64__ */

typedef int __fastcall (*FP_STATUS)(int Status, void * UserContext, const System::PByte ActionDescription);

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_clear_options)(POPTIONS_HANDLE hOption);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_install_clear_options)(POPTIONS_HANDLE hOption);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_execute)(int hOption, System::PByte src_dir, System::PByte dest_dir, FP_STATUS status_func, void * status_data, FP_ERROR error_func, void * error_data, System::PByte uninstal_file_name);
#else /* __aarch64__ */
...
#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_get_info)(int info_type, int option, void * info_buffer, unsigned buf_len);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_install_get_info)(int info_type, long option, void * info_buffer, unsigned buf_len);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_get_message)(int hOption, int message_no, void * message_txt, unsigned message_len);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_install_get_message)(int hOption, long message_no, void * message_txt, unsigned message_len);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_load_external_text)(System::PByte msg_file_name);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_install_load_external_text)(System::PByte msg_file_name);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_precheck)(int hOption, System::PByte src_dir, System::PByte dest_dir);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_install_precheck)(int hOption, System::PByte src_dir, System::PByte dest_dir);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_set_option)(POPTIONS_HANDLE hOption, int option);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_install_set_option)(POPTIONS_HANDLE hOption, long option);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_uninstall_execute)(System::PByte uninstall_file_name, FP_STATUS status_func, void * status_data, FP_ERROR error_func, void * error_data);
#else /* __aarch64__ */
...
#ifndef __aarch64__
typedef int __cdecl (*Tisc_uninstall_precheck)(System::PByte uninstall_file_name);
#else /* __aarch64__ */
typedef long __cdecl (*Tisc_uninstall_precheck)(System::PByte uninstall_file_name);
#endif /* __aarch64__ */

#ifndef __aarch64__
typedef int __cdecl (*Tisc_install_unset_option)(POPTIONS_HANDLE hOption, int option);
#else /* __aarch64__ */
