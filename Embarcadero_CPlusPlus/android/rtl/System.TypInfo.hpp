...
// (DO NOT EDIT: machine generated header) 'System.TypInfo.pas' rev: 34.00 (Android)
...
#ifndef __aarch64__
static constexpr unsigned PROPSLOT_MASK = unsigned(0xff000000);
static constexpr unsigned PROPSLOT_FIELD = unsigned(0xff000000);
static constexpr unsigned PROPSLOT_VIRTUAL = unsigned(0xfe000000);
#else /* __aarch64__ */
static constexpr unsigned __int64 PROPSLOT_MASK = 0xff00000000000000ULL;
static constexpr unsigned __int64 PROPSLOT_FIELD = 0xff00000000000000ULL;
static constexpr unsigned __int64 PROPSLOT_VIRTUAL = 0xfe00000000000000ULL;
#endif /* __aarch64__ */
