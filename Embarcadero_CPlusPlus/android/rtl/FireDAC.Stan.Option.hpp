...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Option.pas' rev: 34.00 (Android)
...
#else /* __aarch64__ */
	__property unsigned long Version = {read=FVersion};
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	unsigned long __fastcall GetMaxStringSize();
#endif /* __aarch64__ */
	bool __fastcall IsMSSS();
#ifndef __aarch64__
	void __fastcall SetMaxStringSize(const unsigned AValue);
#else /* __aarch64__ */
	void __fastcall SetMaxStringSize(const unsigned long AValue);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	unsigned long __fastcall GetSortLocale();
#endif /* __aarch64__ */
	bool __fastcall IsSLS();
#ifndef __aarch64__
	void __fastcall SetSortLocale(const unsigned AValue);
#else /* __aarch64__ */
	void __fastcall SetSortLocale(const unsigned long AValue);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	void __fastcall ResolveDataType(const System::UnicodeString ASrcName, const System::UnicodeString ATypeName, Firedac::Stan::Intf::TFDDataType ASrcDataType, unsigned long ASrcSize, int ASrcPrec, int ASrcScale, Firedac::Stan::Intf::TFDDataType &ADestDataType, unsigned long &ADestSize, bool AForward);
	void __fastcall ResolveFieldType(const System::UnicodeString ASrcName, const System::UnicodeString ATypeName, Data::Db::TFieldType ASrcFieldType, Firedac::Stan::Intf::TFDDataType ASrcADFieldType, unsigned long ASrcSize, int ASrcPrecision, int ASrcScale, Data::Db::TFieldType &ADestFieldType, unsigned long &ADestSize, int &ADestPrecision, int &ADestScale, Firedac::Stan::Intf::TFDDataType &ASrcDataType, Firedac::Stan::Intf::TFDDataType &ADestDataType, bool AForward);
	void __fastcall ColumnDef2FieldDef(Firedac::Stan::Intf::TFDDataType ASrcDataType, unsigned long ASrcSize, int ASrcPrec, int ASrcScale, Firedac::Stan::Intf::TFDDataAttributes ASrcAttrs, Data::Db::TFieldType &ADestFieldType, unsigned long &ADestSize, int &ADestPrec, int &ADestScale);
	__classmethod void __fastcall FieldDef2ColumnDef(Data::Db::TFieldType ASrcFieldType, unsigned long ASrcSize, int ASrcPrec, int ASrcScale, Firedac::Stan::Intf::TFDDataType &ADestDataType, unsigned long &ADestSize, int &ADestPrec, int &ADestScale, Firedac::Stan::Intf::TFDDataAttributes &ADestAttrs)/* overload */;
	__classmethod void __fastcall FieldDef2ColumnDef(Data::Db::TField* AField, Firedac::Stan::Intf::TFDDataType &ADestDataType, unsigned long &ADestSize, int &ADestPrec, int &ADestScale, Firedac::Stan::Intf::TFDDataAttributes &ADestAttrs)/* overload */;
	__classmethod void __fastcall FieldDef2ColumnDef(Data::Db::TFieldDef* AFieldDef, Firedac::Stan::Intf::TFDDataType &ADestDataType, unsigned long &ADestSize, int &ADestPrec, int &ADestScale, Firedac::Stan::Intf::TFDDataAttributes &ADestAttrs)/* overload */;
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	void __fastcall ConvertRawData(Firedac::Stan::Intf::TFDDataType ASrcType, Firedac::Stan::Intf::TFDDataType ADestType, void * ApSrc, unsigned long ASrcSize, void * &ApDest, unsigned long ADestMaxSize, unsigned long &ADestSize, Firedac::Stan::Util::TFDEncoder* AEncoder);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	__property unsigned long MaxStringSize = {read=GetMaxStringSize, write=SetMaxStringSize, stored=IsMSSS, default=32767};
#endif /* __aarch64__ */
...
#ifndef __aarch64__
	__property unsigned SortLocale = {read=GetSortLocale, write=SetSortLocale, stored=IsSLS, default=0};
#else /* __aarch64__ */
	__property unsigned long SortLocale = {read=GetSortLocale, write=SetSortLocale, stored=IsSLS, default=0};
#endif /* __aarch64__ */
