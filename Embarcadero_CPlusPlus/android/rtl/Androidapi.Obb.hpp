...
// (DO NOT EDIT: machine generated header) 'Androidapi.Obb.pas' rev: 34.00 (Android)

#ifndef Androidapi_ObbHPP
#define Androidapi_ObbHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ANDROIDAPI_OBB)
using namespace Androidapi::Obb;
#endif
