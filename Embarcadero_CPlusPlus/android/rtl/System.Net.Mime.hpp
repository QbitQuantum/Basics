...
// (DO NOT EDIT: machine generated header) 'System.Net.Mime.pas' rev: 34.00 (Android)
...
template<typename T> class DELPHICLASS _TAcceptValueListBase__1_Create_1__ActRec;
template<typename T> class DELPHICLASS _TAcceptValueListBase__1_Intersect_ActRec;
//-- type declarations -------------------------------------------------------
#ifndef __aarch64__
#pragma pack(push,4)
