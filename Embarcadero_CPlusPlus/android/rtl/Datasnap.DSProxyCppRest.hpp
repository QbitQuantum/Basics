...
// (DO NOT EDIT: machine generated header) 'Datasnap.DSProxyCppRest.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Datasnap_Dsproxycpprest);
}	/* namespace Dsproxycpprest */
}	/* namespace Datasnap */
...
//-- var, const, procedure ---------------------------------------------------
#define sCPlusPlusBuilderRestProxyWriter u"C++Builder REST"
}	/* namespace Dsproxycpprest */
}	/* namespace Datasnap */
