...
// (DO NOT EDIT: machine generated header) 'IBX.IBDatabase.pas' rev: 34.00 (Android)
...
_DECLARE_STRING_TYPE_ALIAS(System::UnicodeString, TIBFileName);
...
public:
	...
	void __fastcall MoveTableToTablespace(System::UnicodeString TableName, System::UnicodeString Tablespace = u"PRIMARY");
	void __fastcall MoveIndexToTablespace(System::UnicodeString TableName, System::UnicodeString Tablespace = u"PRIMARY");
...
//-- var, const, procedure ---------------------------------------------------
#define DPBPrefix u"isc_dpb_"
#define TPBPrefix u"isc_tpb_"
