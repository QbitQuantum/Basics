...
// (DO NOT EDIT: machine generated header) 'Androidapi.Rect.pas' rev: 34.00 (Android)

#ifndef Androidapi_RectHPP
#define Androidapi_RectHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ANDROIDAPI_RECT)
using namespace Androidapi::Rect;
#endif
