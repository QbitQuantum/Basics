...
// (DO NOT EDIT: machine generated header) 'Data.SqlConst.pas' rev: 34.00 (Android)
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
#define DRIVERS_KEY u"Installed Drivers"
#define CONNECTIONS_KEY u"Installed Connections"
#define DRIVERNAME_KEY u"DriverName"
#define HOSTNAME_KEY u"HostName"
#define ROLENAME_KEY u"RoleName"
#define DATABASENAME_KEY u"Database"
#define MAXBLOBSIZE_KEY u"BlobSize"
#define VENDORLIB_KEY u"VendorLib"
#define DLLLIB_KEY u"LibraryName"
#define GETDRIVERFUNC_KEY u"GetDriverFunc"
#define AUTOCOMMIT_KEY u"AutoCommit"
#define BLOCKINGMODE_KEY u"BlockingMode"
#define WAITONLOCKS_KEY u"WaitOnLocks"
#define COMMITRETAIN_KEY u"CommitRetain"
#define TRANSISOLATION_KEY u"%s TransIsolation"
#define SQLDIALECT_KEY u"SqlDialect"
#define SQLLOCALE_CODE_KEY u"LocaleCode"
#define ERROR_RESOURCE_KEY u"ErrorResourceFile"
#define SQLSERVER_CHARSET_KEY u"ServerCharSet"
#define CONNECTION_STRING u"ConnectionString"
#define SREADCOMMITTED u"readcommitted"
#define SREPEATREAD u"repeatableread"
#define SDIRTYREAD u"dirtyread"
#define szPASSWORD u"PASSWORD"
#define SLocaleCode u"LCID"
#define ROWSETSIZE_KEY u"RowsetSize"
#define OSAUTHENTICATION u"OS Authentication"
#define SERVERPORT u"Server Port"
#define MULTITRANSENABLED u"Multiple Transaction"
#define TRIMCHAR u"Trim Char"
#define CUSTOM_INFO u"Custom String"
#define CONN_TIMEOUT u"Connection Timeout"
#define TDSPACKETSIZE u"TDS Packet Size"
#define CLIENTHOSTNAME u"Client HostName"
#define CLIENTAPPNAME u"Client AppName"
#define COMPRESSED u"Compressed"
#define ENCRYPTED u"Encrypted"
#define PREPARESQL u"Prepare SQL"
