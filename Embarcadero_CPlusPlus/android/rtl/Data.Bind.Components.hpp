...
// (DO NOT EDIT: machine generated header) 'Data.Bind.Components.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Data_Bind_Components);
}	/* namespace Components */
}	/* namespace Bind */
}	/* namespace Data */
...
public:
	static constexpr int IDEditLinkObserver = int(1);
	
	static constexpr int IDEditGridLinkObserver = int(2);
	
	static constexpr int IDPositionLinkObserver = int(3);
	
	static constexpr int IDControlValueObserver = int(4);
