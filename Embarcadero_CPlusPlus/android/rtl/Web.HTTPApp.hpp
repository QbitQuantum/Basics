...
// (DO NOT EDIT: machine generated header) 'Web.HTTPApp.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
#define sDateFormat u"\"%s\", dd \"%s\" yyyy hh\":\"nn\":\"ss"
static constexpr System::Int8 MAX_STRINGS = System::Int8(0xc);
static constexpr System::Int8 MAX_INTEGERS = System::Int8(0x1);
static constexpr System::Int8 MAX_DATETIMES = System::Int8(0x3);
