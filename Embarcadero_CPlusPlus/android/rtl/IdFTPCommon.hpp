...
// (DO NOT EDIT: machine generated header) 'IdFTPCommon.pas' rev: 34.00 (Android)
...
#define SCCN_FEAT u"SSCN"
#define SSCN_ON u"SSCN ON"
#define SSCN_OFF u"SSCN OFF"
static constexpr System::Byte SSCN_OK_REPLY = System::Byte(0xc8);
static constexpr System::Word SSCN_ERR_NEGOTIATION_REPLY = System::Word(0x1a5);
static constexpr System::WideChar PATH_FILENAME_SEP_UNIX = (System::WideChar)(0x2f);
static constexpr System::WideChar PATH_FILENAME_SEP_DOS = (System::WideChar)(0x5c);
static constexpr System::WideChar PATH_FILENAME_SEP_VMS = (System::WideChar)(0x5d);
static constexpr System::WideChar PATH_SUBDIR_SEP_UNIX = (System::WideChar)(0x2f);
static constexpr System::WideChar PATH_SUBDIR_SEP_DOS = (System::WideChar)(0x5c);
static constexpr System::WideChar PATH_SUBDIR_SEP_VMS = (System::WideChar)(0x2e);
#define PATH_DEVICE_SEP_UNIX u""
static constexpr System::WideChar PATH_DEVICE_SEP_DOS = (System::WideChar)(0x3a);
#define PATH_DEVICE_SEP_VMS u":["
static constexpr System::WideChar UNIX_ALL_FILES = (System::WideChar)(0x2a);
#define MS_DOS_ALL_FILES u"*.*"
#define VMS_ALL_FILES u"*.*;*"
static constexpr System::WideChar CUR_DIR = (System::WideChar)(0x2e);
#define PARENT_DIR u".."
#define VMS_RELPATH_PREFIX u"[."
#define MS_DOS_CURDIR u".\\"
#define UNIX_CURDIR u"./"
static constexpr System::Word UNIX_DIR_SIZE = System::Word(0x200);
static constexpr System::Word VMS_BLOCK_SIZE = System::Word(0x200);
static constexpr System::Word EPLF_BASE_DATE = System::Word(0x63e1);
static constexpr System::Int8 DEF_ZLIB_COMP_LEVEL = System::Int8(0x7);
static constexpr System::Int8 DEF_ZLIB_WINDOW_BITS = System::Int8(0xf);
static constexpr System::Int8 DEF_ZLIB_MEM_LEVEL = System::Int8(0x8);
static constexpr System::Int8 DEF_ZLIB_STRATAGY = System::Int8(0x0);
static constexpr System::Int8 DEF_ZLIB_METHOD = System::Int8(0x8);
...
#define UNIX_LINKTO_SYM u" -> "
#define CDATE_PART_SEP u"/-"
static constexpr System::Word Id__S_ISUID = System::Word(0x800);
static constexpr System::Word Id__S_ISGID = System::Word(0x400);
static constexpr System::Word Id__S_ISVTX = System::Word(0x200);
static constexpr System::Word Id__S_IREAD = System::Word(0x100);
static constexpr System::Byte Id__S_IWRITE = System::Byte(0x80);
static constexpr System::Int8 Id__S_IEXEC = System::Int8(0x40);
static constexpr System::Word IdS_ISUID = System::Word(0x800);
static constexpr System::Word IdS_ISGID = System::Word(0x400);
static constexpr System::Word IdS_ISVTX = System::Word(0x200);
static constexpr System::Word IdS_IRUSR = System::Word(0x100);
static constexpr System::Byte IdS_IWUSR = System::Byte(0x80);
static constexpr System::Int8 IdS_IXUSR = System::Int8(0x40);
static constexpr System::Word IdS_IRWXU = System::Word(0x1c0);
static constexpr System::Word IdS_IREAD = System::Word(0x100);
static constexpr System::Byte IdS_IWRITE = System::Byte(0x80);
static constexpr System::Int8 IdS_IEXEC = System::Int8(0x40);
static constexpr System::Int8 IdS_IRGRP = System::Int8(0x20);
static constexpr System::Int8 IdS_IWGRP = System::Int8(0x10);
static constexpr System::Int8 IdS_IXGRP = System::Int8(0x8);
static constexpr System::Int8 IdS_IRWXG = System::Int8(0x38);
static constexpr System::Int8 IdS_IROTH = System::Int8(0x4);
static constexpr System::Int8 IdS_IWOTH = System::Int8(0x2);
static constexpr System::Int8 IdS_IXOTH = System::Int8(0x1);
static constexpr System::Int8 IdS_IRWXO = System::Int8(0x7);
static constexpr System::WideChar KoreanTotal = (System::WideChar)(0xcd1d);
static constexpr System::WideChar KoreanMonth = (System::WideChar)(0xc6d4);
static constexpr System::WideChar KoreanDay = (System::WideChar)(0xc77c);
static constexpr System::WideChar KoreanEUCMonth = (System::WideChar)(0xbff9);
static constexpr System::WideChar KoreanYear = (System::WideChar)(0xb144);
#define ChineseTotal u"\u603b\u6570"
static constexpr System::WideChar ChineseMonth = (System::WideChar)(0x6708);
static constexpr System::WideChar ChineseDay = (System::WideChar)(0x65e5);
static constexpr System::WideChar ChineseYear = (System::WideChar)(0x5e74);
#define JapaneseTotal u"\u5408\u8a08"
static constexpr System::WideChar JapaneseMonth = (System::WideChar)(0x8c8e);
static constexpr System::WideChar JapaneseDay = (System::WideChar)(0x93fa);
static constexpr System::WideChar JapaneseYear = (System::WideChar)(0x944e);
static constexpr int XAUT_2_KEY = int(0x49327576);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall StripPath(const System::UnicodeString AFileName, const System::UnicodeString APathDelim = u"/");
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall FetchLength(System::UnicodeString &AInput, const int AMaxLength, const System::UnicodeString ADelim = u" ", const bool ADelete = true, const bool ACaseSensitive = true);
...
extern DELPHI_PACKAGE System::TDateTime __fastcall DateYYStrMonthDD(const System::UnicodeString AData, const System::UnicodeString ADelim = u"-");
extern DELPHI_PACKAGE System::TDateTime __fastcall DateStrMonthDDYY(const System::UnicodeString AData, const System::UnicodeString ADelim = u"-", const bool AAddMissingYear = false);
extern DELPHI_PACKAGE System::TDateTime __fastcall DateDDStrMonthYY(const System::UnicodeString AData, const System::UnicodeString ADelim = u"-");
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall ParseFacts(System::UnicodeString AData, System::Classes::TStrings* AResults, const System::UnicodeString AFactDelim = u";", const System::UnicodeString ANameDelim = u" ");
extern DELPHI_PACKAGE System::UnicodeString __fastcall ParseFactsMLS(System::UnicodeString AData, System::Classes::TStrings* AResults, const System::UnicodeString AFactDelim = u";", const System::UnicodeString ANameDelim = u" ");
