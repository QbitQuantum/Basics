...
// (DO NOT EDIT: machine generated header) 'Web.CopyPrsr.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr char toEOL = '\x05';
static constexpr char toEOF = '\0';
static constexpr char toSymbol = '\x01';
static constexpr char toString = '\x02';
static constexpr char toInteger = '\x03';
static constexpr char toFloat = '\x04';
}	/* namespace Copyprsr */
}	/* namespace Web */
