...
// (DO NOT EDIT: machine generated header) 'Androidapi.NativeWindowJni.pas' rev: 34.00 (Android)

#ifndef Androidapi_NativewindowjniHPP
#define Androidapi_NativewindowjniHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ANDROIDAPI_NATIVEWINDOWJNI)
using namespace Androidapi::Nativewindowjni;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Androidapi_NativewindowjniHPP
