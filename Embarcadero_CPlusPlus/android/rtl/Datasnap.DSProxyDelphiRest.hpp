...
// (DO NOT EDIT: machine generated header) 'Datasnap.DSProxyDelphiRest.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Datasnap_Dsproxydelphirest);
}	/* namespace Dsproxydelphirest */
}	/* namespace Datasnap */
...
//-- var, const, procedure ---------------------------------------------------
#define sDelphiRestProxyWriter u"Delphi REST"
#define sObjectPascalRestProxyWriter u"Object Pascal REST"
#define sDSRestCached u"DSRestCached"
}	/* namespace Dsproxydelphirest */
}	/* namespace Datasnap */
