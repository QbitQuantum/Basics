...
// (DO NOT EDIT: machine generated header) 'REST.BindSource.pas' rev: 34.00 (Android)
...
template<typename T> class DELPHICLASS _TRESTComponentAdapter_CreateReadOnlyField_ActRec__1;
template<typename T> class DELPHICLASS _TRESTComponentAdapter_CreateReadWriteField_ActRec__1;
//-- type declarations -------------------------------------------------------
#ifndef __aarch64__
#pragma pack(push,4)
