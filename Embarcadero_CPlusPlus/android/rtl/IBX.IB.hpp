...
// (DO NOT EDIT: machine generated header) 'IBX.IB.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
#define IBPalette1 u"InterBase"
#define IBPalette2 u"InterBase Admin"
static constexpr System::Word IBLocalBufferLength = System::Word(0x200);
static constexpr System::Word IBBigLocalBufferLength = System::Word(0x400);
static constexpr System::Word IBHugeLocalBufferLength = System::Word(0x5000);
