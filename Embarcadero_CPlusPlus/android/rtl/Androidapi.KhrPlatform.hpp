...
// (DO NOT EDIT: machine generated header) 'Androidapi.KhrPlatform.pas' rev: 34.00 (Android)

#ifndef Androidapi_KhrplatformHPP
#define Androidapi_KhrplatformHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ANDROIDAPI_KHRPLATFORM)
using namespace Androidapi::Khrplatform;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Androidapi_KhrplatformHPP
