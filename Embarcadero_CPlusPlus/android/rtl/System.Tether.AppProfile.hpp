...
// (DO NOT EDIT: machine generated header) 'System.Tether.AppProfile.pas' rev: 34.00 (Android)
...
public:
	#define TTetheringAppProfile_AppProfileID u"APPLICATION"
	
	
private:
	static constexpr System::WideChar CommandSep = (System::WideChar)(0x24);
	
	static constexpr System::WideChar TokenSep = (System::WideChar)(0x23);
	
	static constexpr System::WideChar InnerSep = (System::WideChar)(0x2a);
	
	static constexpr System::Int8 CommandsLength = System::Int8(0xb);
	
	#define TTetheringAppProfile_ConnectCommand u"CON_PROFIL"
	
	#define TTetheringAppProfile_ReverseConnectCommand u"REV_PROFIL"
	
	#define TTetheringAppProfile_ConnectCommandOKResponse u"RES_OKCON"
	
	#define TTetheringAppProfile_ConnectCommandErrorResponse u"RES_ERCON"
	
	#define TTetheringAppProfile_RunActionCommand u"RUN_ACTION"
	
	#define TTetheringAppProfile_RunActionAsyncCommand u"RUN_ASNACT"
	
	#define TTetheringAppProfile_RunActionResponseErrorCommand u"RES_RUNERR"
	
	#define TTetheringAppProfile_RunActionResponseOKCommand u"RES_RUNOKI"
	
	#define TTetheringAppProfile_GetRemoteActionAsyncStateCommand u"GET_ACTASY"
	
	#define TTetheringAppProfile_GetActionsCommand u"GET_ACTION"
	
	#define TTetheringAppProfile_GetActionsCommandResponse u"RES_GETACT"
	
	#define TTetheringAppProfile_GetResourcesCommand u"GET_RESRCS"
	
	#define TTetheringAppProfile_GetResourcesCommandResponse u"RES_GETRES"
	
	#define TTetheringAppProfile_GetResourceValueCommand u"GET_RESVAL"
	
	#define TTetheringAppProfile_GetResourceValueCommandResponse u"RES_GETVAL"
	
	#define TTetheringAppProfile_GetRemoteActionAsyncStateCommandResponse u"RES_ACTASY"
	
	#define TTetheringAppProfile_GetStreamResourceValueCommandResponse u"RES_GETVST"
	
	#define TTetheringAppProfile_SubscribeResourceCommand u"SUB_RESOUR"
	
	#define TTetheringAppProfile_SubscribeResourceResponseCommand u"RES_SUBSCR"
	
	#define TTetheringAppProfile_UnsubscribeResourceCommand u"UNS_RESOUR"
	
	#define TTetheringAppProfile_UnsubscribeResourceResponseCommand u"RES_UNSUBS"
	
	#define TTetheringAppProfile_NotifyResourceUpdateCommand u"NOT_UPDRES"
	
	#define TTetheringAppProfile_NotifySendResourceCommand u"NOT_SNDRES"
	
	#define TTetheringAppProfile_NotifyRemoteActionEndCommand u"NOT_ACTEND"
	
	#define TTetheringAppProfile_ResponseCommandAlive u"RES_ALIVE"
	
	#define TTetheringAppProfile_ResponseBadCommand u"RES_BADCOM"
	
	#define TTetheringAppProfile_ResponseUnknownResourceCommand u"RES_UNKNOWN"
	
	#define TTetheringAppProfile_DisconnectProfileCommand u"DIS_PROFIL"
	
	#define TTetheringAppProfile_SendStreamCommand u"SND_STREAM"
	
	#define TTetheringAppProfile_SendStreamOkResponse u"SND_STROK"
	
	#define TTetheringAppProfile_SendStreamContentCommand u"SND_STRCNT"
	
	#define TTetheringAppProfile_SendStreamContentOKResponse u"RES_STRCNT"
	
	#define TTetheringAppProfile_SendStreamContentErrorResponse u"RES_ERRSCN"
	
	#define TTetheringAppProfile_SendStringCommand u"SND_STRING"
	
	#define TTetheringAppProfile_SendStringOkResponse u"SND_STRGOK"
	
	#define TTetheringAppProfile_SendStringContentOKResponse u"RES_STRGCNT"
	
	#define TTetheringAppProfile_SendStringContentErrorResponse u"RES_ERRSTCN"
	
	#define TTetheringAppProfile_NotifyProfileUpdateCommand u"NOT_UPDPRO"
...
//-- var, const, procedure ---------------------------------------------------
#define AppProfileDataType u"DataType"
#define AppProfileResourceType u"ResourceType"
#define AppProfileValue u"Value"
#define AppProfileActionEnabled u"ActionEnabled"
#define AppProfileActionCaption u"ActionCaption"
#define AppProfileActionHint u"ActionHint"
#ifndef __aarch64__
static constexpr NativeUInt InvalidRemoteHandle = NativeUInt(0xffffffff);
#else /* __aarch64__ */
static constexpr NativeUInt InvalidRemoteHandle = 0xffffffffffffffffULL;
#endif /* __aarch64__ */
}	/* namespace Appprofile */
}	/* namespace Tether */
}	/* namespace System */
