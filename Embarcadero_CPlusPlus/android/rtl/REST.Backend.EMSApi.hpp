...
// (DO NOT EDIT: machine generated header) 'REST.Backend.EMSApi.pas' rev: 34.00 (Android)
...
public:
	...
	{
	public:
		#define TEMSClientAPI_THeaderNames_ApiVersion u"X-Embarcadero-Api-Version"
		
		#define TEMSClientAPI_THeaderNames_ApplicationId u"X-Embarcadero-Application-Id"
		
		#define TEMSClientAPI_THeaderNames_SessionToken u"X-Embarcadero-Session-Token"
		
		#define TEMSClientAPI_THeaderNames_MasterSecret u"X-Embarcadero-Master-Secret"
		
		#define TEMSClientAPI_THeaderNames_AppSecret u"X-Embarcadero-App-Secret"
		
		#define TEMSClientAPI_THeaderNames_TenantId u"X-Embarcadero-Tenant-Id"
		
		#define TEMSClientAPI_THeaderNames_TenantSecret u"X-Embarcadero-Tenant-Secret"
	...
	{
	public:
		#define TEMSClientAPI_TJSONNames_UserName u"username"
		
		#define TEMSClientAPI_TJSONNames_Password u"password"
		
		#define TEMSClientAPI_TJSONNames_SessionToken u"sessionToken"
		
		#define TEMSClientAPI_TJSONNames_Error u"error"
		
		#define TEMSClientAPI_TJSONNames_Description u"description"
		
		#define TEMSClientAPI_TJSONNames_UserID u"_id"
		
		#define TEMSClientAPI_TJSONNames_GroupName u"groupname"
		
		#define TEMSClientAPI_TJSONNames_InstallationID u"_id"
		
		#define TEMSClientAPI_TJSONNames_MetaData u"_meta"
		
		#define TEMSClientAPI_TJSONNames_MetaCreated u"created"
		
		#define TEMSClientAPI_TJSONNames_MetaUpdated u"updated"
		
		#define TEMSClientAPI_TJSONNames_MetaCreator u"creator"
		
		#define TEMSClientAPI_TJSONNames_PushWhere u"where"
		
		#define TEMSClientAPI_TJSONNames_PushChannels u"channels"
		
		#define TEMSClientAPI_TJSONNames_PushData u"data"
		
		#define TEMSClientAPI_TJSONNames_PushBadge u"badge"
		
		#define TEMSClientAPI_TJSONNames_FieldName u"name"
		
		#define TEMSClientAPI_TJSONNames_FieldCustom u"custom"
		
		#define TEMSClientAPI_TJSONNames_FieldFields u"fields"
		
		#define TEMSClientAPI_TJSONNames_ModuleID u"_id"
		
		#define TEMSClientAPI_TJSONNames_ResourceModuleID u"moduleid"
		
		#define TEMSClientAPI_TJSONNames_ModuleName u"modulename"
		
		#define TEMSClientAPI_TJSONNames_Protocol u"protocol"
		
		#define TEMSClientAPI_TJSONNames_ResourceName u"resourcename"
		
		#define TEMSClientAPI_TJSONNames_ProtocolProps u"protocolprops"
		
		#define TEMSClientAPI_TJSONNames_Resources u"resources"
	...
	{
	public:
		#define TEMSClientAPI_TSegmentNames_Users u"users"
		
		#define TEMSClientAPI_TSegmentNames_UsersFields u"users/fields"
		
		#define TEMSClientAPI_TSegmentNames_Groups u"groups"
		
		#define TEMSClientAPI_TSegmentNames_GroupsFields u"groups/fields"
		
		#define TEMSClientAPI_TSegmentNames_Installations u"installations"
		
		#define TEMSClientAPI_TSegmentNames_InstallationsChannels u"installations/channels"
		
		#define TEMSClientAPI_TSegmentNames_InstallationsFields u"installations/fields"
		
		#define TEMSClientAPI_TSegmentNames_Login u"login"
		
		#define TEMSClientAPI_TSegmentNames_Signup u"signup"
		
		#define TEMSClientAPI_TSegmentNames_Logout u"logout"
		
		#define TEMSClientAPI_TSegmentNames_Restore u"_restore"
		
		#define TEMSClientAPI_TSegmentNames_Me u"me"
		
		#define TEMSClientAPI_TSegmentNames_Push u"push"
		
		#define TEMSClientAPI_TSegmentNames_Modules u"edgemodules"
		
		#define TEMSClientAPI_TSegmentNames_ModulesResources u"edgemodules/resources"
		
		#define TEMSClientAPI_TSegmentNames_ModulesFields u"edgemodules/fields"
		
		#define TEMSClientAPI_TSegmentNames_ResourcesFields u"edgemodules/resources/fields"
		
		#define TEMSClientAPI_TSegmentNames_Resources u"resources"
	...
	{
	public:
		#define TEMSClientAPI_TQueryParamNames_Order u"order"
		
		#define TEMSClientAPI_TQueryParamNames_Where u"where"
		
		#define TEMSClientAPI_TQueryParamNames_Limit u"limit"
		
		#define TEMSClientAPI_TQueryParamNames_Skip u"skip"
	...
	{
	public:
		#define TEMSClientAPI_TDeviceTypes_IOS u"ios"
		
		#define TEMSClientAPI_TDeviceTypes_Android u"android"
	...
	{
	public:
		#define TEMSClientAPI_TCreatorNames_Master u"00000000-0000-0000-0000-000000000001"
		
		#define TEMSClientAPI_TCreatorNames_Null u"00000000-0000-0000-0000-000000000000"
...
public:
	...
	static constexpr System::WideChar cDefaultApiVersion = (System::WideChar)(0x32);
...
public:
	...
	{
	public:
		static constexpr System::Word BadRequest = System::Word(0x190);
		
		static constexpr System::Word NotFound = System::Word(0x194);
		
		static constexpr System::Word Duplicate = System::Word(0x199);
		
		static constexpr System::Word Unauthorized = System::Word(0x191);
		
		static constexpr System::Word Forbidden = System::Word(0x193);
