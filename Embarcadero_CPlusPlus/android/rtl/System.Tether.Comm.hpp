...
// (DO NOT EDIT: machine generated header) 'System.Tether.Comm.pas' rev: 34.00 (Android)
...
private:
	static constexpr System::Word ReadTimeout = System::Word(0x258);
...
private:
	static constexpr System::Word AcceptTimeout = System::Word(0x3e8);
