...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.TDBXBase.pas' rev: 34.00 (Android)
...
#ifndef __aarch64__
	void __fastcall Dbx2ADColInfo(int ADbxType, int ADbxSubType, int ADbxPrec, short ADbxScale, Firedac::Stan::Intf::TFDDataType &AType, Firedac::Stan::Intf::TFDDataAttributes &AAtrs, unsigned &ALen, int &APrec, int &AScale);
#else /* __aarch64__ */
