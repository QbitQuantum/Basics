...
// (DO NOT EDIT: machine generated header) 'System.IOUtils.pas' rev: 34.00 (Android)
...
private:
	...
	static NativeInt __fastcall ConvertDateTimeToFileTime(const System::TDateTime DateTime, const bool UseLocalTimeZone);
