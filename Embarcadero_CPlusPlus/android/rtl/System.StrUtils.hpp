...
// (DO NOT EDIT: machine generated header) 'System.StrUtils.pas' rev: 34.00 (Android)
...
_DECLARE_ARITH_TYPE_ALIAS(int, TSoundexLength);

_DECLARE_ARITH_TYPE_ALIAS(System::Int8, TSoundexIntLength);
