...
// (DO NOT EDIT: machine generated header) 'System.Messaging.pas' rev: 34.00 (Android)
...
class DELPHICLASS TMessageReceivedNotification;
...
#pragma pack(push,4)
#endif /* not __aarch64__ */
class PASCALIMPLEMENTATION TMessageReceivedNotification : public TMessage__1<Androidapi::Jni::Graphicscontentviewtext::_di_JIntent>
{
	typedef TMessage__1<Androidapi::Jni::Graphicscontentviewtext::_di_JIntent> inherited;
	
public:
	/* {System_Messaging}TMessage<Androidapi_JNI_GraphicsContentViewText_JIntent>.Create */ inline __fastcall TMessageReceivedNotification(const Androidapi::Jni::Graphicscontentviewtext::_di_JIntent AValue) : TMessage__1<Androidapi::Jni::Graphicscontentviewtext::_di_JIntent>(AValue) { }
	/* {System_Messaging}TMessage<Androidapi_JNI_GraphicsContentViewText_JIntent>.Destroy */ inline __fastcall virtual ~TMessageReceivedNotification() { }
