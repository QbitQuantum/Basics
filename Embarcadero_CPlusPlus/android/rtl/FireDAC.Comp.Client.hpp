...
// (DO NOT EDIT: machine generated header) 'FireDAC.Comp.Client.pas' rev: 34.00 (Android)
...
#else /* __aarch64__ */
typedef void __fastcall (__closure *TFDExecuteErrorEvent)(System::TObject* ASender, long ATimes, long AOffset, Firedac::Stan::Error::EFDDBEngineException* AError, Firedac::Stan::Intf::TFDErrorAction &AAction);
#endif /* __aarch64__ */
...
private:
	...
	System::Sysutils::TSimpleRWSync* FLock;
...
#else /* __aarch64__ */
	long __fastcall ExecSQL(const System::UnicodeString ASQL, bool AIgnoreObjNotExists = false)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High, const Data::Db::TFieldType *ATypes, const int ATypes_High)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, Firedac::Stan::Param::TFDParams* AParams)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, Firedac::Stan::Param::TFDParams* AParams, Data::Db::TDataSet* &AResultSet)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, Data::Db::TDataSet* &AResultSet)/* overload */;
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	long __fastcall Execute(const System::UnicodeString ASQL)/* overload */;
	long __fastcall Execute(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High)/* overload */;
	long __fastcall Execute(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High, const Data::Db::TFieldType *ATypes, const int ATypes_High)/* overload */;
#endif /* __aarch64__ */
...
public:
	...
	int __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High, const Data::Db::TFieldType *ATypes, const int ATypes_High)/* overload */;
#else /* __aarch64__ */
	long __fastcall ExecSQL(bool AExecDirect)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High)/* overload */;
	long __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const int AParams_High, const Data::Db::TFieldType *ATypes, const int ATypes_High)/* overload */;
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	unsigned long __fastcall GetColSize(Firedac::Dats::TFDDatSColumn* ACol);
	unsigned long __fastcall GetBookmarkColSize(Firedac::Dats::TFDDatSColumn* ACol);
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	long __fastcall ExecProc(const System::UnicodeString AProcName)/* overload */;
	long __fastcall ExecProc(const System::UnicodeString AProcName, const System::Variant *AParams, const int AParams_High)/* overload */;
	long __fastcall ExecProc(const System::UnicodeString AProcName, const System::Variant *AParams, const int AParams_High, const Data::Db::TFieldType *ATypes, const int ATypes_High)/* overload */;
#endif /* __aarch64__ */
