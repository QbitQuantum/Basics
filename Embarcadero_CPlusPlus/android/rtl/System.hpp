...
// (DO NOT EDIT: machine generated header) 'System.pas' rev: 34.00 (Android)
...
#endif
__interface DELPHIINTERFACE IDispatch;
...
private:
	...
	NativeUInt __fastcall CheckOwningThread();
...
__interface  INTERFACE_UUID("{00020400-0000-0000-C000-000000000046}") IDispatch  : public IInterface 
{
...
#else /* __aarch64__ */
struct DECLSPEC_DRECORD TVarArgList
{
public:
	void *__Stack;
	void *__GR_Top;
...
typedef NativeUInt HGLOBAL;

typedef int __fastcall (*TThreadFunc)(void * Parameter);

typedef unsigned TSize_T;

typedef pthread_attr_t TThreadAttr;

typedef pthread_attr_t *PThreadAttr;

typedef int __fastcall (*TBeginThreadProc)(PThreadAttr Attribute, TThreadFunc ThreadFunc, void * Parameter, NativeUInt &ThreadId);

typedef void __fastcall (*TEndThreadProc)(int ExitCode);
...
typedef TObject* __fastcall (*TGetExceptionObject)(unsigned __int64 ExceptionClass);
...
static constexpr int MaxInt = int(2147483647);
#ifndef __aarch64__
static constexpr int MaxLongInt = int(2147483647);
#else /* __aarch64__ */
static constexpr __int64 MaxLongInt = 0x7fffffffffffffffLL;
#endif /* __aarch64__ */
#define RTLVersion  (3.400000E+01)
static constexpr bool RTLVersion1041 = true;
static constexpr bool RTLVersion1042 = true;
static constexpr System::Int8 varEmpty = System::Int8(0x0);
static constexpr System::Int8 varNull = System::Int8(0x1);
static constexpr System::Int8 varSmallint = System::Int8(0x2);
static constexpr System::Int8 varInteger = System::Int8(0x3);
static constexpr System::Int8 varSingle = System::Int8(0x4);
static constexpr System::Int8 varDouble = System::Int8(0x5);
static constexpr System::Int8 varCurrency = System::Int8(0x6);
static constexpr System::Int8 varDate = System::Int8(0x7);
static constexpr System::Int8 varOleStr = System::Int8(0x8);
static constexpr System::Int8 varDispatch = System::Int8(0x9);
static constexpr System::Int8 varError = System::Int8(0xa);
static constexpr System::Int8 varBoolean = System::Int8(0xb);
static constexpr System::Int8 varVariant = System::Int8(0xc);
static constexpr System::Int8 varUnknown = System::Int8(0xd);
static constexpr System::Int8 varShortInt = System::Int8(0x10);
static constexpr System::Int8 varByte = System::Int8(0x11);
static constexpr System::Int8 varWord = System::Int8(0x12);
static constexpr System::Int8 varLongWord = System::Int8(0x13);
static constexpr System::Int8 varUInt32 = System::Int8(0x13);
static constexpr System::Int8 varInt64 = System::Int8(0x14);
static constexpr System::Int8 varUInt64 = System::Int8(0x15);
static constexpr System::Int8 varRecord = System::Int8(0x24);
static constexpr System::Int8 varStrArg = System::Int8(0x48);
static constexpr System::Int8 varObject = System::Int8(0x49);
static constexpr System::Int8 varUStrArg = System::Int8(0x4a);
static constexpr System::Word varString = System::Word(0x100);
static constexpr System::Word varAny = System::Word(0x101);
static constexpr System::Word varUString = System::Word(0x102);
static constexpr System::Word varTypeMask = System::Word(0xfff);
static constexpr System::Word varArray = System::Word(0x2000);
static constexpr System::Word varByRef = System::Word(0x4000);
static constexpr System::Int8 vtInteger = System::Int8(0x0);
static constexpr System::Int8 vtBoolean = System::Int8(0x1);
static constexpr System::Int8 vtChar = System::Int8(0x2);
static constexpr System::Int8 vtExtended = System::Int8(0x3);
static constexpr System::Int8 vtString = System::Int8(0x4);
static constexpr System::Int8 vtPointer = System::Int8(0x5);
static constexpr System::Int8 vtPChar = System::Int8(0x6);
static constexpr System::Int8 vtObject = System::Int8(0x7);
static constexpr System::Int8 vtClass = System::Int8(0x8);
static constexpr System::Int8 vtWideChar = System::Int8(0x9);
static constexpr System::Int8 vtPWideChar = System::Int8(0xa);
static constexpr System::Int8 vtAnsiString = System::Int8(0xb);
static constexpr System::Int8 vtCurrency = System::Int8(0xc);
static constexpr System::Int8 vtVariant = System::Int8(0xd);
static constexpr System::Int8 vtInterface = System::Int8(0xe);
static constexpr System::Int8 vtWideString = System::Int8(0xf);
static constexpr System::Int8 vtInt64 = System::Int8(0x10);
static constexpr System::Int8 vtUnicodeString = System::Int8(0x11);
static constexpr System::Int8 vmtArcOffset = System::Int8(0x0);
#ifndef __aarch64__
static constexpr System::Int8 CPP_ABI_ADJUST = System::Int8(0xc);
static constexpr Int8 vmtSelfPtr = Int8(-100);
static constexpr Int8 vmtIntfTable = Int8(-96);
static constexpr Int8 vmtAutoTable = Int8(-92);
static constexpr Int8 vmtInitTable = Int8(-88);
static constexpr Int8 vmtTypeInfo = Int8(-84);
static constexpr Int8 vmtFieldTable = Int8(-80);
static constexpr Int8 vmtMethodTable = Int8(-76);
static constexpr Int8 vmtDynamicTable = Int8(-72);
static constexpr Int8 vmtClassName = Int8(-68);
static constexpr Int8 vmtInstanceSize = Int8(-64);
static constexpr Int8 vmtParent = Int8(-60);
static constexpr Int8 vmtEquals _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-56);
static constexpr Int8 vmtGetHashCode _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-52);
static constexpr Int8 vmtToString _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-48);
static constexpr Int8 vmtSafeCallException _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-44);
static constexpr Int8 vmtAfterConstruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-40);
static constexpr Int8 vmtBeforeDestruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-36);
static constexpr Int8 vmtDispatch _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-32);
static constexpr Int8 vmtDefaultHandler _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-28);
static constexpr Int8 vmtNewInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-24);
static constexpr Int8 vmtFreeInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-20);
static constexpr Int8 vmtDestroy _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-16);
#else /* __aarch64__ */
static constexpr System::Int8 CPP_ABI_ADJUST = System::Int8(0x18);
static constexpr short vmtSelfPtr = short(-200);
static constexpr short vmtIntfTable = short(-192);
static constexpr short vmtAutoTable = short(-184);
static constexpr short vmtInitTable = short(-176);
static constexpr short vmtTypeInfo = short(-168);
static constexpr short vmtFieldTable = short(-160);
static constexpr short vmtMethodTable = short(-152);
static constexpr short vmtDynamicTable = short(-144);
static constexpr short vmtClassName = short(-136);
static constexpr Int8 vmtInstanceSize = Int8(-128);
static constexpr Int8 vmtParent = Int8(-120);
static constexpr Int8 vmtEquals _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-112);
static constexpr Int8 vmtGetHashCode _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-104);
static constexpr Int8 vmtToString _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-96);
static constexpr Int8 vmtSafeCallException _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-88);
static constexpr Int8 vmtAfterConstruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-80);
static constexpr Int8 vmtBeforeDestruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-72);
static constexpr Int8 vmtDispatch _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-64);
static constexpr Int8 vmtDefaultHandler _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-56);
static constexpr Int8 vmtNewInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-48);
static constexpr Int8 vmtFreeInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-40);
static constexpr Int8 vmtDestroy _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-32);
#endif /* __aarch64__ */
static constexpr System::Int8 vmtQueryInterface _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x0);
#ifndef __aarch64__
static constexpr System::Int8 vmtAddRef _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x4);
static constexpr System::Int8 vmtRelease _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x8);
static constexpr System::Int8 vmtCreateObject _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0xc);
static constexpr int hfFieldSize = int(0x4);
#else /* __aarch64__ */
static constexpr System::Int8 vmtAddRef _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x8);
static constexpr System::Int8 vmtRelease _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x10);
static constexpr System::Int8 vmtCreateObject _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x18);
static constexpr int hfFieldSize = int(0x8);
#endif /* __aarch64__ */
static constexpr System::Int8 hfMonitorOffset = System::Int8(0x0);
...
static constexpr HRESULT E_NOINTERFACE = HRESULT(-2147467262);
static constexpr HRESULT E_UNEXPECTED = HRESULT(-2147418113);
static constexpr HRESULT E_NOTIMPL = HRESULT(-2147467263);
static constexpr System::Int8 opAdd = System::Int8(0x0);
static constexpr System::Int8 opSubtract = System::Int8(0x1);
static constexpr System::Int8 opMultiply = System::Int8(0x2);
static constexpr System::Int8 opDivide = System::Int8(0x3);
static constexpr System::Int8 opIntDivide = System::Int8(0x4);
static constexpr System::Int8 opModulus = System::Int8(0x5);
static constexpr System::Int8 opShiftLeft = System::Int8(0x6);
static constexpr System::Int8 opShiftRight = System::Int8(0x7);
static constexpr System::Int8 opAnd = System::Int8(0x8);
static constexpr System::Int8 opOr = System::Int8(0x9);
static constexpr System::Int8 opXor = System::Int8(0xa);
static constexpr System::Int8 opCompare = System::Int8(0xb);
static constexpr System::Int8 opNegate = System::Int8(0xc);
static constexpr System::Int8 opNot = System::Int8(0xd);
static constexpr System::Int8 opCmpEQ = System::Int8(0xe);
static constexpr System::Int8 opCmpNE = System::Int8(0xf);
static constexpr System::Int8 opCmpLT = System::Int8(0x10);
static constexpr System::Int8 opCmpLE = System::Int8(0x11);
static constexpr System::Int8 opCmpGT = System::Int8(0x12);
static constexpr System::Int8 opCmpGE = System::Int8(0x13);
...
static constexpr System::Int8 NumSmallBlockTypes = System::Int8(0x2e);
...
extern DELPHI_PACKAGE NativeUInt MainInstance;
extern DELPHI_PACKAGE NativeUInt MainThreadID;
...
extern DELPHI_PACKAGE int FileAccessRights;
extern DELPHI_PACKAGE int ArgCount;
extern DELPHI_PACKAGE char * *ArgValues;
extern DELPHI_PACKAGE WideChar * *envp;
...
extern DELPHI_PACKAGE unsigned DefaultFPSCR;
...
extern DELPHI_PACKAGE bool CoreDumpEnabled;
...
extern DELPHI_PACKAGE TBeginThreadProc BeginThreadProc;
extern DELPHI_PACKAGE TEndThreadProc EndThreadProc;
static constexpr Word fmClosed = Word(0xd7b0);
static constexpr Word fmInput = Word(0xd7b1);
static constexpr Word fmOutput = Word(0xd7b2);
static constexpr Word fmInOut = Word(0xd7b3);
static constexpr System::Int8 tfCRLF = System::Int8(0x1);
extern DELPHI_PACKAGE TRandom32Proc Random32Proc;
extern DELPHI_PACKAGE TRandomizeProc RandomizeProc;
static constexpr System::Int8 feeINEXACT = System::Int8(0x10);
static constexpr System::Int8 feeUNDERFLOW = System::Int8(0x8);
static constexpr System::Int8 feeOVERFLOW = System::Int8(0x4);
static constexpr System::Int8 feeDIVBYZERO = System::Int8(0x2);
static constexpr System::Int8 feeINVALID = System::Int8(0x1);
static constexpr Byte feeFLUSHTOZERO = Byte(0x80);
static constexpr Byte feeALLEXCEPT = Byte(0x9f);
static constexpr System::Word femINEXACT = System::Word(0x1000);
static constexpr System::Word femUNDERFLOW = System::Word(0x800);
static constexpr System::Word femOVERFLOW = System::Word(0x400);
static constexpr System::Word femDIVBYZERO = System::Word(0x200);
static constexpr System::Word femINVALID = System::Word(0x100);
static constexpr Word femFLUSHTOZERO = Word(0x8000);
static constexpr Word femALLEXCEPT = Word(0x9f00);
static constexpr System::Int8 ferTONEAREST = System::Int8(0x0);
static constexpr System::Int8 ferUPWARD = System::Int8(0x1);
static constexpr System::Int8 ferDOWNWARD = System::Int8(0x2);
static constexpr System::Int8 ferTOWARDZERO = System::Int8(0x3);
static constexpr System::Int8 ferALLROUND = System::Int8(0x3);
...
static constexpr unsigned __int64 CPPExceptionPersonality = 0x474e5543432b2b00ULL;
static constexpr unsigned __int64 DelphiExceptionPersonality = 0x454d4254444c5048ULL;
extern DELPHI_PACKAGE TGetExceptionObject ExceptObjProc;
extern DELPHI_PACKAGE void *DelphiActivity;
extern DELPHI_PACKAGE void *JavaMachine;
extern DELPHI_PACKAGE void *JavaContext;
extern DELPHI_PACKAGE NativeUInt HICUUC;
extern DELPHI_PACKAGE NativeUInt HICUI18N;
extern DELPHI_PACKAGE UnicodeString LibICUSuffix;
#define LibCPP u"c++_static"
#define LibCPP_ABI u"c++abi"
extern DELPHI_PACKAGE void __fastcall TextStart _DEPRECATED_ATTRIBUTE0 (void);
extern DELPHI_PACKAGE int __fastcall GetLastError(void);
extern DELPHI_PACKAGE void __fastcall SetLastError(int ErrorCode);
extern DELPHI_PACKAGE unsigned __fastcall ModuleCacheID(void);
extern DELPHI_PACKAGE void __fastcall InvalidateModuleCache(void);
...
extern DELPHI_PACKAGE unsigned __fastcall FSetExceptFlag(unsigned NewFlags, unsigned Excepts = (unsigned)(0x9f));
extern DELPHI_PACKAGE unsigned __fastcall FGetExceptFlag(unsigned Excepts = (unsigned)(0x9f));
...
extern DELPHI_PACKAGE unsigned __fastcall FSetExceptMask(unsigned NewMasks, unsigned ExceptMasks = (unsigned)(0x9f00));
extern DELPHI_PACKAGE unsigned __fastcall FGetExceptMask(unsigned ExceptMasks = (unsigned)(0x9f00));
extern DELPHI_PACKAGE void __fastcall SetFPSCR(unsigned NewFlag);
extern DELPHI_PACKAGE unsigned __fastcall GetFPSCR(void);
...
#ifndef __aarch64__
extern DELPHI_PACKAGE NativeUInt __fastcall AllocateExceptionFrame(TObject* const Obj, NativeUInt Address);
extern DELPHI_PACKAGE bool __fastcall IsLeafFunction(NativeUInt IP);
#endif /* not __aarch64__ */
extern DELPHI_PACKAGE int __fastcall BeginThread(PThreadAttr Attribute, TThreadFunc ThreadFunc, void * Parameter, NativeUInt &ThreadId);
...
extern DELPHI_PACKAGE Word __fastcall StringElementSize(const WideString S)/* overload */;
...
extern DELPHI_PACKAGE Word __fastcall StringCodePage(const WideString S)/* overload */;
...
extern DELPHI_PACKAGE int __fastcall StringRefCount(const WideString S)/* overload */;
...
extern DELPHI_PACKAGE int __fastcall GetModuleFileName(NativeUInt Module, WideChar * Buffer, int BufLen);
...
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToString(const char *S, const int S_High)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToString(const Byte *S, const int S_High)/* overload */;
...
extern DELPHI_PACKAGE NativeUInt __fastcall FindResource(NativeUInt ModuleHandle, WideChar * ResourceName, WideChar * ResourceType);
extern DELPHI_PACKAGE NativeUInt __fastcall LoadResource(NativeUInt ModuleHandle, NativeUInt ResHandle);
extern DELPHI_PACKAGE int __fastcall SizeofResource(NativeUInt ModuleHandle, NativeUInt ResHandle);
extern DELPHI_PACKAGE void * __fastcall LockResource(NativeUInt ResData);
extern DELPHI_PACKAGE LongBool __fastcall UnlockResource(NativeUInt ResData);
extern DELPHI_PACKAGE LongBool __fastcall FreeResource(NativeUInt ResData);
...
extern DELPHI_PACKAGE unsigned __fastcall GetACP(void);
...
extern DELPHI_PACKAGE int __fastcall LocaleCharsFromUnicode(const AnsiString LocaleName, unsigned Flags, WideChar * UnicodeStr, int UnicodeStrLen, char * LocaleStr, int LocaleStrLen, char * DefaultChar, PLongBool UsedDefaultChar)/* overload */;
extern DELPHI_PACKAGE int __fastcall UnicodeFromLocaleChars(const AnsiString LocaleName, unsigned Flags, char * LocaleStr, int LocaleStrLen, WideChar * UnicodeStr, int UnicodeStrLen)/* overload */;
extern DELPHI_PACKAGE void __fastcall SetMultiByteConversionCodePage(int CodePage);
extern DELPHI_PACKAGE void * __fastcall UTF8CompareCollator(void);
extern DELPHI_PACKAGE char * __fastcall UTF8CompareLocale(void);
extern DELPHI_PACKAGE bool __fastcall SetUTF8CompareLocale(const UnicodeString LocaleName);
}	/* namespace System */
