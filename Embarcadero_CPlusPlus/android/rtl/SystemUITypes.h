...
#if defined(_PLAT_IOS) || defined(_PLAT_ANDROID) || defined(_PLAT_LINUX64) || defined(_PLAT_MACOS64)
...
#endif //defined(_PLAT_IOS) || defined(_PLAT_ANDROID) || defined(_PLAT_LINUX64)
