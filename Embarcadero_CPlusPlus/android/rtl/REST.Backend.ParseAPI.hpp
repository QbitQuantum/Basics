...
// (DO NOT EDIT: machine generated header) 'REST.Backend.ParseApi.pas' rev: 34.00 (Android)
...
public:
	...
	{
	public:
		#define TParseApi_TDeviceNames_IOS u"ios"
		
		#define TParseApi_TDeviceNames_Android u"android"
...
private:
	#define TParseApi_sClasses u"classes"
	
	#define TParseApi_sInstallations u"installations"
	
	#define TParseApi_sFiles u"files"
	
	#define TParseApi_sUsers u"users"
	
	#define TParseApi_sPush u"push"
	
	
public:
	static constexpr System::WideChar cDefaultApiVersion = (System::WideChar)(0x31);
	
	#define TParseApi_cDefaultBaseURL u"https://api.parse.com/{ApiVersion}"
