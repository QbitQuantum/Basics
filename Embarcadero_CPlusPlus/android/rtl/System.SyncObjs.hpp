...
// (DO NOT EDIT: machine generated header) 'System.SyncObjs.pas' rev: 34.00 (Android)
...
public:
	...
	bool __fastcall TryBeginRead()/* overload */;
	bool __fastcall TryBeginRead(unsigned Timeout)/* overload */;
	void __fastcall EndRead();
	void __fastcall BeginWrite();
	bool __fastcall TryBeginWrite()/* overload */;
	bool __fastcall TryBeginWrite(unsigned Timeout)/* overload */;
