...
// (DO NOT EDIT: machine generated header) 'Xml.Internal.XmlRulesUtils.pas' rev: 34.00 (Android)
...
#else /* __aarch64__ */
extern DELPHI_PACKAGE bool __fastcall IsXmlCharCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlWhiteSpaceCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlWhiteSpaceOrNullCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlLetterCodePoint _DEPRECATED_ATTRIBUTE0 (const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlBaseCharCodePoint _DEPRECATED_ATTRIBUTE0 (const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlHexDigitCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlIdeographicCodePoint _DEPRECATED_ATTRIBUTE0 (const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlCombiningCharCodePoint _DEPRECATED_ATTRIBUTE0 (const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlDecDigitCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlDigitCodePoint _DEPRECATED_ATTRIBUTE0 (const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlExtenderCodePoint _DEPRECATED_ATTRIBUTE0 (const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlNameCharCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlNameStartCharCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlEncNameLeadingCharCodePoint(const long UCS4);
extern DELPHI_PACKAGE bool __fastcall IsXmlEncNameFollowingCharCodePoint(const long UCS4);
#endif /* __aarch64__ */
