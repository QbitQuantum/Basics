...
// (DO NOT EDIT: machine generated header) 'FireDAC.Moni.Base.pas' rev: 34.00 (Android)
...
#else /* __aarch64__ */
	virtual unsigned long __fastcall RegisterAdapter(const Firedac::Stan::Intf::_di_IFDMoniAdapter AAdapter);
#endif /* __aarch64__ */
