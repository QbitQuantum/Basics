...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.SQLiteWrapper.pas' rev: 34.00 (Android)
...
#endif /* __aarch64__ */
	char * __fastcall GetLocaleID();
	void __fastcall SetLocaleID(const char * AValue);
...
public:
	...
	__property char * LocaleID = {read=GetLocaleID, write=SetLocaleID};
#ifndef __aarch64__
