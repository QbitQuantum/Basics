...
// (DO NOT EDIT: machine generated header) 'Androidapi.AssetManager.pas' rev: 34.00 (Android)

#ifndef Androidapi_AssetmanagerHPP
#define Androidapi_AssetmanagerHPP
...
//-- type declarations -------------------------------------------------------
typedef AAssetManager *PAAssetManager;

typedef AAssetDir *PAAssetDir;

typedef AAsset *PAAsset;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ANDROIDAPI_ASSETMANAGER)
using namespace Androidapi::Assetmanager;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Androidapi_AssetmanagerHPP
