...
// (DO NOT EDIT: machine generated header) 'FireDAC.UI.Intf.pas' rev: 34.00 (Android)
...
#else /* __aarch64__ */
	virtual void __fastcall SetEvent(System::Classes::TNotifyEvent AProc, unsigned long ATimeout) = 0 ;
#endif /* __aarch64__ */
