...
// (DO NOT EDIT: machine generated header) 'REST.Backend.KinveyProvider.pas' rev: 34.00 (Android)
...
{
  _INIT_UNIT(Rest_Backend_Kinveyprovider);
}	/* namespace Kinveyprovider */
}	/* namespace Backend */
}	/* namespace Rest */
...
public:
	#define TCustomKinveyProvider_ProviderID u"Kinvey"
