...
// (DO NOT EDIT: machine generated header) 'IBX.IBServices.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word DefaultBufferSize = System::Word(0x7d00);
#define SPBPrefix u"isc_spb_"
}	/* namespace Ibservices */
}	/* namespace Ibx */
