...
// (DO NOT EDIT: machine generated header) 'IdFTPListOutput.pas' rev: 34.00 (Android)
...
//-- var, const, procedure ---------------------------------------------------
#define DEF_FILE_OWN_PERM u"rw-"
#define DEF_FILE_GRP_PERM u"rw-"
#define DEF_FILE_OTHER_PERM u"r--"
#define DEF_DIR_OWN_PERM u"rwx"
#define DEF_DIR_GRP_PERM u"rwx"
#define DEF_DIR_OTHER_PERM u"r-x"
#define DEF_OWNER u"root"
static constexpr System::WideChar SWITCH_COLS_ACCROSS = (System::WideChar)(0x78);
static constexpr System::WideChar SWITCH_COLS_DOWN = (System::WideChar)(0x43);
static constexpr System::WideChar SWITCH_ONE_COL = (System::WideChar)(0x31);
static constexpr System::WideChar SWITCH_ONE_DIR = (System::WideChar)(0x66);
static constexpr System::WideChar SWITCH_COMMA_STREAM = (System::WideChar)(0x6d);
static constexpr System::WideChar SWITCH_LONG_FORM = (System::WideChar)(0x6c);
static constexpr System::WideChar SWITCH_RECURSIVE = (System::WideChar)(0x52);
static constexpr System::WideChar SWITCH_SORT_REVERSE = (System::WideChar)(0x72);
static constexpr System::WideChar SWITCH_SORTBY_MTIME = (System::WideChar)(0x74);
static constexpr System::WideChar SWITCH_SORTBY_CTIME = (System::WideChar)(0x75);
static constexpr System::WideChar SWITCH_SORTBY_EXT = (System::WideChar)(0x58);
static constexpr System::WideChar SWITCH_SORTBY_SIZE = (System::WideChar)(0x53);
static constexpr System::WideChar SWITCH_CLASSIFY = (System::WideChar)(0x46);
static constexpr System::WideChar SWITCH_SLASHDIR = (System::WideChar)(0x70);
static constexpr System::WideChar SWITCH_QUOTEDNAME = (System::WideChar)(0x51);
static constexpr System::WideChar SWITCH_PRINT_BLOCKS = (System::WideChar)(0x73);
static constexpr System::WideChar SWITCH_PRINT_INODE = (System::WideChar)(0x69);
static constexpr System::WideChar SWITCH_SHOW_ALLPERIOD = (System::WideChar)(0x61);
static constexpr System::WideChar SWITCH_HIDE_DIRPOINT = (System::WideChar)(0x41);
static constexpr System::WideChar SWITCH_BOTH_TIME_YEAR = (System::WideChar)(0x54);
}	/* namespace Idftplistoutput */
