...
// (DO NOT EDIT: machine generated header) 'System.Classes.pas' rev: 34.00 (Android)
...
struct TLinkObserversHelper /* Helper for class 'TLinkObservers*' */;
class DELPHICLASS TObserverMapping;
struct TObserverMappingHelper /* Helper for class 'TObserverMapping*' */;
...
class DELPHICLASS ObservableMemberExtAttribute;
...
_DECLARE_ARITH_TYPE_ALIAS(int, THelpContext);

enum DECLSPEC_DENUM THelpType : unsigned char { htKeyword, htContext };

_DECLARE_ARITH_TYPE_ALIAS(System::Word, TShortCut);
...
public:
	...
	void __fastcall AddStrings(const System::TArray__1<System::UnicodeString> Strings)/* overload */;
	void __fastcall AddStrings(const System::TArray__1<System::UnicodeString> Strings, const System::TArray__1<System::TObject*> Objects)/* overload */;
	virtual void __fastcall Assign(TPersistent* Source);
...
public:
	inline void __fastcall  AddStrings(const System::TArray__1<System::UnicodeString> Strings){ TStrings::AddStrings(Strings); }
	inline void __fastcall  AddStrings(const System::TArray__1<System::UnicodeString> Strings, const System::TArray__1<System::TObject*> Objects){ TStrings::AddStrings(Strings, Objects); }
...
#else /* __aarch64__ */
	virtual void __fastcall SetSize _DEPRECATED_ATTRIBUTE0 (long NewSize)/* overload */;
#endif /* __aarch64__ */
...
public:
	...
	long __fastcall Read(System::TArray__1<System::Byte> &Buffer, long Count)/* overload */;
	long __fastcall Write(const System::TArray__1<System::Byte> Buffer, long Count)/* overload */;
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	inline long __fastcall  Read(System::TArray__1<System::Byte> &Buffer, long Count){ return TStream::Read(Buffer, Count); }
	inline long __fastcall  Write(const System::TArray__1<System::Byte> Buffer, long Count){ return TStream::Write(Buffer, Count); }
	inline long __fastcall  Seek(long Offset, System::Word Origin){ return TStream::Seek(Offset, Origin); }
#endif /* __aarch64__ */
...
#else /* __aarch64__ */
	inline void __fastcall  SetSize(long NewSize){ THandleStream::SetSize(NewSize); }
#endif /* __aarch64__ */
...
public:
	...
	virtual int __fastcall Write(const System::TArray__1<System::Byte> Buffer, int Offset, int Count)/* overload */ _FINAL_ATTRIBUTE;
#else /* __aarch64__ */
	virtual long __fastcall Write(const void *Buffer, long Count)/* overload */ _FINAL_ATTRIBUTE;
	virtual long __fastcall Write(const System::TArray__1<System::Byte> Buffer, long Offset, long Count)/* overload */ _FINAL_ATTRIBUTE;
#endif /* __aarch64__ */
	/* Hoisted overloads: */
...
public:
	...
	virtual HRESULT __stdcall CopyTo(System::Types::_di_IStream stm, unsigned __int64 cb, /* out */ unsigned __int64 &cbRead, /* out */ unsigned __int64 &cbWritten);
	...
	virtual HRESULT __stdcall Stat(/* out */ System::Types::tagSTATSTG &statstg, unsigned grfStatFlag);
	virtual HRESULT __stdcall Clone(/* out */ System::Types::_di_IStream &stm);
...
private:
	void *__IStream;	// System::Types::IStream 
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {0000000C-0000-0000-C000-000000000046}
	operator System::Types::_di_IStream()
	{
		System::Types::_di_IStream intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator System::Types::IStream*(void) { return (System::Types::IStream*)&__IStream; }
	#endif
...
private:
	...
	pthread_mutex_t FCreateSuspendedMutex;
...
private:
	...
	int __fastcall GetPolicy();
	void __fastcall SetPolicy(int Value);
...
public:
...
#else /* __aarch64__ */
	unsigned long __fastcall WaitFor();
#endif /* __aarch64__ */
	void __fastcall Schedule(int APolicy, int APriority);
...
#ifndef __aarch64__
	static void __fastcall NameThreadForDebugging(System::AnsiString AThreadName, NativeUInt AThreadID = (NativeUInt)(0xffffffff))/* overload */;
	static void __fastcall NameThreadForDebugging(System::UnicodeString AThreadName, NativeUInt AThreadID = (NativeUInt)(0xffffffff))/* overload */;
#else /* __aarch64__ */
	static void __fastcall NameThreadForDebugging(System::AnsiString AThreadName, NativeUInt AThreadID = (NativeUInt)(0xffffffffffffffffULL))/* overload */;
	static void __fastcall NameThreadForDebugging(System::UnicodeString AThreadName, NativeUInt AThreadID = (NativeUInt)(0xffffffffffffffffULL))/* overload */;
#endif /* __aarch64__ */
	...
	__property int Policy = {read=GetPolicy, write=SetPolicy, nodefault};
	__property bool Started = {read=FStarted, nodefault};
	__property bool Suspended = {read=FSuspended, write=SetSuspended, nodefault};
#ifndef __aarch64__
	__property NativeUInt ThreadID = {read=FThreadID, nodefault};
#else /* __aarch64__ */
	__property NativeUInt ThreadID = {read=FThreadID};
#endif /* __aarch64__ */
...
enum DECLSPEC_DENUM System_Classes__55 : unsigned char { csLoading, csReading, csWriting, csDestroying, csDesigning, csAncestor, csUpdating, csFixups, csFreeNotification, csInline, csDesignInstance };

typedef System::Set<System_Classes__55, System_Classes__55::csLoading, System_Classes__55::csDesignInstance> TComponentState;

enum DECLSPEC_DENUM System_Classes__65 : unsigned char { csInheritable, csCheckPropAvail, csSubComponent, csTransient };
...
_DECLARE_STRING_TYPE_ALIAS(System::UnicodeString, TComponentName);
...
public:
	static constexpr System::Int8 EditLinkID = System::Int8(0x1);
	
	static constexpr System::Int8 EditGridLinkID = System::Int8(0x2);
	
	static constexpr System::Int8 PositionLinkID = System::Int8(0x3);
	
	static constexpr System::Int8 ControlValueID = System::Int8(0x4);
	
	static constexpr System::Int8 MappedID = System::Int8(0x64);
...
#pragma pack(push,4)
#endif /* not __aarch64__ */
class PASCALIMPLEMENTATION ObservableMemberExtAttribute : public ObservableMemberAttribute
{
	typedef ObservableMemberAttribute inherited;
...
public:
	__fastcall ObservableMemberExtAttribute(const System::UnicodeString AMemberName, const System::UnicodeString AFramework, bool ATrack)/* overload */;
	__fastcall ObservableMemberExtAttribute(const System::UnicodeString AMemberName, bool ATrack)/* overload */;
	__property System::UnicodeString Framework = {read=FFramework};
	__property bool Track = {read=FTrack, nodefault};
public:
	/* ObservableMemberAttribute.Create */ inline __fastcall ObservableMemberExtAttribute(const System::UnicodeString AMemberName)/* overload */ : ObservableMemberAttribute(AMemberName) { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~ObservableMemberExtAttribute() { }
...
protected:
	...
	DYNAMIC void __fastcall PaletteCreated();
...
public:
	#define TLoginCredentialService_Default u""
	
	#define TLoginCredentialService_DefaultUsrPw u"DefaultUsrPw"
	
	#define TLoginCredentialService_DefaultUsrPwDm u"DefaultUsrPwDm"
...
//-- var, const, procedure ---------------------------------------------------
static constexpr int MaxListSize _DEPRECATED_ATTRIBUTE0  = int(0x7ffffff);
static constexpr System::Int8 soFromBeginning = System::Int8(0x0);
static constexpr System::Int8 soFromCurrent = System::Int8(0x1);
static constexpr System::Int8 soFromEnd = System::Int8(0x2);
static constexpr System::Word fmCreate = System::Word(0xff00);
static constexpr System::WideChar toEOF = (System::WideChar)(0x0);
static constexpr System::WideChar toSymbol = (System::WideChar)(0x1);
static constexpr System::WideChar toString = (System::WideChar)(0x2);
static constexpr System::WideChar toInteger = (System::WideChar)(0x3);
static constexpr System::WideChar toFloat = (System::WideChar)(0x4);
static constexpr System::WideChar toWString = (System::WideChar)(0x5);
static constexpr System::Word scCommand = System::Word(0x1000);
static constexpr System::Word scShift = System::Word(0x2000);
static constexpr System::Word scCtrl = System::Word(0x4000);
static constexpr System::Word scAlt = System::Word(0x8000);
static constexpr System::Int8 scNone = System::Int8(0x0);
static constexpr System::Int8 pidWin32 = System::Int8(0x1);
static constexpr System::Int8 pidWin64 = System::Int8(0x2);
static constexpr System::Int8 pidOSX32 = System::Int8(0x4);
static constexpr System::Int8 pidiOSSimulator32 = System::Int8(0x8);
static constexpr System::Int8 pidiOSSimulator _DEPRECATED_ATTRIBUTE1("Use pidiOSSimulator32")  = System::Int8(0x8);
static constexpr System::Int8 pidAndroid32Arm = System::Int8(0x10);
static constexpr System::Int8 pidAndroid _DEPRECATED_ATTRIBUTE1("Use pidAndroid32Arm")  = System::Int8(0x10);
static constexpr System::Int8 pidLinux32 = System::Int8(0x20);
static constexpr System::Int8 pidiOSDevice32 = System::Int8(0x40);
static constexpr System::Int8 pidiOSDevice _DEPRECATED_ATTRIBUTE1("Use pidiOSDevice32")  = System::Int8(0x40);
static constexpr System::Byte pidLinux64 = System::Byte(0x80);
static constexpr System::Word pidWinNX32 = System::Word(0x100);
static constexpr System::Word pidWinIoT32 = System::Word(0x200);
static constexpr System::Word pidiOSDevice64 = System::Word(0x400);
static constexpr System::Word pidWinARM32 = System::Word(0x800);
static constexpr System::Word pidOSX64 = System::Word(0x1000);
static constexpr System::Word pidLinux32Arm = System::Word(0x2000);
static constexpr System::Word pidLinux64Arm = System::Word(0x4000);
static constexpr System::Word pidAndroid64Arm = System::Word(0x8000);
static constexpr int pidiOSSimulator64 = int(0x10000);
static constexpr int pidAllPlatforms = int(0x194df);
static constexpr System::Int8 pfidWindows = System::Int8(0x3);
static constexpr System::Word pfidOSX = System::Word(0x1004);
static constexpr int pfidiOS = int(0x10448);
static constexpr System::Word pfidAndroid = System::Word(0x8010);
static constexpr System::Byte pfidLinux = System::Byte(0x80);
...
extern DELPHI_PACKAGE Posix::Unistd::TPipeDescriptors SyncEvent;
