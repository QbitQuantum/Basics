...
// (DO NOT EDIT: machine generated header) 'IdStackVCLPosix.pas' rev: 34.00 (Android)
...
class PASCALIMPLEMENTATION EIdAccessWifiStatePermissionNeeded : public Idstack::EIdAndroidPermissionNeeded
{
	typedef Idstack::EIdAndroidPermissionNeeded inherited;
	
public:
	/* EIdSocketError.CreateError */ inline __fastcall virtual EIdAccessWifiStatePermissionNeeded(const int AErr, const System::UnicodeString AMsg) : Idstack::EIdAndroidPermissionNeeded(AErr, AMsg) { }
	
public:
	/* EIdException.Create */ inline __fastcall virtual EIdAccessWifiStatePermissionNeeded(const System::UnicodeString AMsg)/* overload */ : Idstack::EIdAndroidPermissionNeeded(AMsg) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EIdAccessWifiStatePermissionNeeded(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : Idstack::EIdAndroidPermissionNeeded(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EIdAccessWifiStatePermissionNeeded(NativeUInt Ident)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EIdAccessWifiStatePermissionNeeded(System::PResStringRec ResStringRec)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdAccessWifiStatePermissionNeeded(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdAccessWifiStatePermissionNeeded(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EIdAccessWifiStatePermissionNeeded(const System::UnicodeString Msg, int AHelpContext) : Idstack::EIdAndroidPermissionNeeded(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EIdAccessWifiStatePermissionNeeded(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : Idstack::EIdAndroidPermissionNeeded(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdAccessWifiStatePermissionNeeded(NativeUInt Ident, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdAccessWifiStatePermissionNeeded(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdAccessWifiStatePermissionNeeded(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdAccessWifiStatePermissionNeeded(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident, Args, Args_High, AHelpContext) { }
...
#pragma pack(push,4)
#endif /* not __aarch64__ */
class PASCALIMPLEMENTATION EIdAccessNetworkStatePermissionNeeded : public Idstack::EIdAndroidPermissionNeeded
{
	typedef Idstack::EIdAndroidPermissionNeeded inherited;
	
public:
	/* EIdSocketError.CreateError */ inline __fastcall virtual EIdAccessNetworkStatePermissionNeeded(const int AErr, const System::UnicodeString AMsg) : Idstack::EIdAndroidPermissionNeeded(AErr, AMsg) { }
	
public:
	/* EIdException.Create */ inline __fastcall virtual EIdAccessNetworkStatePermissionNeeded(const System::UnicodeString AMsg)/* overload */ : Idstack::EIdAndroidPermissionNeeded(AMsg) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : Idstack::EIdAndroidPermissionNeeded(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(NativeUInt Ident)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(System::PResStringRec ResStringRec)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(const System::UnicodeString Msg, int AHelpContext) : Idstack::EIdAndroidPermissionNeeded(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : Idstack::EIdAndroidPermissionNeeded(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(NativeUInt Ident, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdAccessNetworkStatePermissionNeeded(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Idstack::EIdAndroidPermissionNeeded(Ident, Args, Args_High, AHelpContext) { }
