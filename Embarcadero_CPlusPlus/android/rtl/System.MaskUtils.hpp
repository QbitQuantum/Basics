...
// (DO NOT EDIT: machine generated header) 'System.MaskUtils.pas' rev: 34.00 (Android)
...
_DECLARE_STRING_TYPE_ALIAS(System::UnicodeString, TMaskedText);

_DECLARE_STRING_TYPE_ALIAS(System::UnicodeString, TEditMask);

//-- var, const, procedure ---------------------------------------------------
static constexpr System::WideChar mDirReverse = (System::WideChar)(0x21);
static constexpr System::WideChar mDirUpperCase = (System::WideChar)(0x3e);
static constexpr System::WideChar mDirLowerCase = (System::WideChar)(0x3c);
static constexpr System::WideChar mDirLiteral = (System::WideChar)(0x5c);
static constexpr System::WideChar mMskAlpha = (System::WideChar)(0x4c);
static constexpr System::WideChar mMskAlphaOpt = (System::WideChar)(0x6c);
static constexpr System::WideChar mMskAlphaNum = (System::WideChar)(0x41);
static constexpr System::WideChar mMskAlphaNumOpt = (System::WideChar)(0x61);
static constexpr System::WideChar mMskAscii = (System::WideChar)(0x43);
static constexpr System::WideChar mMskAsciiOpt = (System::WideChar)(0x63);
static constexpr System::WideChar mMskNumeric = (System::WideChar)(0x30);
static constexpr System::WideChar mMskNumericOpt = (System::WideChar)(0x39);
static constexpr System::WideChar mMskNumSymOpt = (System::WideChar)(0x23);
static constexpr System::WideChar mMskTimeSeparator = (System::WideChar)(0x3a);
static constexpr System::WideChar mMskDateSeparator = (System::WideChar)(0x2f);
