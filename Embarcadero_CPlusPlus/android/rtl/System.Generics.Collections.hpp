...
// (DO NOT EDIT: machine generated header) 'System.Generics.Collections.pas' rev: 34.00 (Android)
...
template<typename T> class DELPHICLASS _TList__1_Pack_1__ActRec;
template<typename T> class DELPHICLASS _TList__1_Pack_0__ActRec;
//-- type declarations -------------------------------------------------------
#ifndef __aarch64__
#pragma pack(push,4)
