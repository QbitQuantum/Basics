...
// (DO NOT EDIT: machine generated header) 'FMX.Grid.Style.pas' rev: 34.00 (Android)
...
public:
	static constexpr System::Int8 MinSize = System::Int8(0xa);
	
	static System::Uitypes::TAlphaColor AlternatingBackgroundColor;
	static System::Uitypes::TAlphaColor LineColor;
	static constexpr System::Int8 DefaultRowHeight = System::Int8(0x15);
	
	static constexpr System::Int8 DefaultThickness = System::Int8(0x1);
