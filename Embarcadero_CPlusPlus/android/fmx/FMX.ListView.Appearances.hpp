...
// (DO NOT EDIT: machine generated header) 'FMX.ListView.Appearances.pas' rev: 34.00 (Android)
...
public:
	#define TAppearanceNames_Empty u""
	
	#define TAppearanceNames_Null u"Null"
	
	#define TAppearanceNames_Custom u"Custom"
	
	#define TAppearanceNames_ListHeader u"ListHeader"
	
	#define TAppearanceNames_ListItem u"ListItem"
	
	#define TAppearanceNames_ListItemDelete u"ListItemDelete"
	
	#define TAppearanceNames_ListItemShowCheck u"ListItemShowCheck"
	
	#define TAppearanceNames_ListItemRightDetail u"ListItemRightDetail"
	
	#define TAppearanceNames_ListItemRightDetailDelete u"ListItemRightDetailDelete"
	
	#define TAppearanceNames_ListItemRightDetailShowCheck u"ListItemRightDetailShowCheck"
	
	#define TAppearanceNames_ImageListItem u"ImageListItem"
	
	#define TAppearanceNames_ImageListItemDelete u"ImageListItemDelete"
	
	#define TAppearanceNames_ImageListItemShowCheck u"ImageListItemShowCheck"
	
	#define TAppearanceNames_ImageListItemBottomDetail u"ImageListItemBottomDetail"
	
	#define TAppearanceNames_ImageListItemBottomDetailShowCheck u"ImageListItemBottomDetailShowCheck"
	
	#define TAppearanceNames_ImageListItemBottomDetailRightButton u"ImageListItemBottomDetailRightButton"
	
	#define TAppearanceNames_ImageListItemBottomDetailRightButtonShowCheck u"ImageListItemBottomDetailRightButtonShowCheck"
	
	#define TAppearanceNames_ImageListItemRightButton u"ImageListItemRightButton"
	
	#define TAppearanceNames_ImageListItemRightButtonDelete u"ImageListItemRightButtonDelete"
	
	#define TAppearanceNames_ImageListItemRightButtonShowCheck u"ImageListItemRightButtonShowCheck"
...
public:
	...
	public:
		static constexpr System::WideChar Text = (System::WideChar)(0x54);
		
		static constexpr System::WideChar Detail = (System::WideChar)(0x44);
		
		static constexpr System::WideChar Accessory = (System::WideChar)(0x41);
		
		static constexpr System::WideChar TextButton = (System::WideChar)(0x42);
		
		static constexpr System::WideChar GlyphButton = (System::WideChar)(0x47);
		
		static constexpr System::WideChar Image = (System::WideChar)(0x49);
	...
	public:
		#define TListViewItem_TMemberNames_Text u"Text"
		
		#define TListViewItem_TMemberNames_Detail u"Detail"
		
		#define TListViewItem_TMemberNames_ButtonText u"ButtonText"
		
		#define TListViewItem_TMemberNames_Bitmap u"Bitmap"
		
		#define TListViewItem_TMemberNames_ImageIndex u"ImageIndex"
...
private:
	static constexpr System::Int8 cDefaultHeight = System::Int8(0x2c);
	
	static constexpr System::Int8 cDefaultHeaderHeight = System::Int8(0x18);
...
public:
	...
	static constexpr System::Int8 cDefaultButtonHeight = System::Int8(0x1f);
	
	static constexpr System::Int8 cDefaultTextButtonWidth = System::Int8(0x40);
	
	static constexpr System::Int8 cDefaultImageWidth = System::Int8(0x1d);
	
	static constexpr System::Int8 cDefaultImageHeight = System::Int8(0x1d);
	
	static constexpr System::Int8 cDefaultImageTextPlaceOffsetX = System::Int8(0xa);
	
	static constexpr System::Int8 cDefaultGlyphPlaceOffsetX = System::Int8(-6);
...
T __fastcall TListViewItem::TListViewItemObjects::FindObjectT(const System::UnicodeString AName) {
  TListItemDrawable* LObject = FindDrawable(AName);
