...
// (DO NOT EDIT: machine generated header) 'FMX.Grid.pas' rev: 34.00 (Android)
...
public:
	static constexpr System::Int8 HorzTextMargin = System::Int8(0x3);
	
	static constexpr System::Int8 VertTextMargin = System::Int8(0x3);
...
public:
	static constexpr System::Int8 DefaultMax = System::Int8(0x64);
...
public:
	#define TCheckColumn_StrStyleName u"checkcellstyle"
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_CONTENT_CHANGED = System::Word(0x1710);
static constexpr System::Word MM_COLUMN_CHANGED = System::Word(0x1711);
static constexpr System::Word MM_COLUMN_MOVED = System::Word(0x1712);
static constexpr System::Word MM_SEL_CHANGED = System::Word(0x1713);
static constexpr System::Word MM_INVALIDATE_CELL = System::Word(0x1714);
static constexpr System::Word MM_INVALIDATE_CONTENT_SIZE = System::Word(0x1715);
static constexpr System::Word MM_GET_ROW_HEIGHT = System::Word(0x1716);
static constexpr System::Word MM_CELL_RECT = System::Word(0x1717);
static constexpr System::Word MM_SHOW_EDITOR = System::Word(0x1718);
static constexpr System::Word MM_HIDE_EDITOR = System::Word(0x1719);
static constexpr System::Word MM_EDITOR_MODE = System::Word(0x171a);
static constexpr System::Word MM_GET_EDITOR_VALUE = System::Word(0x171b);
static constexpr System::Word MM_POST_EDITOR_VALUE = System::Word(0x171c);
static constexpr System::Word MM_REFRESH_EDITOR_VALUE = System::Word(0x171d);
static constexpr System::Word MM_GRID_USER = System::Word(0x171e);
static constexpr System::Word PM_CREATE_CELL_OBJECT = System::Word(0x100b);
static constexpr System::Word PM_CAN_EDIT = System::Word(0x100c);
static constexpr System::Word PM_CELL_BY_POINT = System::Word(0x100d);
static constexpr System::Word PM_SET_TOP_LEFT = System::Word(0x100e);
static constexpr System::Word PM_GET_DISPLAY_CELLS = System::Word(0x100f);
static constexpr System::Word PM_SCROLL_TO_SELECT = System::Word(0x1010);
static constexpr System::Word PM_VKDISPLACEMENT = System::Word(0x1011);
static constexpr System::Word PM_GRID_USER = System::Word(0x1019);
}	/* namespace Grid */
}	/* namespace Fmx */
