...
// (DO NOT EDIT: machine generated header) 'FMX.Edit.pas' rev: 34.00 (Android)
...
public:
	...
	static constexpr unsigned DefaultFontColor = unsigned(0xff000000);
	
	static constexpr bool DefaultInputSupport = true;
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_EDIT_SELSTART_CHANGED = System::Word(0x1701);
static constexpr System::Word MM_EDIT_SELLENGTH_CHANGED = System::Word(0x1702);
static constexpr System::Word MM_EDIT_READONLY_CHANGED = System::Word(0x1703);
static constexpr System::Word MM_EDIT_MAXLENGTH_CHANGED = System::Word(0x1704);
static constexpr System::Word MM_EDIT_ISPASSWORD_CHANGED = System::Word(0x1705);
static constexpr System::Word MM_EDIT_IMEMODE_CHANGED = System::Word(0x1706);
static constexpr System::Word MM_EDIT_KEYBOARDTYPE_CHANGED = System::Word(0x1707);
static constexpr System::Word MM_EDIT_RETURNKEYTYPE_CHANGED = System::Word(0x1708);
static constexpr System::Word MM_EDIT_KILLFOCUSBYRETURN_CHANGED = System::Word(0x1709);
static constexpr System::Word MM_EDIT_CHECKSPELLING_CHANGED = System::Word(0x170a);
static constexpr System::Word MM_EDIT_PROMPTTEXT_CHANGED = System::Word(0x170b);
static constexpr System::Word MM_EDIT_CARETPOSITION_CHANGED = System::Word(0x170f);
static constexpr System::Word MM_EDIT_CARETCHANGED = System::Word(0x1710);
static constexpr System::Word MM_EDIT_TYPING_CHANGED = System::Word(0x1711);
static constexpr System::Word MM_EDIT_TEXT_SETTINGS_CHANGED = System::Word(0x1712);
static constexpr System::Word MM_EDIT_TEXT_CHANGED = System::Word(0x1713);
static constexpr System::Word MM_EDIT_EDITBUTTONS_CHANGED = System::Word(0x1715);
static constexpr System::Word MM_EDIT_TEXT_CHANGING = System::Word(0x1716);
static constexpr System::Word MM_EDIT_CHARCASE_CHANGED = System::Word(0x1717);
static constexpr System::Word MM_EDIT_FILTERCHAR_CHANGED = System::Word(0x1718);
static constexpr System::Word MM_EDIT_GET_CARET_POSITION_BY_POINT = System::Word(0x1719);
static constexpr System::Word MM_EDIT_USER = System::Word(0x171a);
static constexpr System::Word PM_EDIT_REALIGN_BUTTONS_CONTAINER = System::Word(0x1001);
static constexpr System::Word PM_EDIT_GET_TEXT_CONTENT_RECT = System::Word(0x1002);
static constexpr System::Word PM_EDIT_USER = System::Word(0x1003);
}	/* namespace Edit */
}	/* namespace Fmx */
