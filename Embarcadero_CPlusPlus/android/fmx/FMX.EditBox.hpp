...
// (DO NOT EDIT: machine generated header) 'FMX.EditBox.pas' rev: 34.00 (Android)
...
public:
	static constexpr System::Int8 DefaultDecimalDigits = System::Int8(0x2);
	
	static constexpr System::Int8 DefaultHorzIncrement = System::Int8(0x1);
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_DECIMALDIGITS_CHANGED = System::Word(0x171b);
static constexpr System::Word MM_VALUETYPE_CHANGED = System::Word(0x171c);
static constexpr System::Word MM_VALUERANGE_CHANGED = System::Word(0x171d);
static constexpr System::Word MM_HORZ_INCREMENT_CHANGED = System::Word(0x171e);
static constexpr System::Word MM_EDITBOX_USER = System::Word(0x171f);
}	/* namespace Editbox */
}	/* namespace Fmx */
