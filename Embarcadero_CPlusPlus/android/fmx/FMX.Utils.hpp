...
// (DO NOT EDIT: machine generated header) 'FMX.Utils.pas' rev: 34.00 (Android)
...
struct TCircle2D;
struct TLine2D;
template<typename T> class DELPHICLASS _TFMXObjectHelper_FindNearestParentOfClass_ActRec__1;
//-- type declarations -------------------------------------------------------
