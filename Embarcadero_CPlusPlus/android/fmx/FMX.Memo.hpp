...
// (DO NOT EDIT: machine generated header) 'FMX.Memo.pas' rev: 34.00 (Android)
...
public:
	static constexpr bool DefaultAutoSelect = false;
	
	static const System::Uitypes::TEditCharCase DefaultCharCase = (System::Uitypes::TEditCharCase)(0);
	
	static constexpr bool DefaultHideSelectionOnExit = true;
	
	static const Fmx::Types::TVirtualKeyboardType DefaultKeyboardType = (Fmx::Types::TVirtualKeyboardType)(0);
	
	static constexpr System::Int8 DefaultMaxLength = System::Int8(0x0);
	
	static constexpr bool DefaultReadOnly = false;
	
	static constexpr unsigned DefaultSelectionColor = unsigned(0x802a8adf);
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_MEMO_CARETCHANGED = System::Word(0x1710);
static constexpr System::Word MM_MEMO_READONLY_CHANGED = System::Word(0x1711);
static constexpr System::Word MM_MEMO_CHECKSPELLING_CHANGED = System::Word(0x1712);
static constexpr System::Word MM_MEMO_IMEMODE_CHANGED = System::Word(0x1713);
static constexpr System::Word MM_MEMO_KEYBOARDTYPE_CHANGED = System::Word(0x1714);
static constexpr System::Word MM_MEMO_TEXT_SETTINGS_CHANGED = System::Word(0x1715);
static constexpr System::Word MM_MEMO_AUTOSELECT_CHANGED = System::Word(0x1716);
static constexpr System::Word MM_MEMO_CHARCASE_CHANGED = System::Word(0x1717);
static constexpr System::Word MM_MEMO_HIDESELECTIONONEXIT_CHANGED = System::Word(0x1718);
static constexpr System::Word MM_MEMO_MAXLENGTH_CHANGED = System::Word(0x1719);
static constexpr System::Word MM_MEMO_LINES_CHANGED = System::Word(0x171a);
static constexpr System::Word MM_MEMO_TEXT_CHANGING = System::Word(0x171b);
static constexpr System::Word MM_MEMO_GET_CARET_POSITION = System::Word(0x171c);
static constexpr System::Word MM_MEMO_SET_CARET_POSITION = System::Word(0x171d);
static constexpr System::Word MM_MEMO_SELSTART_CHANGED = System::Word(0x171e);
static constexpr System::Word MM_MEMO_SELLENGTH_CHANGED = System::Word(0x171f);
static constexpr System::Word MM_MEMO_DATADETECTORTYPES_CHANGED = System::Word(0x1720);
static constexpr System::Word MM_MEMO_LINES_INSERT_LINE = System::Word(0x1721);
static constexpr System::Word MM_MEMO_LINES_PUT_LINE = System::Word(0x1722);
static constexpr System::Word MM_MEMO_LINES_DELETE_LINE = System::Word(0x1723);
static constexpr System::Word MM_MEMO_LINES_EXCHANGE_LINES = System::Word(0x1724);
static constexpr System::Word MM_MEMO_LINES_CLEAR = System::Word(0x1725);
static constexpr System::Word MM_MEMO_UPDATE_STATE_CHANGED = System::Word(0x1726);
static constexpr System::Word MM_MEMO_CAN_SET_FOCUS = System::Word(0x172e);
static constexpr System::Word MM_MEMO_GET_CARET_POSITION_BY_POINT = System::Word(0x172f);
static constexpr System::Word MM_MEMO_USER = System::Word(0x1730);
static constexpr System::Word PM_MEMO_GOTO_LINE_BEGIN = System::Word(0x100b);
static constexpr System::Word PM_MEMO_GOTO_LINE_END = System::Word(0x100c);
static constexpr System::Word PM_MEMO_GOTO_TEXT_BEGIN _DEPRECATED_ATTRIBUTE0  = System::Word(0x100d);
static constexpr System::Word PM_MEMO_GOTO_TEXT_END _DEPRECATED_ATTRIBUTE0  = System::Word(0x100e);
static constexpr System::Word PM_MEMO_UNDO_MANAGER_INSERT_TEXT = System::Word(0x100f);
static constexpr System::Word PM_MEMO_UNDO_MANAGER_DELETE_TEXT = System::Word(0x1010);
static constexpr System::Word PM_MEMO_UNDO_MANAGER_UNDO = System::Word(0x1011);
static constexpr System::Word PM_MEMO_SELECT_TEXT = System::Word(0x1012);
static constexpr System::Word PM_MEMO_USER = System::Word(0x1013);
}	/* namespace Memo */
}	/* namespace Fmx */
