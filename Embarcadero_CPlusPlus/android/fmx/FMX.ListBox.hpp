...
// (DO NOT EDIT: machine generated header) 'FMX.ListBox.pas' rev: 34.00 (Android)
...
struct TListGroupingKindHelper /* Helper for enum 'TListGroupingKind' */;
...
private:
	#define TListBoxItemData_StyleSelectorMore u"accessorymore.Visible"
	
	#define TListBoxItemData_StyleSelectorDetail u"accessorydetail.Visible"
	
	#define TListBoxItemData_StyleSelectorCheckmark u"accessorycheckmark.Visible"
...
enum class DECLSPEC_DENUM TListGroupingKind : unsigned char { Plain, Grouped, gsPlain _DEPRECATED_ATTRIBUTE3("Use TListGroupingKind.Plain")  = 0x0, gsGrouped _DEPRECATED_ATTRIBUTE3("Use TListGroupingKind.Grouped")  = 0x1 };
...
public:
	...
	struct TStringsChangeOpHelper /* Helper for enum 'TStringsChangeOp' */;
...
private:
	...
	void __fastcall InitSelectionObjects();
	void __fastcall FreeSelectionObjects();
