...
// (DO NOT EDIT: machine generated header) 'FMX.ListView.pas' rev: 34.00 (Android)
...
private:
	...
	static constexpr System::Int8 PhysicsProcessingInterval = System::Int8(0x8);
	
	static constexpr System::Int8 RecurrentTimerInterval = System::Int8(0x10);
	
	static constexpr System::Int8 AutoTapScrollingSpeed = System::Int8(0x8);
	
	static constexpr System::Int8 AutoTapMaxScrollingTime = System::Int8(0x1);
	...
	static constexpr System::Int8 MinScrollThreshold = System::Int8(0xa);
	
	static constexpr System::Int8 MinSwypeThreshold = System::Int8(0x28);
	
	static constexpr System::Int8 DefaultDeleteButtonWidth = System::Int8(0x48);
	
	static constexpr System::Int8 ItemSeparatorTop = System::Int8(0x1);
	
	static constexpr System::Int8 ItemSeparatorBottom = System::Int8(0x2);
	...
	#define TListViewBase_DefaultDeleteButtonText u"Delete"
	
	static constexpr System::Int8 PullRefreshIndicatorStrengthStart = System::Int8(0x10);
	
	static constexpr System::Int8 PullRefreshIndicatorMaxSteps = System::Int8(0xc);
	
	static constexpr System::Int8 DefaultLeftMargin = System::Int8(0xa);
	
	static constexpr System::Int8 DefaultRightMargin = System::Int8(0xb);
