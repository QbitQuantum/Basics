...
// (DO NOT EDIT: machine generated header) 'FMX.NumberBox.Style.pas' rev: 34.00 (Android)
...
public:
	static constexpr System::Int8 Backlash = System::Int8(0x5);
	
	static constexpr System::Int8 MinimumMovement = System::Int8(0x1);
