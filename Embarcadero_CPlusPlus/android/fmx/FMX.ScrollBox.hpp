...
// (DO NOT EDIT: machine generated header) 'FMX.ScrollBox.pas' rev: 34.00 (Android)
...
public:
	...
	static constexpr bool DefaultAutoCalculateContentSize = true;
	
	static const Fmx::Behaviormanager::TBehaviorBoolean DefaultBounces = (Fmx::Behaviormanager::TBehaviorBoolean)(2);
	
	static constexpr bool DefaultEnabledScroll = true;
	
	static constexpr bool DefaultShowScrollBars = true;
...
//-- var, const, procedure ---------------------------------------------------
static constexpr System::Word MM_AUTOHIDE_CHANGED = System::Word(0x1701);
static constexpr System::Word MM_BOUNCES_CHANGED = System::Word(0x1702);
static constexpr System::Word MM_DISABLE_MOUSE_WHEEL_CHANGED = System::Word(0x1703);
static constexpr System::Word MM_ENABLED_SCROLL_CHANGED = System::Word(0x1704);
static constexpr System::Word MM_SCROLLBAR_VISIBLE_CHANGED = System::Word(0x1705);
static constexpr System::Word MM_SHOW_SIZE_GRIP_CHANGED = System::Word(0x1706);
static constexpr System::Word MM_SHOW_SCROLLBAR_CHANGED = System::Word(0x1707);
static constexpr System::Word MM_GET_VIEWPORT_POSITION = System::Word(0x1708);
static constexpr System::Word MM_SET_VIEWPORT_POSITION = System::Word(0x1709);
static constexpr System::Word MM_GET_VIEWPORT_SIZE = System::Word(0x170a);
static constexpr System::Word MM_SCROLL_ANIMATION_CHANGED = System::Word(0x170b);
static constexpr System::Word MM_SCROLL_DIRECTIONS_CHANGED = System::Word(0x170c);
static constexpr System::Word MM_SET_CONTENT_BOUNDS = System::Word(0x170d);
static constexpr System::Word MM_TOUCH_TRACKING_CHANGED = System::Word(0x170e);
static constexpr System::Word MM_SCROLLBOX_USER = System::Word(0x170f);
static constexpr System::Word PM_SCROLL_BY = System::Word(0x1001);
static constexpr System::Word PM_SCROLL_IN_RECT = System::Word(0x1002);
static constexpr System::Word PM_SET_CONTENT = System::Word(0x1003);
static constexpr System::Word PM_GET_CONTENT_LAYOUT = System::Word(0x1004);
static constexpr System::Word PM_GET_VSCROLLBAR = System::Word(0x1005);
static constexpr System::Word PM_GET_HSCROLLBAR = System::Word(0x1006);
static constexpr System::Word PM_GET_ANICALCULATIONS = System::Word(0x1007);
static constexpr System::Word PM_BEGIN_PAINT_CHILDREN = System::Word(0x1008);
static constexpr System::Word PM_END_PAINT_CHILDREN = System::Word(0x1009);
static constexpr System::Word PM_USER_SCROLLBOX = System::Word(0x100a);
