...
// (DO NOT EDIT: machine generated header) 'FMX.TabControl.pas' rev: 34.00 (Android)
...
public:
	#define TTabItem_DotStyleName u"tabdotstyle"
	
	static constexpr System::Int8 DotSize = System::Int8(0x8);
