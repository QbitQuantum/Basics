...
// (DO NOT EDIT: machine generated header) 'System.Messaging.pas' rev: 34.00 (iOS)
...
class PASCALIMPLEMENTATION TMessageReceivedNotification : public TMessage__1<Iosapi::Uikit::_di_UILocalNotification>
{
	typedef TMessage__1<Iosapi::Uikit::_di_UILocalNotification> inherited;
	
public:
	/* {System_Messaging}TMessage<iOSapi_UIKit_UILocalNotification>.Create */ inline __fastcall TMessageReceivedNotification(const Iosapi::Uikit::_di_UILocalNotification AValue) : TMessage__1<Iosapi::Uikit::_di_UILocalNotification>(AValue) { }
	/* {System_Messaging}TMessage<iOSapi_UIKit_UILocalNotification>.Destroy */ inline __fastcall virtual ~TMessageReceivedNotification() { }
