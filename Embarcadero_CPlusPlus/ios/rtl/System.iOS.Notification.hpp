...
// (DO NOT EDIT: machine generated header) 'System.iOS.Notification.pas' rev: 34.00 (iOS)

#ifndef System_Ios_NotificationHPP
#define System_Ios_NotificationHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYSTEM_IOS_NOTIFICATION)
using namespace System::Ios::Notification;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// System_Ios_NotificationHPP
