...
// (DO NOT EDIT: machine generated header) 'System.SysUtils.pas' rev: 34.00 (iOS)
...
typedef CFLocaleRef TLocaleID;

#pragma pack(push,1)
struct DECLSPEC_DRECORD TSysLocale
{
public:
	__CFLocale *DefaultLCID;
	int PriLangID;
	int SubLangID;
	bool FarEast;
	bool MiddleEast;
...
private:
	static __CFLocale *FDefaultLocale;
...
private:
	...
	CFLocaleRef __fastcall GetLocaleID(int Index);
	System::UnicodeString __fastcall GetLocaleName(int Index);
	System::UnicodeString __fastcall GetName(int Index);
	System::UnicodeString __fastcall GetNameFromLocaleID(CFLocaleRef ID);
	System::UnicodeString __fastcall GetNameFromLCID(const System::UnicodeString ID);
	CFLocaleRef __fastcall GetLocaleIDFromName(const System::UnicodeString LocaleName);
	int __fastcall GetCount();
	static CFLocaleRef __fastcall GetUserDefaultLocale();
	
public:
	__fastcall TLanguages();
	__fastcall virtual ~TLanguages();
	static CFLocaleRef __fastcall GetLocaleIDFromLocaleName(const System::UnicodeString LocaleName);
	int __fastcall IndexOf(CFLocaleRef ID)/* overload */;
	...
	__property System::UnicodeString NameFromLocaleID[CFLocaleRef ID] = {read=GetNameFromLocaleID};
	...
	__property CFLocaleRef LocaleID[int Index] = {read=GetLocaleID};
	__property CFLocaleRef LocaleIDFromName[const System::UnicodeString LocaleName] = {read=GetLocaleIDFromName};
	__property System::UnicodeString Ext[int Index] = {read=GetExt};
	/* static */ __property CFLocaleRef UserDefaultLocale = {read=GetUserDefaultLocale};
...
private:
	static void __fastcall GetEraInformation(CFLocaleRef Locale, CFDateFormatterRef Formatter, TFormatSettings &AFormatSettings);
	static void __fastcall GetDayNames(CFDateFormatterRef Formatter, TFormatSettings &AFormatSettings);
	static void __fastcall GetMonthNames(CFDateFormatterRef Formatter, TFormatSettings &AFormatSettings);
	static System::UnicodeString __fastcall TranslateDateFormat(CFLocaleRef Locale, int LocaleType, const System::UnicodeString Default, const System::WideChar Separator);
...
public:
	...
	static TFormatSettings __fastcall Create(CFLocaleRef Locale)/* overload */;
...
static constexpr System::Int8 RTL_SIGQUIT = System::Int8(0x1);
static constexpr System::Int8 RTL_SIGLAST = System::Int8(0x1);
...
static constexpr System::Word MAX_PATH = System::Word(0x400);
...
extern DELPHI_PACKAGE bool __fastcall StringToFileSystemString(const System::UnicodeString Source, System::TArray__1<System::Byte> &Dest);
extern DELPHI_PACKAGE bool __fastcall FileSystemStringToString(const char * Source, System::UnicodeString &Dest);
...
extern DELPHI_PACKAGE void __fastcall GetLocaleFormatSettings _DEPRECATED_ATTRIBUTE1("Use TFormatSettings.Create(Locale)") (CFLocaleRef Locale, TFormatSettings &AFormatSettings);
