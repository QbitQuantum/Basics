...
// (DO NOT EDIT: machine generated header) 'System.ZLib.pas' rev: 34.00 (iOS)
...
extern "C" int __cdecl inflateReset2(z_stream &strm, int windowBits);
extern "C" int __cdecl inflatePrime(z_stream &strm, int bits, int value);
extern "C" long __cdecl inflateMark(z_stream &strm);
...
extern "C" int __cdecl gzbuffer(void * file_, unsigned size);
...
extern "C" int __cdecl gzclose_r(void * file_);
extern "C" int __cdecl gzclose_w(void * file_);
...
extern "C" void * __cdecl gzopen64(char * path, char * mode);
extern "C" __int64 __cdecl gzseek64(void * file_, __int64 offset, int flush);
extern "C" __int64 __cdecl gztell64(void * file_);
extern "C" __int64 __cdecl gzoffset64(void * file_);
extern "C" unsigned long __cdecl adler32_combine64(unsigned long adler1, unsigned long adler2, __int64 len2);
extern "C" unsigned long __cdecl crc32_combine64(unsigned long crc1, unsigned long crc2, __int64 len2);
...
extern "C" long __cdecl gzoffset(void * file_);
...
extern "C" int __cdecl inflateUndermine(z_streamp stream, int size);
