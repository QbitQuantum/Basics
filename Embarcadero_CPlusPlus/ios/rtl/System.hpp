...
// (DO NOT EDIT: machine generated header) 'System.pas' rev: 34.00 (iOS)
...
struct DECLSPEC_DRECORD TSchedParam
{
public:
	int sched_priority;
	System::StaticArray<Byte, 4> opaque;
};
...
static constexpr System::Int8 PTHREAD_ATTR_SIZE = System::Int8(0x24);
static constexpr System::Int8 SCHED_PARAM_SIZE = System::Int8(0x4);
...
static constexpr int ferUPWARD = int(0x400000);
static constexpr int ferDOWNWARD = int(0x800000);
static constexpr int ferTOWARDZERO = int(0xc00000);
static constexpr int ferALLROUND = int(0xc00000);
...
static constexpr unsigned __int64 CPPExceptionPersonality = 0x434c4e47432b2b00ULL;
static constexpr unsigned __int64 CPPExceptionPersonality1 = 0x434c4e47432b2b01ULL;
...
extern DELPHI_PACKAGE void * __fastcall UTF8CompareLocale(void);
extern DELPHI_PACKAGE char * __fastcall UTF8CompareLocaleName(void);
