...
// (DO NOT EDIT: machine generated header) 'Vcl.VirtualImageList.pas' rev: 34.00 (Windows)
...
__published:
	__property int CollectionIndex = {read=FCollectionIndex, write=SetCollectionIndex, nodefault};
	__property System::UnicodeString CollectionName = {read=FCollectionName, write=SetCollectionName};
	__property bool Disabled = {read=FDisabled, write=SetDisabled, nodefault};
...
__published:
	...
	__property System::UnicodeString DisabledSuffix = {read=FDisabledSuffix, write=SetDisabledSuffix};
	__property TVirtualImageListItems* Images = {read=FImages, write=FImages};
