...
// (DO NOT EDIT: machine generated header) 'Vcl.OleAuto.pas' rev: 34.00 (Windows)
...
extern DELPHI_PACKAGE Winapi::Ole2::TGUID __fastcall StringToClassID(const System::UnicodeString S);
extern DELPHI_PACKAGE System::UnicodeString __fastcall ClassIDToString(const Winapi::Ole2::TGUID &ClassID);
extern DELPHI_PACKAGE Winapi::Ole2::TGUID __fastcall ProgIDToClassID(const System::UnicodeString ProgID);
extern DELPHI_PACKAGE System::UnicodeString __fastcall ClassIDToProgID(const Winapi::Ole2::TGUID &ClassID);
...
extern DELPHI_PACKAGE HRESULT __stdcall DllGetClassObject(const Winapi::Ole2::TGUID &CLSID, const Winapi::Ole2::TGUID &IID, void *Obj);
