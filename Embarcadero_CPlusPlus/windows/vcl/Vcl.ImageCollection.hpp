...
// (DO NOT EDIT: machine generated header) 'Vcl.ImageCollection.pas' rev: 34.00 (Windows)
...
__published:
	...
	__property TImageCollectionItemSources* SourceImages = {read=FSourceImages, write=FSourceImages};
};
...
protected:
	...
	void __fastcall LoadFromCollection(TImageCollection* AImageCollection);
