...
// (DO NOT EDIT: machine generated header) 'Vcl.NumberBox.pas' rev: 34.00 (Windows)
...
public:
	...
	__property System::Byte CurrencyFormat = {read=FCurrencyFormat, write=SetCurrencyFormat, stored=IsCurrencyFormatStored, nodefault};
	__property System::UnicodeString DisplayFormant = {read=FDisplayFormat, write=SetDisplayFormat};
