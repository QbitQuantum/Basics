...
// (DO NOT EDIT: machine generated header) 'Vcl.BaseImageCollection.pas' rev: 34.00 (Windows)
...
public:
	...
	__fastcall TImageCollectionChangedMessage(TCustomImageCollection* ACollection, int AIndex, const System::UnicodeString AName);
public:
