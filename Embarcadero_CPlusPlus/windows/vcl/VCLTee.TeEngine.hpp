...
protected:
	...
	virtual void __fastcall DoDraw(Vcltee::Teeprocs::TCustomTeePanel* const Panel, const System::Types::TRect &Rect, int Angle = 0x0, int AZ = 0x0);
...
private:
	...
	bool __fastcall IncDecDateTime(bool Increment, double &Value, const double AnIncrement, Vcltee::Teeprocs::TDateTimeStep tmpWhichDateTime);
...
protected:
	...
	virtual void __fastcall DrawLegendShape(const System::Types::TRect &Rect) = 0 ;
...
private:
	...
	void __fastcall InternalDraw(int Index, System::Uitypes::TColor AColor, const System::UnicodeString AText, TSeriesMarkPosition* APosition);
	void __fastcall ReadItems(System::Classes::TStream* Stream);
...
enum DECLSPEC_DENUM Vcltee_Teengine__84 : unsigned char { rOnDelete, rOnModify, rOnInsert, rOnClear };

typedef System::Set<Vcltee_Teengine__84, Vcltee_Teengine__84::rOnDelete, Vcltee_Teengine__84::rOnClear> TSeriesRecalcOptions;
...
enum DECLSPEC_DENUM Vcltee_Teengine__35 : unsigned char { tssIsTemplate, tssDenyChangeType, tssDenyDelete, tssDenyClone, tssIsPersistent, tssHideDataSource };

typedef System::Set<Vcltee_Teengine__35, Vcltee_Teengine__35::tssIsTemplate, Vcltee_Teengine__35::tssHideDataSource> TChartSeriesStyle;
