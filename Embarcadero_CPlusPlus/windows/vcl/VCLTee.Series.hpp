...
public:
	...
	__property bool Smoothed = {read=FSmoothed, write=SetSmoothed, nodefault};
...
public:
	...
	__classmethod void __fastcall AdjustScreenRatio(Vcltee::Tecanvas::TCanvas3D* const ACanvas, int AXRadius, int AYRadius, System::Types::TRect &R);
