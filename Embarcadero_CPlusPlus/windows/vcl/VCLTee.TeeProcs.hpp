...
public:
	...
	void __fastcall SaveToMetafileRect(bool Enhanced, const System::UnicodeString FileName, const System::Types::TRect &Rect);
	...
	Vcl::Graphics::TMetafile* __fastcall TeeCreateMetafile(bool Enhanced, const System::Types::TRect &Rect);
...
private:
	...
	void __fastcall SetBevelWidth(Vcl::Controls::TBevelWidth Value);
	...
	void __fastcall SetTransparency(Vcltee::Tecanvas::TTeeTransparency Value);
...
protected:
	...
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	virtual void __fastcall DoDraw(TCustomTeePanel* const Panel, const System::Types::TRect &Rect, int Angle = 0x0, int AZ = 0x0);
