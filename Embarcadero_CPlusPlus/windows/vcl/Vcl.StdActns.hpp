...
// (DO NOT EDIT: machine generated header) 'Vcl.StdActns.pas' rev: 34.00 (Windows)
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TCommonDialogClass);
#endif /* _WIN64 */
...
#else /* _WIN64 */
	System::TArray__1<System::UnicodeString> FFolders;
#endif /* _WIN64 */
