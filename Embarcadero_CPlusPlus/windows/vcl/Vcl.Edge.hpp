...
// (DO NOT EDIT: machine generated header) 'Vcl.Edge.pas' rev: 34.00 (Windows)
...
struct TEdgeBrowserHelper /* Helper for class 'TCustomEdgeBrowser*' */;
...
private:
	Webview2::_di_ICoreWebView2NavigationStartingEventArgs FArgsInterface;
	
public:
	__fastcall TNavigationStartingEventArgs(const Webview2::_di_ICoreWebView2NavigationStartingEventArgs Args);
	__property Webview2::_di_ICoreWebView2NavigationStartingEventArgs ArgsInterface = {read=FArgsInterface};
public:
...
public:
	...
	operator Webview2::_di_ICoreWebView2NavigationStartingEventArgs() { return ArgsInterface; }
	#else
	operator Webview2::ICoreWebView2NavigationStartingEventArgs*(void) { return (Webview2::ICoreWebView2NavigationStartingEventArgs*)ArgsInterface; }
	#endif
...
private:
	Webview2::_di_ICoreWebView2NewWindowRequestedEventArgs FArgsInterface;
	
public:
	__fastcall TNewWindowRequestedEventArgs(const Webview2::_di_ICoreWebView2NewWindowRequestedEventArgs Args);
	__property Webview2::_di_ICoreWebView2NewWindowRequestedEventArgs ArgsInterface = {read=FArgsInterface};
public:
...
public:
	...
	operator Webview2::_di_ICoreWebView2NewWindowRequestedEventArgs() { return ArgsInterface; }
	#else
	operator Webview2::ICoreWebView2NewWindowRequestedEventArgs*(void) { return (Webview2::ICoreWebView2NewWindowRequestedEventArgs*)ArgsInterface; }
	#endif
...
private:
	Webview2::_di_ICoreWebView2PermissionRequestedEventArgs FArgsInterface;
	
public:
	__fastcall TPermissionRequestedEventArgs(const Webview2::_di_ICoreWebView2PermissionRequestedEventArgs Args);
	__property Webview2::_di_ICoreWebView2PermissionRequestedEventArgs ArgsInterface = {read=FArgsInterface};
public:
...
public:
	...
	operator Webview2::_di_ICoreWebView2PermissionRequestedEventArgs() { return ArgsInterface; }
	#else
	operator Webview2::ICoreWebView2PermissionRequestedEventArgs*(void) { return (Webview2::ICoreWebView2PermissionRequestedEventArgs*)ArgsInterface; }
	#endif
...
private:
	Webview2::_di_ICoreWebView2ScriptDialogOpeningEventArgs FArgsInterface;
	
public:
	__fastcall TScriptDialogOpeningEventArgs(const Webview2::_di_ICoreWebView2ScriptDialogOpeningEventArgs Args);
	__property Webview2::_di_ICoreWebView2ScriptDialogOpeningEventArgs ArgsInterface = {read=FArgsInterface};
public:
...
public:
	...
	operator Webview2::_di_ICoreWebView2ScriptDialogOpeningEventArgs() { return ArgsInterface; }
	#else
	operator Webview2::ICoreWebView2ScriptDialogOpeningEventArgs*(void) { return (Webview2::ICoreWebView2ScriptDialogOpeningEventArgs*)ArgsInterface; }
	#endif
...
private:
	Webview2::_di_ICoreWebView2WebMessageReceivedEventArgs FArgsInterface;
	
public:
	__fastcall TWebMessageReceivedEventArgs(const Webview2::_di_ICoreWebView2WebMessageReceivedEventArgs Args);
	__property Webview2::_di_ICoreWebView2WebMessageReceivedEventArgs ArgsInterface = {read=FArgsInterface};
public:
...
public:
	...
	operator Webview2::_di_ICoreWebView2WebMessageReceivedEventArgs() { return ArgsInterface; }
	#else
	operator Webview2::ICoreWebView2WebMessageReceivedEventArgs*(void) { return (Webview2::ICoreWebView2WebMessageReceivedEventArgs*)ArgsInterface; }
	#endif
...
private:
	Webview2::_di_ICoreWebView2WebResourceRequestedEventArgs FArgsInterface;
	
public:
	__fastcall TWebResourceRequestedEventArgs(const Webview2::_di_ICoreWebView2WebResourceRequestedEventArgs Args);
	__property Webview2::_di_ICoreWebView2WebResourceRequestedEventArgs ArgsInterface = {read=FArgsInterface};
public:
...
public:
	...
	operator Webview2::_di_ICoreWebView2WebResourceRequestedEventArgs() { return ArgsInterface; }
	#else
	operator Webview2::ICoreWebView2WebResourceRequestedEventArgs*(void) { return (Webview2::ICoreWebView2WebResourceRequestedEventArgs*)ArgsInterface; }
	#endif
...
private:
	...
	Webview2::_di_ICoreWebView2Environment FWebViewEnvironment;
	Webview2::_di_ICoreWebView2Controller FWebViewController;
	Webview2::_di_ICoreWebView2 FWebView;
	Webview2::_di_ICoreWebView2Settings FWebViewSettings;
	double FSizeRatio;
	...
	Webview2::EventRegistrationToken FAcceleratorKeyPressedToken;
	Webview2::EventRegistrationToken FContainsFullScreenElementChangedToken;
	Webview2::EventRegistrationToken FContentLoadingToken;
	Webview2::EventRegistrationToken FDocumentTitleChangedToken;
	Webview2::EventRegistrationToken FFrameNavigationStartingToken;
	Webview2::EventRegistrationToken FFrameNavigationCompletedToken;
	Webview2::EventRegistrationToken FGotFocusToken;
	Webview2::EventRegistrationToken FHistoryChangedToken;
	Webview2::EventRegistrationToken FLostFocusToken;
	Webview2::EventRegistrationToken FMoveFocusRequestedToken;
	Webview2::EventRegistrationToken FNavigationStartingToken;
	Webview2::EventRegistrationToken FNavigationCompletedToken;
	Webview2::EventRegistrationToken FNewWindowRequestedToken;
	Webview2::EventRegistrationToken FPermissionRequestedToken;
	Webview2::EventRegistrationToken FProcessFailedToken;
	Webview2::EventRegistrationToken FScriptDialogOpeningToken;
	Webview2::EventRegistrationToken FSourceChangedToken;
	Webview2::EventRegistrationToken FWebResourceRequestedToken;
	Webview2::EventRegistrationToken FWebMessageReceivedToken;
	Webview2::EventRegistrationToken FWindowCloseRequestedToken;
	Webview2::EventRegistrationToken FZoomFactorChangedToken;
	System::Generics::Collections::TDictionary__2<System::UnicodeString,Webview2::EventRegistrationToken>* FDevToolsProtocolEventReceivedTokenMap;
	...
	HRESULT __stdcall CreateEnvironmentCompleted(HRESULT AResult, const Webview2::_di_ICoreWebView2Environment AEnvironment);
	HRESULT __stdcall CreateCoreWebView2ControllerCompleted(HRESULT AResult, const Webview2::_di_ICoreWebView2Controller ACreatedController);
...
public:
	...
	bool __fastcall Navigate(const System::UnicodeString AUrl);
	...
	__property Webview2::_di_ICoreWebView2 DefaultInterface = {read=FWebView};
	__property Webview2::_di_ICoreWebView2Controller ControllerInterface = {read=FWebViewController};
	...
	System::UnicodeString GetBrowserExecutableFolder();
	System::UnicodeString GetUserDataFolder();
	void SetBrowserExecutableFolder(const System::UnicodeString s);
	void SetUserDataFolder(const System::UnicodeString s);
	__property System::UnicodeString BrowserExecutableFolder = {read=GetBrowserExecutableFolder, write=SetBrowserExecutableFolder};
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall EdgeBrowserGetBrowserExecutableFolder(TCustomEdgeBrowser* EdgeBrowser);
extern DELPHI_PACKAGE System::UnicodeString __fastcall EdgeBrowserGetUserDataFolder(TCustomEdgeBrowser* EdgeBrowser);
extern DELPHI_PACKAGE void __fastcall EdgeBrowserSetBrowserExecutableFolder(TCustomEdgeBrowser* EdgeBrowser, const System::UnicodeString S);
extern DELPHI_PACKAGE void __fastcall EdgeBrowserSetUserDataFolder(TCustomEdgeBrowser* EdgeBrowser, const System::UnicodeString S);
}	/* namespace Edge */
}	/* namespace Vcl */
...
namespace Edge
{
	inline System::UnicodeString TCustomEdgeBrowser::GetBrowserExecutableFolder() { return EdgeBrowserGetBrowserExecutableFolder(this); }
	inline System::UnicodeString TCustomEdgeBrowser::GetUserDataFolder(){ return EdgeBrowserGetUserDataFolder(this); }
	inline void TCustomEdgeBrowser::SetBrowserExecutableFolder(const System::UnicodeString s) { EdgeBrowserSetBrowserExecutableFolder(this, s); }
	inline void TCustomEdgeBrowser::SetUserDataFolder(const System::UnicodeString s){ EdgeBrowserSetUserDataFolder(this, s); }
}	/* namespace Edge */
}	/* namespace Vcl */
