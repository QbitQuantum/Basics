...
// (DO NOT EDIT: machine generated header) 'PlatformAPI.pas' rev: 34.00 (Windows)
...
DEFINE_GUID(IID_IOTAPlatformSDKAndroid, 0xFAEF0B24, 0x9E15, 0x4205, 0x99, 0x04, 0xC7, 0x96, 0xF2, 0xD9, 0xEF, 0x33);
...
__interface  INTERFACE_UUID("{FAEF0B24-9E15-4205-9904-C796F2D9EF33}") IOTAPlatformSDKAndroid  : public IOTAPlatformSDKAndroid240 
{
...
static const int AllPlatforms _DEPRECATED_ATTRIBUTE1("use System.Classes.pidAllPlatforms")  = int(0x194df);
