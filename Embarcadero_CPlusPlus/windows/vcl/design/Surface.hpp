...
// (DO NOT EDIT: machine generated header) 'Surface.pas' rev: 34.00 (Windows)
...
protected:
	...
	Designer::_di_IItem __fastcall CreateItem(const Designer::_di_IItem Parent, const System::Types::TRect &Rect);
