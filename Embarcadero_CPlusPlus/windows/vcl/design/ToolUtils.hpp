...
// (DO NOT EDIT: machine generated header) 'ToolUtils.pas' rev: 34.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall ForEach(const System::Classes::_di_IInterfaceList InterfaceList, TIUnknownEvent Event, const System::_di_IInterface UnkParam);
