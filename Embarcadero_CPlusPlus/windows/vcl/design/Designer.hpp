...
// (DO NOT EDIT: machine generated header) 'Designer.pas' rev: 34.00 (Windows)
...
__interface  INTERFACE_UUID("{37C644AA-6B33-4D7E-B18A-53D57E48010F}") IDesignSurface  : public System::IInterface 
{
	...
	virtual _di_IItem __fastcall CreateItem(const _di_IItem Parent, const System::Types::TRect &Rect) = 0 ;
