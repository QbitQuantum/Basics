...
// (DO NOT EDIT: machine generated header) 'DebugAPI.pas' rev: 34.00 (Windows)
...
enum DECLSPEC_DENUM TEvaluatorType: char { etNone = -1, etDelphi, etCPPBuilder, etMicrosoftCPP, etAssembly, etConstant, etJava, etGenericMSIL, etCSharpMSIL, etDelphiMSIL, etDelphiGDB, etCPPBuilderGDB };
