...
// (DO NOT EDIT: machine generated header) 'PaletteAPI.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
enum DECLSPEC_DENUM TNTAPaintIconSize : unsigned char { pi16x16, pi24x24, pi32x32 };
...
__interface  INTERFACE_UUID("{9CAEBEBF-6BFB-4E9A-B5E7-C3146DEFA6E8}") IOTABasePaletteItem  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{6963F71C-0A3F-4598-B6F6-9574CE0E6847}") IOTAPaletteServices  : public System::IInterface 
{
