...
// (DO NOT EDIT: machine generated header) 'ComponentDesigner.pas' rev: 34.00 (Windows)
...
private:
	...
	System::Classes::TComponent* __fastcall DoCreateComponent(const _di_IInternalPaletteItem Item, Designer::_di_IItem ParentItem, const System::Types::TRect &Rect, bool ApplyDefaults = true);
