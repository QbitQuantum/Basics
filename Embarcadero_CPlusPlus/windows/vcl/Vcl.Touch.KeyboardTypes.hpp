...
// (DO NOT EDIT: machine generated header) 'Vcl.Touch.KeyboardTypes.pas' rev: 34.00 (Windows)
...
enum DECLSPEC_DENUM TKeyImage: char { kiOverride = -2, kiText, kiTab, kiShift, kiEnter, kiBackspace, kiUp, kiDown, kiLeft, kiRight, kiTallEnter };
