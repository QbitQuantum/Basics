...
// (DO NOT EDIT: machine generated header) 'FMX.Canvas.GPU.Helpers.pas' rev: 34.00 (Windows)
...
private:
	...
	static const System::Word MaxBatchedVertices = System::Word(0x6000);
	
	static const System::Word MaxBatchedIndices = System::Word(0x9000);
