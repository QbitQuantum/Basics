...
// (DO NOT EDIT: machine generated header) 'FMX.Import.pas' rev: 34.00 (Windows)
...
public:
	...
	void __fastcall SetTextue0Source(const System::DynamicArray<float> ASource, int AStride = 0x2);
...
#ifndef _WIN64
extern DELPHI_PACKAGE System::DynamicArray<float> __fastcall FloatStringsToSingleDynArray(const System::UnicodeString AStr);
...
extern DELPHI_PACKAGE System::DynamicArray<System::UnicodeString> __fastcall StringsToStringDynArray(const System::UnicodeString AStr)/* overload */;
#else /* _WIN64 */
