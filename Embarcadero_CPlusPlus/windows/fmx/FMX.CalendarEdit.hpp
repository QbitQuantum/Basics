...
// (DO NOT EDIT: machine generated header) 'FMX.CalendarEdit.pas' rev: 34.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
static const System::Word MM_DATE_CHANGED = System::Word(0x1723);
static const System::Word MM_WEEK_NUMBERS_CHANGED = System::Word(0x1724);
static const System::Word MM_FIRST_DAY_OF_WEEK_CHANGED = System::Word(0x1725);
static const System::Word MM_DATETIME_CHANGED = System::Word(0x1726);
static const System::Word PM_CLOSEPICKER = System::Word(0x1009);
}	/* namespace Calendaredit */
}	/* namespace Fmx */
