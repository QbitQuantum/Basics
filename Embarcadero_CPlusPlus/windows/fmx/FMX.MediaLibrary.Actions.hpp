...
// (DO NOT EDIT: machine generated header) 'FMX.MediaLibrary.Actions.pas' rev: 34.00 (Windows)
...
public:
	static const System::Word DefaultMaxWidth = System::Word(0x400);
	
	static const System::Word DefaultMaxHeight = System::Word(0x400);
	
	static const bool DefaultEditable = false;
	
	static const bool DefaultNeedSaveToAlbum = false;
