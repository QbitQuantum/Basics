...
// (DO NOT EDIT: machine generated header) 'FMX.WindowsStore.pas' rev: 34.00 (Windows)

#ifndef Fmx_WindowsstoreHPP
#define Fmx_WindowsstoreHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_WINDOWSSTORE)
using namespace Fmx::Windowsstore;
#endif
