...
// (DO NOT EDIT: machine generated header) 'FMX.MultiView.pas' rev: 34.00 (Windows)
...
public:
	static const System::Int8 DefaultSpeed = System::Int8(0x0);
...
#ifndef _WIN64
typedef System::TMetaClass* TMultiViewPresentationClass;
#else /* _WIN64 */
...
public:
	static const System::Byte DefaultWidth = System::Byte(0xfa);
