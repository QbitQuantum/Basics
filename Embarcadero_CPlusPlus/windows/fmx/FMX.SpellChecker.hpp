...
// (DO NOT EDIT: machine generated header) 'FMX.SpellChecker.pas' rev: 34.00 (Windows)
...
{
#ifndef _WIN64
	virtual System::DynamicArray<System::UnicodeString> __fastcall CheckSpelling(System::UnicodeString Word) = 0 ;
	virtual System::DynamicArray<System::UnicodeString> __fastcall GuessCompletions(System::UnicodeString Word) = 0 ;
#else /* _WIN64 */
