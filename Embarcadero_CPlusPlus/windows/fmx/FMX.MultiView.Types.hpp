...
// (DO NOT EDIT: machine generated header) 'FMX.MultiView.Types.pas' rev: 34.00 (Windows)
...
public:
	...
	static const System::Int8 DefaultSizeInterception = System::Int8(0x14);
...
public:
	...
	static const System::Int8 DefaultIndentFromScreenBorder = System::Int8(0x5);
...
public:
	...
	static const System::Uitypes::TAlphaColor DefaultColor = System::Uitypes::TAlphaColor(0x0);
...
public:
	...
	static const System::Int8 DefaultTouchAreaSize = System::Int8(0x14);
...
public:
	...
	static const unsigned DefaultColor = unsigned(0xff000000);
...
public:
	static const System::Word DefaultHeight = System::Word(0x190);
	
	#define TPopoverAppearance_DefaultAppearanceDuration  (2.500000E-01)
	
	static const System::Uitypes::TAlphaColor DefaultTintColor = System::Uitypes::TAlphaColor(0x0);
...
public:
	static const System::Int8 DefaultCollapsedWidth = System::Int8(0x32);
...
//-- var, const, procedure ---------------------------------------------------
static const System::Word MM_MODE_CHANGED = System::Word(0x1701);
static const System::Word MM_INTERCEPTION_SIZE_CHANGED = System::Word(0x1702);
static const System::Word MM_COLOR_CHANGED = System::Word(0x1703);
static const System::Word MM_ENABLED_SHADOW_CHANGED = System::Word(0x1704);
static const System::Word MM_SHADOW_OPACITY_CHANGED = System::Word(0x1705);
static const System::Word MM_SHADOWED_OVERLAY_LAYOUT_USER = System::Word(0x1706);
}	/* namespace Types */
}	/* namespace Multiview */
}	/* namespace Fmx */
