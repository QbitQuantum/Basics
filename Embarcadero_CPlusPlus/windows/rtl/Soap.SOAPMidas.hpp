...
// (DO NOT EDIT: machine generated header) 'Soap.SOAPMidas.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	virtual System::DynamicArray<System::WideString> __stdcall SAS_GetProviderNames() = 0 ;
#else /* _WIN64 */
