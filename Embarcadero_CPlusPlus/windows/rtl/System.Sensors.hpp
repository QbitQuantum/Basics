...
// (DO NOT EDIT: machine generated header) 'System.Sensors.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
typedef System::TMetaClass* TGeocoderClass;
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TGeocoderClass);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::TMetaClass* TGpsStatusClass;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::TMetaClass* ESensorExceptionClass;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<TLocationCoord2D> _dt_System_Sensors_1;
...
protected:
#ifndef _WIN64
	static System::DynamicArray<TLocationCoord2D> FGeoFwdCoords;
#else /* _WIN64 */
...
#ifndef _WIN64
	__classmethod virtual void __fastcall DoGeocode(const System::DynamicArray<TLocationCoord2D> Coords);
#else /* _WIN64 */
