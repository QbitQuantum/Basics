...
// (DO NOT EDIT: machine generated header) 'Data.DBXJSONReflect.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	__classmethod System::Rtti::TRttiType* __fastcall ObjectType(System::Rtti::TRttiContext Ctx, const System::UnicodeString TypeName);
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
#define sValidatePeerCertificate L"ValidatePeerCertificate"
