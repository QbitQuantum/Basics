...
// (DO NOT EDIT: machine generated header) 'IdIrcServer.pas' rev: 34.00 (Windows)
...
__published:
	__property DefaultPort = {default=6667};
...
public:
	/* TIdCmdTCPServer.Destroy */ inline __fastcall virtual ~TIdIRCServer() { }
	
public:
	/* TIdBaseComponent.Create */ inline __fastcall TIdIRCServer(System::Classes::TComponent* AOwner)/* overload */ : Idcmdtcpserver::TIdCmdTCPServer(AOwner) { }
	
public:
	/* TIdInitializerComponent.Create */ inline __fastcall TIdIRCServer()/* overload */ : Idcmdtcpserver::TIdCmdTCPServer() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_IDIRCSERVER)
