...
// (DO NOT EDIT: machine generated header) 'Xml.Internal.OTextReadWrite.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	void __fastcall InitBuffer(const System::DynamicArray<System::Byte> aBuffer, System::Sysutils::TEncoding* const aDefaultEncoding = (System::Sysutils::TEncoding*)(0x0));
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
static const System::Int8 TEncodingBuffer_FirstElement = System::Int8(0x0);
