...
// (DO NOT EDIT: machine generated header) 'System.Bluetooth.pas' rev: 34.00 (Windows)
...
class DELPHICLASS TBluetoothServerSocket;
class DELPHICLASS TBluetoothSocket;
}	/* namespace Bluetooth */
}	/* namespace System */
namespace System
{
...
class DELPHICLASS EBluetoothSocketException;
class DELPHICLASS TBluetoothDeviceList;
class DELPHICLASS TBluetoothServiceList;
class DELPHICLASS TBluetoothManager;
class DELPHICLASS TBluetoothAdapter;
class DELPHICLASS TBluetoothDevice;
class DELPHICLASS TBluetoothSocket;
class DELPHICLASS TBluetoothServerSocket;
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION EBluetoothSocketException : public EBluetoothException
{
	typedef EBluetoothException inherited;
	
public:
	/* Exception.Create */ inline __fastcall EBluetoothSocketException(const System::UnicodeString Msg) : EBluetoothException(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EBluetoothSocketException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EBluetoothException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EBluetoothSocketException(NativeUInt Ident)/* overload */ : EBluetoothException(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EBluetoothSocketException(System::PResStringRec ResStringRec)/* overload */ : EBluetoothException(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EBluetoothSocketException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EBluetoothException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EBluetoothSocketException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EBluetoothException(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EBluetoothSocketException(const System::UnicodeString Msg, int AHelpContext) : EBluetoothException(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EBluetoothSocketException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EBluetoothException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EBluetoothSocketException(NativeUInt Ident, int AHelpContext)/* overload */ : EBluetoothException(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EBluetoothSocketException(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EBluetoothException(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EBluetoothSocketException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EBluetoothException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EBluetoothSocketException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EBluetoothException(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EBluetoothSocketException() { }
...
{
	typedef System::Generics::Collections::TObjectList__1<TBluetoothDevice*> inherited;
...
{
	typedef System::Generics::Collections::TList__1<TBluetoothService> inherited;
...
typedef void __fastcall (__closure *TRemoteRequestPairEvent)(TBluetoothDevice* const ADevice);
...
protected:
#ifndef _WIN64
	typedef System::TMetaClass* TBluetoothManagerClass;
#else /* _WIN64 */
...
private:
	static TBluetoothManager* FCurrentManager;
	static TBluetoothManager* __fastcall InternalGetBluetoothManager();
...
protected:
	...
	static unsigned FSocketTimeout;
	static TIdentifyUUIDEvent FOnIdentifyCustomUUID;
	
private:
	TBluetoothAdapter* __fastcall GetCurrentAdapter();
	TBluetoothDeviceList* __fastcall GetLastPairedDevices();
	
protected:
	TBluetoothDeviceList* FPairedDevices;
	TBluetoothDeviceList* FDiscoveredDevices;
	System::TDateTime FLastDiscoveredTimeStamp;
	TDiscoverableEndEvent FOnDiscoverableEnd;
	TDiscoveryEndEvent FOnDiscoveryEnd;
	TRemoteRequestPairEvent FOnRemoteRequestPair;
	...
	virtual void __fastcall DoRemoteRequestPair(TBluetoothDevice* const ADevice);
...
public:
	...
	__fastcall virtual ~TBluetoothManager();
...
public:
	...
	__fastcall virtual ~TBluetoothAdapter();
...
private:
	TBluetoothServiceList* __fastcall GetServiceList();
	
protected:
	TBluetoothServiceList* FServiceList;
	virtual bool __fastcall GetPaired() = 0 ;
...
public:
	...
	__property int ClassDevice = {read=GetClassDevice, nodefault};
...
#else /* _WIN64 */
	virtual System::TArray__1<System::Byte> __fastcall DoReceiveData(unsigned ATimeout) = 0 ;
...
#else /* _WIN64 */
	System::TArray__1<System::Byte> __fastcall ReadData _DEPRECATED_ATTRIBUTE1("Use ReceiveData") ()/* overload */;
	System::TArray__1<System::Byte> __fastcall ReadData _DEPRECATED_ATTRIBUTE1("Use ReceiveData") (unsigned ATimeout)/* overload */;
	System::TArray__1<System::Byte> __fastcall ReceiveData()/* overload */;
	System::TArray__1<System::Byte> __fastcall ReceiveData(unsigned ATimeout)/* overload */;
	void __fastcall SendData(const System::TArray__1<System::Byte> AData);
#endif /* _WIN64 */
...
public:
	...
	void __fastcall Close();
public:
	/* TObject.Create */ inline __fastcall TBluetoothServerSocket() : System::TObject() { }
...
{
#ifndef _WIN64
	typedef System::Generics::Collections::TDictionary__2<TScanResponseKey,System::DynamicArray<System::Byte> > inherited;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_System_Bluetooth_1;
...
{
#ifndef _WIN64
	typedef System::Generics::Collections::TDictionary__2<GUID,System::DynamicArray<System::Byte> > inherited;
#else /* _WIN64 */
...
protected:
	...
	int FTxPowerLevel;
#ifndef _WIN64
	System::DynamicArray<System::Byte> FManufacturerSpecificData;
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual void __fastcall SetManufacturerSpecificData(const System::DynamicArray<System::Byte> AManufacturerSpecificData) = 0 ;
...
#ifndef _WIN64
	System::DynamicArray<System::Byte> FManufacturerSpecificData;
	System::DynamicArray<System::Byte> FManufacturerSpecificDataMask;
#else /* _WIN64 */
	System::TArray__1<System::Byte> FManufacturerSpecificData;
...
#ifndef _WIN64
	System::DynamicArray<System::Byte> FServiceDataMask;
#else /* _WIN64 */
...
#ifndef _WIN64
	__property System::DynamicArray<System::Byte> ManufacturerSpecificData = {read=FManufacturerSpecificData, write=SetManufacturerSpecificData};
	__property System::DynamicArray<System::Byte> ManufacturerSpecificDataMask = {read=FManufacturerSpecificDataMask, write=SetManufacturerSpecificDataMask};
#else /* _WIN64 */
