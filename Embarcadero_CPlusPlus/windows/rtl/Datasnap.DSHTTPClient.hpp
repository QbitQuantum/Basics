...
// (DO NOT EDIT: machine generated header) 'Datasnap.DSHTTPClient.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	System::DynamicArray<System::Net::Urlclient::TCredentialsStorage::TCredential> __fastcall GetClientCredentials();
#else /* _WIN64 */
