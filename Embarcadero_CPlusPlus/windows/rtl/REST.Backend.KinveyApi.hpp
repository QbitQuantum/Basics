...
// (DO NOT EDIT: machine generated header) 'REST.Backend.KinveyApi.pas' rev: 34.00 (Windows)
...
private:
	#define TKinveyApi_sAppKey L"appKey"
	
	#define TKinveyApi_sDateCreated L"ect"
	
	#define TKinveyApi_sDateUpdated L"lmt"
	
	static const bool cDateTimeIsUTC = true;
	
	#define TKinveyApi_sDataStore L"appdata"
	
	#define TKinveyApi_sUserGroup L"group"
	
	#define TKinveyApi_sBlob L"blob"
	
	#define TKinveyApi_sUser L"user"
	
	#define TKinveyApi_sLogin L"login"
	
	#define TKinveyApi_sPush L"push"
	
	#define TKinveyApi_sRpc L"rpc"
	
	#define TKinveyApi_sRegisterDevice L"register-device"
	
	#define TKinveyApi_sUnregisterDevice L"unregister-device"
	
	#define TKinveyApi_sAppKeySegment L"/{appKey}"
	
	#define TKinveyApi_sUserAppKey L"user/{appKey}"
	
	#define TKinveyApi_sDataStoreAppKey L"appdata/{appKey}"
	
	#define TKinveyApi_sUserGroupAppKey L"group/{appKey}"
	
	#define TKinveyApi_sPushAppKey L"push/{appKey}"
	
	#define TKinveyApi_sBlobAppKey L"blob/{appKey}"
	
	#define TKinveyApi_sRpcAppKey L"rpc/{appKey}"
	
	#define TKinveyApi_sMessageElement L"message"
	
	#define TKinveyApi_sIOSApsElement L"iosaps"
	
	#define TKinveyApi_sIOSExtrasElement L"iosextras"
	
	#define TKinveyApi_sAndroidPayloadElement L"androidpayload"
	
	#define TKinveyApi_sUsersElement L"users"
	
	
public:
	static const System::WideChar cDefaultApiVersion = (System::WideChar)(0x33);
	
	#define TKinveyApi_cDefaultBaseURL L"https://baas.kinvey.com/"
...
#ifndef _WIN64
	void __fastcall QueryAppData(const System::UnicodeString ABackendCollectionName, const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray, /* out */ System::DynamicArray<TObjectID> &AObjects)/* overload */;
#else /* _WIN64 */
