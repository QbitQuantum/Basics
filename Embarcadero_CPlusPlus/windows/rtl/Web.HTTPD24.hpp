...
// (DO NOT EDIT: machine generated header) 'Web.HTTPD24.pas' rev: 34.00 (Windows)

#ifndef Web_Httpd24HPP
#define Web_Httpd24HPP
...
struct conn_state_t;
struct DECLSPEC_DRECORD apr_thread_t
{
};
...
struct DECLSPEC_DRECORD apr_thread_mutex_t
{
};
...
enum DECLSPEC_DENUM cmd_how : unsigned char { RAW_ARGS, TAKE1, TAKE2, ITERATE, ITERATE2, FLAG, NO_ARGS, TAKE12, TAKE3, TAKE23, TAKE123, TAKE13, TAKE_ARGV };
...
typedef ap_logconf *Pap_logconf;

struct DECLSPEC_DRECORD ap_logconf
{
public:
	char *module_levels;
	int level;
...
enum DECLSPEC_DENUM conn_state_e : unsigned char { CONN_STATE_CHECK_REQUEST_LINE_READABLE, CONN_STATE_READ_REQUEST_LINE, CONN_STATE_HANDLER, CONN_STATE_WRITE_COMPLETION, CONN_STATE_SUSPENDED, CONN_STATE_LINGER, CONN_STATE_LINGER_NORMAL, CONN_STATE_LINGER_SHORT };

typedef conn_state_t *Pconn_state_t;

struct DECLSPEC_DRECORD conn_state_t
{
public:
	conn_state_e state;
};
...
typedef apr_thread_t *Papr_thread_t;
...
typedef apr_thread_mutex_t *Papr_thread_mutex_t;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_WEB_HTTPD24)
using namespace Web::Httpd24;
#endif
