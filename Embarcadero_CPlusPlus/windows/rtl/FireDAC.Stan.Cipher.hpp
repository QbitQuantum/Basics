...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Cipher.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
typedef System::TMetaClass* TFDCipherClass;
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
static const System::Int8 C_FD_AESBlockSize = System::Int8(0x10);
static const System::Int8 C_FD_AESMaxRounds = System::Int8(0xe);
