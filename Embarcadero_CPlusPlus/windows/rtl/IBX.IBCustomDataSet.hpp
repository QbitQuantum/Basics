...
// (DO NOT EDIT: machine generated header) 'IBX.IBCustomDataSet.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	bool __fastcall InternalGetFieldData(Data::Db::TField* Field, System::DynamicArray<System::Byte> Buffer);
	virtual void __fastcall InternalSetFieldData(Data::Db::TField* Field, System::DynamicArray<System::Byte> Buffer);
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
static const System::Word BufferCacheSize = System::Word(0x3e8);
static const System::Int8 UniCache = System::Int8(0x2);
