...
// (DO NOT EDIT: machine generated header) 'System.Tether.BluetoothAdapter.pas' rev: 34.00 (Windows)
...
private:
	...
	static const System::Int8 MAXCONNECTIONS = System::Int8(0xa);
...
public:
	static const System::Int8 MaxBluetoothConnections = System::Int8(0x6);
	
	#define TTetheringBluetoothAdapter_AdapterID L"Bluetooth"
