...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.MySQLCli.pas' rev: 34.00 (Windows)
...
typedef void __stdcall (*TMYSQL_BIND_store_param_func)(void * net, void * param);

typedef void __stdcall (*TMYSQL_BIND_fetch_result)(void * p1, PPByte row);

typedef void __stdcall (*TMYSQL_BIND_skip_result)(void * p1, void * p2, PPByte row);
...
typedef unsigned __int64 __stdcall (*TPrcmysql_num_rows)(void * res);

typedef unsigned __stdcall (*TPrcmysql_num_fields)(void * res);

typedef System::Byte __stdcall (*TPrcmysql_eof)(void * res);

typedef void * __stdcall (*TPrcmysql_fetch_field_direct)(void * res, int fieldnr);

typedef void * __stdcall (*TPrcmysql_fetch_fields)(void * res);

typedef void * __stdcall (*TPrcmysql_row_tell)(void * res);

typedef unsigned __stdcall (*TPrcmysql_field_tell)(void * res);

typedef unsigned __stdcall (*TPrcmysql_field_count)(void * mysql);

typedef unsigned __int64 __stdcall (*TPrcmysql_affected_rows)(void * mysql);

typedef unsigned __int64 __stdcall (*TPrcmysql_insert_id)(void * mysql);

typedef unsigned __stdcall (*TPrcmysql_errno)(void * mysql);

typedef char * __stdcall (*TPrcmysql_error)(void * mysql);

typedef char * __stdcall (*TPrcmysql_sqlstate)(void * mysql);

typedef char * __stdcall (*TPrcmysql_info)(void * mysql);

typedef unsigned __stdcall (*TPrcmysql_thread_id)(void * mysql);

typedef char * __stdcall (*TPrcmysql_character_set_name)(void * mysql);

typedef void __stdcall (*TPrcmysql_get_character_set_info)(void * mysql, MY_CHARSET_INFO &charset);

typedef int __stdcall (*TPrcmysql_set_character_set)(void * mysql, char * cs_name);

typedef unsigned __stdcall (*TPrcmysql_warning_count)(void * mysql);

typedef void * __stdcall (*TPrcmysql_init)(void * mysql);

typedef System::Byte __stdcall (*TPrcmysql_ssl_set)(void * mysql, const char * key, const char * cert, const char * ca, const char * capath, const char * cipher);

typedef char * __stdcall (*TPrcmysql_get_ssl_cipher)(void * mysql);

typedef System::Byte __stdcall (*TPrcmysql_change_user)(void * mysql, const char * user, const char * passwd, const char * db);

typedef void * __stdcall (*TPrcmysql_real_connect)(void * mysql, const char * host, const char * user, const char * passwd, const char * db, unsigned port, const char * unix_socket, unsigned clientflag);

typedef void __stdcall (*TPrcmysql_close)(void * sock);

typedef int __stdcall (*TPrcmysql_select_db)(void * mysql, const char * db);

typedef int __stdcall (*TPrcmysql_query)(void * mysql, const char * q);

typedef int __stdcall (*TPrcmysql_send_query)(void * mysql, const char * q, unsigned length);

typedef int __stdcall (*TPrcmysql_read_query_result)(void * mysql);

typedef int __stdcall (*TPrcmysql_real_query)(void * mysql, const char * q, unsigned length);

typedef int __stdcall (*TPrcmysql_shutdown)(void * mysql);

typedef int __stdcall (*TPrcmysql_dump_debug_info)(void * mysql);

typedef int __stdcall (*TPrcmysql_refresh)(void * mysql, unsigned refresh_options);

typedef int __stdcall (*TPrcmysql_kill)(void * mysql, unsigned pid);

typedef int __stdcall (*TPrcmysql_ping)(void * mysql);

typedef char * __stdcall (*TPrcmysql_stat)(void * mysql);

typedef char * __stdcall (*TPrcmysql_get_server_info)(void * mysql);

typedef char * __stdcall (*TPrcmysql_get_client_info)(void);

typedef char * __stdcall (*TPrcmysql_get_host_info)(void * mysql);

typedef int __stdcall (*TPrcmysql_get_proto_info)(void * mysql);

typedef void * __stdcall (*TPrcmysql_list_dbs)(void * mysql, const char * wild);

typedef void * __stdcall (*TPrcmysql_list_tables)(void * mysql, const char * wild);

typedef void * __stdcall (*TPrcmysql_list_fields)(void * mysql, const char * table, const char * wild);

typedef void * __stdcall (*TPrcmysql_list_processes)(void * mysql);

typedef void * __stdcall (*TPrcmysql_store_result)(void * mysql);

typedef void * __stdcall (*TPrcmysql_use_result)(void * mysql);

typedef int __stdcall (*TPrcmysql_options)(void * mysql, int option, const System::PByte arg);

typedef void __stdcall (*TPrcmysql_free_result)(void * res);

typedef void __stdcall (*TPrcmysql_data_seek0320)(void * res, unsigned offset);

typedef void __stdcall (*TPrcmysql_data_seek0323)(void * res, unsigned __int64 offset);

typedef void * __stdcall (*TPrcmysql_row_seek)(void * res, void * Row);

typedef unsigned __stdcall (*TPrcmysql_field_seek)(void * res, unsigned offset);

typedef PPByte __stdcall (*TPrcmysql_fetch_row)(void * res);

typedef Pmy_ulong __stdcall (*TPrcmysql_fetch_lengths)(void * res);

typedef void * __stdcall (*TPrcmysql_fetch_field)(void * res);

typedef unsigned __stdcall (*TPrcmysql_escape_string)(char * szTo, const char * szFrom, unsigned from_length);

typedef unsigned __stdcall (*TPrcmysql_real_escape_string)(void * mysql, char * szTo, const char * szFrom, unsigned length);

typedef void __stdcall (*TPrcmysql_debug)(const char * debug);

typedef void __stdcall (*TPrcmyodbc_remove_escape)(void * mysql, char * name);

typedef int __stdcall (*TPrcmysql_thread_safe)(void);

typedef void * __stdcall (*TPrcmysql_connect)(void * mysql, const char * host, const char * user, const char * passwd);

typedef int __stdcall (*TPrcmysql_create_db)(void * mysql, const char * DB);

typedef int __stdcall (*TPrcmysql_drop_db)(void * mysql, const char * DB);

typedef System::Byte __stdcall (*TPrcmysql_autocommit)(void * mysql, System::Byte mode);

typedef System::Byte __stdcall (*TPrcmysql_commit)(void * mysql);

typedef System::Byte __stdcall (*TPrcmysql_rollback)(void * mysql);

typedef System::Byte __stdcall (*TPrcmysql_more_results)(void * mysql);

typedef int __stdcall (*TPrcmysql_next_result)(void * mysql);

typedef void * __stdcall (*TPrcmysql_stmt_init)(void * mysql);

typedef int __stdcall (*TPrcmysql_stmt_prepare)(void * stmt, const char * query, unsigned length);

typedef int __stdcall (*TPrcmysql_stmt_execute)(void * stmt);

typedef int __stdcall (*TPrcmysql_stmt_fetch)(void * stmt);

typedef int __stdcall (*TPrcmysql_stmt_fetch_column)(void * stmt, void * bind, unsigned column, unsigned offset);

typedef int __stdcall (*TPrcmysql_stmt_store_result)(void * stmt);

typedef unsigned __stdcall (*TPrcmysql_stmt_param_count)(void * stmt);

typedef System::Byte __stdcall (*TPrcmysql_stmt_attr_set)(void * stmt, int attr_type, void * attr);

typedef System::Byte __stdcall (*TPrcmysql_stmt_attr_get)(void * stmt, int attr_type, void * attr);

typedef System::Byte __stdcall (*TPrcmysql_stmt_bind_param)(void * stmt, void * bnd);

typedef System::Byte __stdcall (*TPrcmysql_stmt_bind_result)(void * stmt, void * bnd);

typedef System::Byte __stdcall (*TPrcmysql_stmt_close)(void * stmt);

typedef System::Byte __stdcall (*TPrcmysql_stmt_reset)(void * stmt);

typedef System::Byte __stdcall (*TPrcmysql_stmt_free_result)(void * stmt);

typedef System::Byte __stdcall (*TPrcmysql_stmt_send_long_data)(void * stmt, unsigned param_number, const System::PByte data, unsigned length);

typedef void * __stdcall (*TPrcmysql_stmt_result_metadata)(void * stmt);

typedef unsigned __stdcall (*TPrcmysql_stmt_errno)(void * stmt);

typedef char * __stdcall (*TPrcmysql_stmt_error)(void * stmt);

typedef char * __stdcall (*TPrcmysql_stmt_sqlstate)(void * stmt);

typedef void * __stdcall (*TPrcmysql_stmt_row_seek)(void * stmt, void * offset);

typedef void * __stdcall (*TPrcmysql_stmt_row_tell)(void * stmt);

typedef void __stdcall (*TPrcmysql_stmt_data_seek)(void * stmt, unsigned __int64 offset);

typedef unsigned __int64 __stdcall (*TPrcmysql_stmt_num_rows)(void * stmt);

typedef unsigned __int64 __stdcall (*TPrcmysql_stmt_affected_rows)(void * stmt);

typedef unsigned __int64 __stdcall (*TPrcmysql_stmt_insert_id)(void * stmt);

typedef unsigned __stdcall (*TPrcmysql_stmt_field_count)(void * stmt);

typedef int __stdcall (*TPrcmysql_stmt_next_result)(void * stmt);

typedef int __stdcall (*TPrcmysql_server_init)(int argc, my_ppchar argv, my_ppchar groups);

typedef void __stdcall (*TPrcmysql_server_end)(void);

typedef System::Byte __stdcall (*TPrcmysql_thread_init)(void);

typedef void __stdcall (*TPrcmysql_thread_end)(void);
...
#define MYSQL_UNIX_ADDR L"/tmp/mysql.sock"
#define MYSQL_NAMEDPIPE L"MySQL"
#define MYSQL_SERVICENAME L"MySql"
