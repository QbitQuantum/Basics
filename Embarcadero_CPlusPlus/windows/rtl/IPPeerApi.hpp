...
// (DO NOT EDIT: machine generated header) 'IPPeerAPI.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> TIPBytesPeer;
#else /* _WIN64 */
...
#else /* _WIN64 */
	virtual System::TPtrWrapper __fastcall _ERR_error_string(unsigned e, const System::TPtrWrapper &buf) = 0 /* overload */;
#endif /* _WIN64 */
...
#ifndef _WIN64
	virtual void * __fastcall GetHMACSHA256HashInst(const System::DynamicArray<System::Byte> AKey) = 0 ;
	virtual System::DynamicArray<System::Byte> __fastcall HashSHA256(const System::DynamicArray<System::Byte> AData) = 0 ;
	virtual void __fastcall UpdateHMACInst(void * ACtx, const System::DynamicArray<System::Byte> AIn) = 0 ;
	virtual System::DynamicArray<System::Byte> __fastcall FinalHMACInst(void * ACtx) = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual void * __fastcall GetHMACSHA1HashInst(const System::DynamicArray<System::Byte> AKey) = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual System::DynamicArray<TIPv4Subnet> __fastcall GetIPv4Subnets() = 0 ;
#else /* _WIN64 */
...
__interface  INTERFACE_UUID("{ADB82592-F88C-4762-A266-EED3288E917D}") IIPIOHandler  : public System::IInterface 
{
...
#ifndef _WIN64
	virtual void __fastcall ReadBytes(System::DynamicArray<System::Byte> &VBuffer, int AByteCount, bool AAppend = true) = 0 ;
	...
	virtual void __fastcall Write(const System::DynamicArray<System::Byte> ABuffer, const int ALength = 0xffffffff, const int AOffset = 0x0) = 0 /* overload */;
...
__interface  INTERFACE_UUID("{4B101B6D-9C18-4579-A381-0F238A01CC18}") IIPX509  : public System::IInterface 
{
	...
	__property System::DynamicArray<System::Byte> EncodedCertificate = {read=GetEncoded};
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual System::DynamicArray<System::Byte> __fastcall GetEncodedKey() = 0 ;
	__property System::DynamicArray<System::Byte> EncodedKey = {read=GetEncodedKey};
#else /* _WIN64 */
...
__interface  INTERFACE_UUID("{DF4F2321-EAC7-4D69-A290-8E0303627C6B}") IIPHashMessageDigest5  : public System::IInterface 
{
	...
	virtual System::UnicodeString __fastcall GetIPImplementationID() = 0 ;
#ifndef _WIN64
	virtual System::UnicodeString __fastcall HashBytesAsHex(const System::DynamicArray<System::Byte> ASrc) = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual void __fastcall Broadcast(const System::DynamicArray<System::Byte> AData, const System::Word APort, const System::UnicodeString AIP = System::UnicodeString()) = 0 /* overload */;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_Ippeerapi_1;
typedef void __fastcall (__closure *TIPUDPReadEventPeer)(_di_IIPUDPListenerThread AThread, const _dt_Ippeerapi_1 AData, _di_IIPSocketHandle ABinding);
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual void __fastcall SendBuffer(const System::UnicodeString AHost, const System::Word APort, const System::DynamicArray<System::Byte> ABuffer) = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_Ippeerapi_2;
typedef void __fastcall (__closure *TIPMCastReadEventPeer)(System::TObject* Sender, const _dt_Ippeerapi_2 AData, const _di_IIPSocketHandle ABinding);
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual void __fastcall Send(const System::DynamicArray<System::Byte> ABuffer) = 0 /* overload */;
	virtual void __fastcall Send(const System::DynamicArray<System::Byte> ABuffer, const System::Word APort) = 0 /* overload */;
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
static const System::Int8 _IPPORT_HTTP = System::Int8(0x50);
...
extern DELPHI_PACKAGE TIPPeerFactory* __fastcall PeerFactory();
}	/* namespace Ippeerapi */
