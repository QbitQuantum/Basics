...
// (DO NOT EDIT: machine generated header) 'Xml.Internal.CodecUtilsWin32.pas' rev: 34.00 (Windows)
...
public:
	...
	__classmethod virtual TUnicodeCodec* __fastcall CreateCodecForSystemEncoding();
	__classmethod virtual System::UnicodeString __fastcall SystemEncodingName();
...
typedef void __fastcall (__closure *TCodecReadEvent)(System::TObject* const Sender, void *Buf, int Count, bool &Ok);

typedef void __fastcall (__closure *TCodecWriteEvent)(System::TObject* const Sender, const void *Buf, int Count);
...
#ifndef _WIN64
	__classmethod virtual System::DynamicArray<System::Byte> __fastcall GetPreamble();
#else /* _WIN64 */
