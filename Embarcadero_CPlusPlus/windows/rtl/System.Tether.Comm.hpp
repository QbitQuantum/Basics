...
// (DO NOT EDIT: machine generated header) 'System.Tether.Comm.pas' rev: 34.00 (Windows)
...
class DELPHICLASS TTetheringBTComm;
class DELPHICLASS TTetheringBTServerComm;
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
#pragma pack(push,4)
#endif /* not _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_System_Tether_Comm_1;
typedef System::DynamicArray<System::Byte> _dt_System_Tether_Comm_2;
...
public:
	static const System::Int8 ProtocolSpecificTimeout = System::Int8(-1);
...
#ifndef _WIN64
	virtual System::DynamicArray<System::Byte> __fastcall DoReadData() = 0 ;
	virtual void __fastcall DoWriteData(const System::DynamicArray<System::Byte> AData) = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
	System::DynamicArray<System::Byte> __fastcall ReadData();
	void __fastcall WriteData(const System::DynamicArray<System::Byte> AData);
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_System_Tether_Comm_3;
typedef void __fastcall (__closure *TNetworkCommUDPData)(const System::UnicodeString AConnectionString, const _dt_System_Tether_Comm_3 AData);
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_System_Tether_Comm_4;
typedef void __fastcall (__closure *TNetworkCommMulticastData)(const System::UnicodeString AConnectionString, const _dt_System_Tether_Comm_4 AData);
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual System::DynamicArray<System::Byte> __fastcall DoReadData();
	virtual void __fastcall DoWriteData(const System::DynamicArray<System::Byte> AData);
#else /* _WIN64 */
...
#ifndef _WIN64
	void __fastcall DoUDPRead(Ippeerapi::_di_IIPUDPListenerThread AThread, const System::DynamicArray<System::Byte> AData, Ippeerapi::_di_IIPSocketHandle ABinding);
#else /* _WIN64 */
...
#ifndef _WIN64
	void __fastcall DoMulticastRead(System::TObject* Sender, const System::DynamicArray<System::Byte> AData, const Ippeerapi::_di_IIPSocketHandle ABinding);
#else /* _WIN64 */
...
class PASCALIMPLEMENTATION TTetheringBTComm : public TTetheringCustomComm
{
	typedef TTetheringCustomComm inherited;
	
private:
	static const System::Word ReadTimeout = System::Word(0x258);
	
	System::TObject* FBufferLock;
#ifndef _WIN64
	System::DynamicArray<System::Byte> FInternalBuffer;
#else /* _WIN64 */
	System::TArray__1<System::Byte> FInternalBuffer;
#endif /* _WIN64 */
	System::Bluetooth::TBluetoothSocket* FInternalSocket;
	bool __fastcall AvailableData();
#ifndef _WIN64
	System::DynamicArray<System::Byte> __fastcall InternalReadData();
#else /* _WIN64 */
	System::TArray__1<System::Byte> __fastcall InternalReadData();
#endif /* _WIN64 */
	
protected:
	System::Bluetooth::TBluetoothSocket* FSocket;
	virtual bool __fastcall DoConnect(const System::UnicodeString ATarget, int ATimeout);
	virtual void __fastcall DoDisconnect();
	virtual bool __fastcall GetConnected();
#ifndef _WIN64
...
public:
	__fastcall TTetheringBTComm(System::Bluetooth::TBluetoothSocket* const ASocket, bool ASecured);
	__fastcall virtual ~TTetheringBTComm();
};


class PASCALIMPLEMENTATION TTetheringBTServerComm : public TTetheringCustomServerComm
{
	typedef TTetheringCustomServerComm inherited;
	
	
protected:
	struct DECLSPEC_DRECORD TRegisteredServer
	{
	public:
		GUID FGUID;
		TServerCommExecuteEvent FOnExecute;
...
private:
	class DELPHICLASS TBTCommThread;
	class PASCALIMPLEMENTATION TBTCommThread : public System::Classes::TThread
	{
	...
	protected:
		TTetheringBTServerComm* FServerComm;
		System::Bluetooth::TBluetoothSocket* FSocket;
		virtual void __fastcall Execute();
		
	public:
		__fastcall TBTCommThread(TTetheringBTServerComm* const AServerComm, System::Bluetooth::TBluetoothSocket* const ASocket);
		__fastcall virtual ~TBTCommThread();
	};
	
	
	class DELPHICLASS TBTListenerThread;
	class PASCALIMPLEMENTATION TBTListenerThread : public System::Classes::TThread
	{
		typedef System::Classes::TThread inherited;
		
	protected:
		System::Bluetooth::TBluetoothServerSocket* FServerSocket;
		TTetheringBTServerComm* FServerComm;
		virtual void __fastcall Execute();
		
	public:
		__fastcall TBTListenerThread(TTetheringBTServerComm* const AServerComm, System::Bluetooth::TBluetoothServerSocket* const AServerSocket);
		__fastcall virtual ~TBTListenerThread();
	};
	
	
	
private:
	static const System::Word AcceptTimeout = System::Word(0x3e8);
	
	
public:
	static GUID BTServerBaseUUID;
	
protected:
	static System::Generics::Collections::TList__1<TRegisteredServer>* FRegisteredServers;
	
private:
	int __fastcall FindRegisteredServer(const GUID &AGUID);
	void __fastcall RegisterServer(const GUID &AGUID);
	void __fastcall UnRegisterServer(const GUID &AGUID);
...
protected:
	static System::Bluetooth::TBluetoothServerSocket* FServerSocket;
	static GUID FGUIDServer;
	static TBTListenerThread* FListener;
	static GUID FGUID;
	virtual void __fastcall SetTarget(const System::UnicodeString Value);
	virtual bool __fastcall DoStartServer();
	virtual void __fastcall DoStopServer();
...
public:
	__fastcall TTetheringBTServerComm();
	__fastcall virtual ~TTetheringBTServerComm();
};
