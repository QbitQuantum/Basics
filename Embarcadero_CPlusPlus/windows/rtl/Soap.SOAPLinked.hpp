...
// (DO NOT EDIT: machine generated header) 'Soap.SOAPLinked.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	System::DynamicArray<System::Byte> FStaticRequest;
	System::DynamicArray<System::Byte> FStaticResponse;
#else /* _WIN64 */
...
#ifndef _WIN64
	__property System::DynamicArray<System::Byte> StaticRequest = {read=FStaticRequest, write=FStaticRequest};
	__property System::DynamicArray<System::Byte> StaticResponse = {read=FStaticResponse, write=FStaticResponse};
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
#ifndef _WIN64
extern DELPHI_PACKAGE System::DynamicArray<System::Byte> __fastcall LoadDataFromFile(const System::UnicodeString FileName);
extern DELPHI_PACKAGE void __fastcall WriteDataToFile(const System::UnicodeString FileName, const System::DynamicArray<System::Byte> Data);
#else /* _WIN64 */
