...
// (DO NOT EDIT: machine generated header) 'TestFramework.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
typedef System::TMetaClass* TTestCaseClass;
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TTestCaseClass);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::TMetaClass* ExceptionClass;
#else /* _WIN64 */
...
protected:
	...
	System::UnicodeString __fastcall GetMemDiffStr(void * expected, void * actual, unsigned size, System::UnicodeString msg);
...
public:
	...
	virtual void __fastcall CheckEqualsMem(void * expected, void * actual, unsigned size, System::UnicodeString msg = System::UnicodeString());
	virtual void __fastcall CheckEquals(bool expected, bool actual, System::UnicodeString msg = System::UnicodeString())/* overload */;
	virtual void __fastcall CheckEqualsBin(unsigned expected, unsigned actual, System::UnicodeString msg = System::UnicodeString(), int digits = 0x20);
	virtual void __fastcall CheckEqualsHex(unsigned expected, unsigned actual, System::UnicodeString msg = System::UnicodeString(), int digits = 0x8);
#ifndef _WIN64
	virtual void __fastcall CheckEquals(System::DynamicArray<System::WideChar> expected, System::DynamicArray<System::WideChar> actual, System::UnicodeString msg = System::UnicodeString())/* overload */;
#else /* _WIN64 */
	...
	virtual void __fastcall CheckNotEqualsMem(void * expected, void * actual, unsigned size, System::UnicodeString msg = System::UnicodeString());
	virtual void __fastcall CheckNotEquals(bool expected, bool actual, System::UnicodeString msg = System::UnicodeString())/* overload */;
	virtual void __fastcall CheckNotEqualsBin(unsigned expected, unsigned actual, System::UnicodeString msg = System::UnicodeString(), int digits = 0x20);
	virtual void __fastcall CheckNotEqualsHex(unsigned expected, unsigned actual, System::UnicodeString msg = System::UnicodeString(), int digits = 0x8);
#ifndef _WIN64
	virtual void __fastcall CheckNotEquals(System::DynamicArray<System::WideChar> expected, System::DynamicArray<System::WideChar> actual, System::UnicodeString msg = System::UnicodeString())/* overload */;
#else /* _WIN64 */
...
#ifndef _WIN64
	inline void __fastcall  CheckEquals(System::DynamicArray<System::WideChar> expected, System::DynamicArray<System::WideChar> actual, System::UnicodeString msg = System::UnicodeString()){ TAbstractTest::CheckEquals(expected, actual, msg); }
#else /* _WIN64 */
...
#ifndef _WIN64
	inline void __fastcall  CheckNotEquals(System::DynamicArray<System::WideChar> expected, System::DynamicArray<System::WideChar> actual, System::UnicodeString msg = System::UnicodeString()){ TAbstractTest::CheckNotEquals(expected, actual, msg); }
#else /* _WIN64 */
...
#define sExpButWasFmt L"%sexpected: <%s> but was: <%s>"
#define sExpAndActualFmt L"%sexpected and actual were: <%s>"
...
extern DELPHI_PACKAGE int __fastcall FirstByteDiff(void * p1, void * p2, unsigned size, /* out */ System::Byte &b1, /* out */ System::Byte &b2);
