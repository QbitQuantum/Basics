...
// (DO NOT EDIT: machine generated header) 'Data.DBXMetaDataReader.pas' rev: 34.00 (Windows)
...
private:
	static const System::Byte DefaultAnsiDataSize = System::Byte(0x80);
	
	static const System::Word DefaultWideDataSize = System::Word(0x100);
...
private:
	...
	static const System::Word TokenDatabase = System::Word(0x1f4);
	
	static const System::Word TokenTable = System::Word(0x1f5);
	
	static const System::Word TokenView = System::Word(0x1f6);
	
	static const System::Word TokenSystemTable = System::Word(0x1f7);
	
	static const System::Word TokenSystemView = System::Word(0x1f8);
	
	static const System::Word TokenSynonym = System::Word(0x1f9);
	
	static const System::Word TokenProcedureType = System::Word(0x1fa);
	
	static const System::Word TokenFunctionType = System::Word(0x1fb);
	
	static const System::Word TokenPrimaryKey = System::Word(0x1fc);
	
	static const System::Word TokenForeignKey = System::Word(0x1fd);
...
public:
	static const System::Int8 Table = System::Int8(0x1);
	
	static const System::Int8 View = System::Int8(0x2);
	
	static const System::Int8 SystemTable = System::Int8(0x4);
	
	static const System::Int8 SystemView = System::Int8(0x8);
	
	static const System::Int8 Synonym = System::Int8(0x10);
	
	static const System::Int8 All = System::Int8(0x1f);
...
public:
	static const System::Int8 AutoIncrementable = System::Int8(0x1);
	
	static const System::Int8 BestMatch = System::Int8(0x2);
	
	static const System::Int8 FixedLength = System::Int8(0x4);
	
	static const System::Int8 CaseSensitive = System::Int8(0x8);
	
	static const System::Int8 FixedPrecisionScale = System::Int8(0x10);
	
	static const System::Int8 Long = System::Int8(0x20);
	
	static const System::Int8 Nullable = System::Int8(0x40);
	
	static const System::Byte Searchable = System::Byte(0x80);
	
	static const System::Word SearchableWithLike = System::Word(0x100);
	
	static const System::Word Unsigned = System::Word(0x200);
	
	static const System::Word ConcurrencyType = System::Word(0x400);
	
	static const System::Word LiteralSupported = System::Word(0x800);
	
	static const System::Word Unicode = System::Word(0x1000);
	
	static const System::Word UnicodeOption = System::Word(0x2000);
	
	static const System::Word UnsignedOption = System::Word(0x4000);
	
	static const System::Word StringOption = System::Word(0x8000);
	
	static const int LongOption = int(0x10000);
