...
// (DO NOT EDIT: machine generated header) 'REST.Backend.EMSPushDevice.pas' rev: 34.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "REST.Backend.EMSPushDevice"
...
private:
	#define TEMSPushDeviceAPI_sEMS L"EMS"
