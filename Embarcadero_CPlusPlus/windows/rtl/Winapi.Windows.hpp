...
// (DO NOT EDIT: machine generated header) 'Winapi.Windows.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
typedef _SINGLE_LIST_ENTRY TListEntry;
#else /* _WIN64 */
typedef _SLIST_ENTRY TListEntry;
#endif /* _WIN64 */

typedef PSLIST_ENTRY PListEntry;
...
typedef _SLIST_HEADER TListHeader;

typedef PSLIST_HEADER PListHeader;
...
typedef tagNEWTEXTMETRICEXW NEWTEXTMETRICEX;
...
typedef tagACTCTXW tagACTCTX;

typedef tagACTCTXW ACTCTX;
