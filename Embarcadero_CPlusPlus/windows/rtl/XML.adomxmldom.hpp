...
// (DO NOT EDIT: machine generated header) 'Xml.adomxmldom.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
typedef System::TMetaClass* Tox4DOMNodeClass;
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
#define sAdom4XmlVendor L"ADOM XML v4"
