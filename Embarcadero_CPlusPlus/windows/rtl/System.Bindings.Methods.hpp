...
// (DO NOT EDIT: machine generated header) 'System.Bindings.Methods.pas' rev: 34.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "System.Bindings.Methods"
...
{
#ifndef _WIN64
	virtual System::Bindings::Evalprotocol::_di_IValue __fastcall Invoke(System::DynamicArray<System::Bindings::Evalprotocol::_di_IValue> Args) = 0 ;
#else /* _WIN64 */
