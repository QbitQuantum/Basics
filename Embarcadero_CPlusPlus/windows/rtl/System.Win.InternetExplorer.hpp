...
// (DO NOT EDIT: machine generated header) 'System.Win.InternetExplorer.pas' rev: 34.00 (Windows)

#ifndef System_Win_InternetexplorerHPP
#define System_Win_InternetexplorerHPP
...
#include <System.Win.OleServers.hpp>
...
class DELPHICLASS TOleWebBrowser;
...
__interface  INTERFACE_UUID("{0002DF05-0000-0000-C000-000000000046}") IWebBrowserApp  : public IWebBrowser 
{
	...
	virtual HRESULT __safecall Get_HWND_(HWND &__Get_HWND__result) = 0 ;
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline HWND _scw_Get_HWND_() { HWND __r; HRESULT __hr = Get_HWND_(__r); System::CheckSafecallResult(__hr); return __r; }
	#pragma option pop
	__property HWND HWND_ = {read=_scw_Get_HWND_};
	#pragma option push -w-inl
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TOleWebBrowser : public System::Win::Olecontrols::TDelegatedOleControl
{
	typedef System::Win::Olecontrols::TDelegatedOleControl inherited;
...
private:
	...
	System::WordBool __fastcall GetVisible();
	void __fastcall SetVisible(const System::WordBool Value);
...
public:
	...
	__property System::WordBool TopLevelContainer = {read=GetWordBoolProp, index=204, nodefault};
	__property System::WideString type_ = {read=GetWideStringProp, index=205};
...
#ifndef _WIN64
	__property HWND HWND_ = {read=Get_HWND_, nodefault};
#else /* _WIN64 */
	__property HWND HWND_ = {read=Get_HWND_};
#endif /* _WIN64 */
...
__published:
	__property System::WordBool Visible = {read=GetVisible, write=SetVisible, stored=false, nodefault};
	__property System::WordBool StatusBar = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=403, nodefault};
	...
	__property System::WordBool MenuBar = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=406, nodefault};
	__property System::WordBool FullScreen = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=407, nodefault};
	__property System::WordBool Offline = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=550, nodefault};
	__property System::WordBool Silent = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=551, nodefault};
	...
	__property System::WordBool TheaterMode = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=554, nodefault};
	__property System::WordBool AddressBar = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=555, nodefault};
	__property System::WordBool Resizable = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, index=556, nodefault};
...
public:
	/* TDelegatedOleControl.Create */ inline __fastcall TOleWebBrowser(System::Win::Olecontrols::_di_IOLEFrameworkDelegate ADelegate) : System::Win::Olecontrols::TDelegatedOleControl(ADelegate) { }
	/* TDelegatedOleControl.Destroy */ inline __fastcall virtual ~TOleWebBrowser() { }
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TInternetExplorer : public System::Win::Oleservers::TOleServer
{
	typedef System::Win::Oleservers::TOleServer inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TInternetExplorerMedium : public System::Win::Oleservers::TOleServer
{
	typedef System::Win::Oleservers::TOleServer inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TShellWindows : public System::Win::Oleservers::TOleServer
{
	typedef System::Win::Oleservers::TOleServer inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TShellUIHelper : public System::Win::Oleservers::TOleServer
{
	typedef System::Win::Oleservers::TOleServer inherited;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TShellNameSpace : public System::Win::Oleservers::TOleServer
{
	typedef System::Win::Oleservers::TOleServer inherited;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYSTEM_WIN_INTERNETEXPLORER)
using namespace System::Win::Internetexplorer;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// System_Win_InternetexplorerHPP
