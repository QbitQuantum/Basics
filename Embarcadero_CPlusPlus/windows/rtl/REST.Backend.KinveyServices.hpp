...
// (DO NOT EDIT: machine generated header) 'REST.Backend.KinveyServices.pas' rev: 34.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "REST.Backend.KinveyServices"
...
protected:
	...
	void __fastcall QueryObjects(const Rest::Backend::Metatypes::TBackendClassValue AClass, const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray, /* out */ System::DynamicArray<Rest::Backend::Metatypes::TBackendEntityValue> &AObjects)/* overload */;
#else /* _WIN64 */
	void __fastcall QueryObjects(const Rest::Backend::Metatypes::TBackendClassValue &AClass, const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray)/* overload */;
