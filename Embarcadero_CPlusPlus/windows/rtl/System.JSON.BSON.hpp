...
// (DO NOT EDIT: machine generated header) 'System.JSON.BSON.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	void __fastcall WriteBytes(const System::DynamicArray<System::Byte> Value, System::Json::Types::TJsonBinaryType BinaryType);
#else /* _WIN64 */
...
private:
	static const System::Byte MaxCharBytesSize = System::Byte(0x80);
	
	#define TBsonReader_CodeWScopeKey L"$code"
	...
	System::DynamicArray<System::WideChar> FCharBuffer;
#else /* _WIN64 */
...
#ifndef _WIN64
	System::DynamicArray<System::Byte> __fastcall ReadBinary(/* out */ System::Json::Types::TJsonBinaryType &BinaryType);
	System::DynamicArray<System::Byte> __fastcall ReadBytes(int Count);
#else /* _WIN64 */
