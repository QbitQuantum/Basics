...
// (DO NOT EDIT: machine generated header) 'System.Generics.Collections.pas' rev: 34.00 (Windows)
...
template<typename TKey, typename TValue> struct TPair__2;
...
template<typename TKey, typename TValue> class DELPHICLASS TObjectDictionary__2;
...
private:
	...
	__property int FCount = {read=FListHelper.FCount, write=FListHelper.FCount, nodefault};
...
public:
	...
	virtual System::TArray__1<T> __fastcall ToArray() _FINAL_ATTRIBUTE;
#endif /* _WIN64 */
	__property int Count = {read=FStackHelper.FLH.FCount, nodefault};
	__property arrayOfT List = {read=GetList};
	__property int Capacity = {read=GetCapacity, write=DoSetCapacity, nodefault};
#ifndef _WIN64
...
{
	typedef TEnumerable__1<TPair__2<TKey,TValue> > inherited;
...
public:
	...
	// used only for accessing Delphi variables and fields.
	// Don't instantiate with new type parameters in user code.
	class PASCALIMPLEMENTATION TPairEnumerator : public TEnumerator__1<TPair__2<TKey,TValue> >
	{
		typedef TEnumerator__1<TPair__2<TKey,TValue> > inherited;
		
	private:
		TDictionary__2<TKey,TValue>* FDictionary;
		int FIndex;
		TPair__2<TKey,TValue> __fastcall GetCurrent();
		
	protected:
		virtual TPair__2<TKey,TValue> __fastcall DoGetCurrent();
		virtual bool __fastcall DoMoveNext();
	...
	{
		typedef TEnumerator__1<TKey> inherited;
		
	private:
		TDictionary__2<TKey,TValue>* FDictionary;
		int FIndex;
		TKey __fastcall GetCurrent();
	...
	{
		typedef TEnumerator__1<TValue> inherited;
		
	private:
		TDictionary__2<TKey,TValue>* FDictionary;
		int FIndex;
		TValue __fastcall GetCurrent();
	...
	{
		typedef TEnumerable__1<TValue> inherited;
...
#else /* _WIN64 */
		virtual System::TArray__1<TValue> __fastcall ToArray() _FINAL_ATTRIBUTE;
#endif /* _WIN64 */
		__property int Count = {read=GetCount, nodefault};
	public:
		/* {System_Generics_Collections}TEnumerable<System_Generics_Collections_TDictionary<TKey,TValue>_TValue>.Destroy */ inline __fastcall virtual ~TValueCollection() { }
	...
	{
		typedef TEnumerable__1<TKey> inherited;
...
#else /* _WIN64 */
		virtual System::TArray__1<TKey> __fastcall ToArray() _FINAL_ATTRIBUTE;
#endif /* _WIN64 */
		__property int Count = {read=GetCount, nodefault};
	public:
		/* {System_Generics_Collections}TEnumerable<System_Generics_Collections_TDictionary<TKey,TValue>_TKey>.Destroy */ inline __fastcall virtual ~TKeyCollection() { }
...
private:
	...
	TValue __fastcall DoRemove(const TKey Key, int HashCode, TCollectionNotification Notification);
	int __fastcall GetCapacity();
	void __fastcall SetCapacity(const int Value);
	
protected:
	virtual TEnumerator__1<TPair__2<TKey,TValue> >* __fastcall DoGetEnumerator();
	virtual void __fastcall KeyNotify(const TKey Key, TCollectionNotification Action);
...
public:
	...
	void __fastcall Clear();
	void __fastcall TrimExcess();
	bool __fastcall TryGetValue(const TKey Key, TValue &Value);
...
#ifndef _WIN64
	virtual System::DynamicArray<TPair__2<TKey,TValue> > __fastcall ToArray() _FINAL_ATTRIBUTE;
#else /* _WIN64 */
	virtual System::TArray__1<TPair__2<TKey,TValue> > __fastcall ToArray() _FINAL_ATTRIBUTE;
#endif /* _WIN64 */
	__property int Capacity = {read=GetCapacity, write=SetCapacity, nodefault};
...
private:
#ifndef _WIN64
	typedef void __fastcall (__closure *_dt_System_Generics_Collections_8)(System::TObject* Sender, const TKey Item, TCollectionNotification Action);
	_dt_System_Generics_Collections_8 FOnKeyNotify;
	typedef void __fastcall (__closure *_dt_System_Generics_Collections_9)(System::TObject* Sender, const TValue Item, TCollectionNotification Action);
	_dt_System_Generics_Collections_9 FOnValueNotify;
#else /* _WIN64 */
	TCollectionNotifyEvent__1<TKey> FOnKeyNotify;
	TCollectionNotifyEvent__1<TValue> FOnValueNotify;
#endif /* _WIN64 */
...
public:
	...
	__property System::DelphiInterface<System::Generics::Defaults::IEqualityComparer__1<TKey> > Comparer = {read=FComparer};
#ifndef _WIN64
	typedef void __fastcall (__closure *_dt_System_Generics_Collections_10)(System::TObject* Sender, const TKey Item, TCollectionNotification Action);
	__property _dt_System_Generics_Collections_10 OnKeyNotify = {read=FOnKeyNotify, write=FOnKeyNotify};
	typedef void __fastcall (__closure *_dt_System_Generics_Collections_11)(System::TObject* Sender, const TValue Item, TCollectionNotification Action);
	__property _dt_System_Generics_Collections_11 OnValueNotify = {read=FOnValueNotify, write=FOnValueNotify};
#else /* _WIN64 */
	__property TCollectionNotifyEvent__1<TKey> OnKeyNotify = {read=FOnKeyNotify, write=FOnKeyNotify};
	__property TCollectionNotifyEvent__1<TValue> OnValueNotify = {read=FOnValueNotify, write=FOnValueNotify};
#endif /* _WIN64 */
};
...
{
	typedef TDictionary__2<TKey,TValue> inherited;
