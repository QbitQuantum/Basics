...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.MSSQLCli.pas' rev: 34.00 (Windows)
...
#else /* _WIN64 */
typedef NativeUInt __stdcall (*TMSSQLOpenSqlFilestream)(System::WideChar * FilestreamPath, unsigned DesiredAccess, unsigned OpenOptions, System::PByte FilestreamTransactionContext, unsigned __int64 FilestreamTransactionContextLength, System::PInt64 AllocationSize);
#endif /* _WIN64 */
...
static const int FSCTL_SQL_FILESTREAM_FETCH_OLD_CONTENT = int(0x92560);
}	/* namespace Mssqlcli */
}	/* namespace Phys */
}	/* namespace Firedac */
