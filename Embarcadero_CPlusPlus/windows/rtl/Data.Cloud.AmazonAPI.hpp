...
// (DO NOT EDIT: machine generated header) 'Data.Cloud.AmazonAPI.pas' rev: 34.00 (Windows)
...
public:
	#define TAmazonAuthentication_AuthorizationType L"AWS"
...
public:
	#define TAmazonAWS4Authentication_AuthorizationType L"AWS4-HMAC-SHA256"
...
public:
	#define TAmazonSHA1Authentication_AuthorizationType L"AWS"
...
public:
	#define TAmazonConnectionInfo_DefaultStorageEndpoint L"s3.amazonaws.com"
	
	#define TAmazonConnectionInfo_DefaultTableEndpoint L"sdb.amazonaws.com"
	
	#define TAmazonConnectionInfo_DefaultQueueEndpoint L"sqs.amazonaws.com"
	
	#define TAmazonConnectionInfo_RegionStorageEndpoint L"s3.%s.amazonaws.com"
	
	#define TAmazonConnectionInfo_RegionTableEndpoint L"sdb.%s.amazonaws.com"
	
	#define TAmazonConnectionInfo_RegionQueueEndpoint L"sqs.%s.amazonaws.com"
	
	#define TAmazonConnectionInfo_DefaultRegion L"us-east-1"
...
#ifndef _WIN64
	typedef System::DynamicArray<System::Generics::Collections::TPair__2<TAmazonQueueAttribute,System::UnicodeString> > TQueueAttributePairs;
#else /* _WIN64 */
...
#ifndef _WIN64
	System::DynamicArray<System::UnicodeString> __fastcall SendMessageBatch(const System::UnicodeString AQueueURL, System::DynamicArray<System::UnicodeString> AMessageList, Data::Cloud::Cloudapi::TCloudResponseInfo* const AResponseInfo);
#else /* _WIN64 */
...
#ifndef _WIN64
	bool __fastcall DeleteMessageBatch(const System::UnicodeString AQueueURL, const System::DynamicArray<System::UnicodeString> APopReceiptList, Data::Cloud::Cloudapi::TCloudResponseInfo* const AResponseInfo);
#else /* _WIN64 */
...
#ifndef _WIN64
	bool __fastcall ChangeMessageVisibilityBatch(const System::UnicodeString AQueueURL, System::DynamicArray<System::Generics::Collections::TPair__2<System::UnicodeString,int> > AMessageInfoList, Data::Cloud::Cloudapi::TCloudResponseInfo* const AResponseInfo);
	System::DynamicArray<System::UnicodeString> __fastcall ListDeadLetterSourceQueues(const System::UnicodeString AQueueURL, Data::Cloud::Cloudapi::TCloudResponseInfo* const AResponseInfo);
#else /* _WIN64 */
...
public:
	#define TAmazonBucketLoggingInfo_LogXMLPrefix L"<?xml version=\"1.0\"?><BucketLoggingStatus xmlns=\"http:/"\
		L"/doc.s3.amazonaws.com/2006-03-01\">"
	
	#define TAmazonBucketLoggingInfo_LogXMLSuffix L"</BucketLoggingStatus>"
...
//-- var, const, procedure ---------------------------------------------------
#define amzrNotSpecified L""
#define amzrEUWest1 L"eu-west-1"
#define amzrEUWest2 L"eu-west-2"
#define amzrEUWest3 L"eu-west-3"
#define amzrEUCentral1 L"eu-central-1"
#define amzrUSEast1 L"us-east-1"
#define amzrUSEast2 L"us-east-2"
#define amzrUSWest1 L"us-west-1"
#define amzrUSWest2 L"us-west-2"
#define amzrAPEast1 L"ap-east-1"
#define amzrAPSouth1 L"ap-south-1"
#define amzrAPSoutheast1 L"ap-southeast-1"
#define amzrAPSoutheast2 L"ap-southeast-2"
#define amzrAPNortheast1 L"ap-northeast-1"
#define amzrAPNortheast2 L"ap-northeast-2"
#define amzrAPNortheast3 L"ap-northeast-3"
#define amzrCACentral1 L"ca-central-1"
#define amzrSAEast1 L"sa-east-1"
#define amzrUSClassic L"us-east-1"
#define amzrEU L"eu-west-1"
#define amzrCNNorth1 L"cn-north-1"
#define amzrCNNorthwest1 L"cn-northwest-1"
#define azmrEUNorth1 L"eu-north-1"
#define azmrMESouth1 L"me-south-1"
#define TABLE_ROW_DATATYPE_REPLACE L"replace"
#define TABLE_ROW_DATATYPE_DO_NOT_REPLACE L"noreplace"
#define ALL_USERS_GROUP L"http://acs.amazonaws.com/groups/global/AllUsers"
#define ALL_AUTHENTICATED_USERS_GROUP L"http://acs.amazonaws.com/groups/global/AuthenticatedUsers"
#define LOG_DELIVERY_GROUP L"http://acs.amazonaws.com/groups/s3/LogDelivery"
}	/* namespace Amazonapi */
}	/* namespace Cloud */
}	/* namespace Data */
