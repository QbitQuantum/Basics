...
// (DO NOT EDIT: machine generated header) 'Soap.InvokeRegistry.pas' rev: 34.00 (Windows)
...
typedef System::DynamicArray<unsigned> TLongWordSOAPArray;
...
#ifndef _WIN64
typedef System::TMetaClass* TInvokableClassClass;
#else /* _WIN64 */
