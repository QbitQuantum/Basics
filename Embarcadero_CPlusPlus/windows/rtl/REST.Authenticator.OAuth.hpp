...
// (DO NOT EDIT: machine generated header) 'REST.Authenticator.OAuth.pas' rev: 34.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "REST.Authenticator.OAuth"
...
#ifndef _WIN64
typedef System::TMetaClass* TOAuth1SignatureMethodClass;
#else /* _WIN64 */
