...
// (DO NOT EDIT: machine generated header) 'System.Win.OleServers.pas' rev: 34.00 (Windows)

#ifndef System_Win_OleserversHPP
#define System_Win_OleserversHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYSTEM_WIN_OLESERVERS)
using namespace System::Win::Oleservers;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// System_Win_OleserversHPP
