...
#define _DECLARE_ANSISTRING_TYPE_ALIAS(Alias, CP) \
  ...
  public:                                         \
    using _BaseAnsiStringType  = AnsiStringT<CP>;   \
    using _BaseAnsiStringType::_BaseAnsiStringType; \
    ~Alias() {}                                     \
  };

  _DECLARE_ANSISTRING_TYPE_ALIAS(RawByteString, 65535);
  _DECLARE_ANSISTRING_TYPE_ALIAS(UTF8String, 65001);
