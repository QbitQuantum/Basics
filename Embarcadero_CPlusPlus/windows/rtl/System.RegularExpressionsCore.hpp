...
// (DO NOT EDIT: machine generated header) 'System.RegularExpressionsCore.pas' rev: 34.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef System::UnicodeString PCREString;
...
private:
	...
	void __fastcall SetFSubject(const System::UnicodeString Value);
	...
	int __fastcall InternalNamedGroup(const System::UnicodeString Name);
...
//-- var, const, procedure ---------------------------------------------------
static const System::Int8 MAX_SUBEXPRESSIONS = System::Int8(0x63);
}	/* namespace Regularexpressionscore */
}	/* namespace System */
