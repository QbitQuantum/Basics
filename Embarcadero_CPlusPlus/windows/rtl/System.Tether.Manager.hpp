...
// (DO NOT EDIT: machine generated header) 'System.Tether.Manager.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
typedef System::DynamicArray<System::UnicodeString> TTetheringProfileTypes;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::UnicodeString> TTetheringProtocolTypes;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::UnicodeString> TTetheringAdapterTypes;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Generics::Collections::TPair__2<System::UnicodeString,System::UnicodeString> > TTetheringProtocolAdapterTypes;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::UnicodeString> TTetheringTargetHosts;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<TTetheringAllowedConnection> TTetheringAllowedConnections;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::Byte> _dt_System_Tether_Manager_1;
...
private:
	...
	public:
		...
		/* TThread.Create */ inline __fastcall TThreadTimer(bool CreateSuspended, NativeUInt ReservedStackSize)/* overload */ : System::Classes::TThread(CreateSuspended, ReservedStackSize) { }
...
#ifndef _WIN64
typedef System::TMetaClass* TTetheringAdapterClass;
#else /* _WIN64 */
...
#ifndef _WIN64
	static System::DynamicArray<System::UnicodeString> __fastcall GetAdapterTypes();
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<TTetheringCommand> TTetheringCommands;
#else /* _WIN64 */
typedef System::TArray__1<TTetheringCommand> TTetheringCommands;
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::DynamicArray<TTetheringCommand> _dt_System_Tether_Manager_2;
...
#ifndef _WIN64
typedef System::TMetaClass* TTetheringProtocolClass;
#else /* _WIN64 */
...
#ifndef _WIN64
	static System::DynamicArray<System::UnicodeString> __fastcall GetProtocolTypes();
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::DynamicArray<System::UnicodeString> TTetheringParams;
#else /* _WIN64 */
...
protected:
	#define TTetheringManagerCommunicationThread_TetheringDiscoverManagers L"TetheringDiscoverManagers"
	
	#define TTetheringManagerCommunicationThread_TetheringServerDiscovered L"TetheringServerDiscovered"
	
	#define TTetheringManagerCommunicationThread_TetheringDiscoverProfiles L"TetheringDiscoverProfiles"
	
	#define TTetheringManagerCommunicationThread_TetheringBeginProfiles L"TetheringBeginProfiles"
	
	#define TTetheringManagerCommunicationThread_TetheringEndProfiles L"TetheringEndProfiles"
	
	#define TTetheringManagerCommunicationThread_TetheringRequestPair L"TetheringRequestPair"
	
	#define TTetheringManagerCommunicationThread_TetheringRequestUnPair L"TetheringRequestUnPair"
	
	#define TTetheringManagerCommunicationThread_TetheringRequestPassword L"TetheringRequestPassword"
	
	#define TTetheringManagerCommunicationThread_TetheringPassword L"TetheringPassword"
	
	#define TTetheringManagerCommunicationThread_TetheringPairAccepted L"TetheringPairAccepted"
	
	#define TTetheringManagerCommunicationThread_TetheringPairDenied L"TetheringPairDenied"
	
	#define TTetheringManagerCommunicationThread_TetheringNotification L"TetheringNotification"
	
	#define TTetheringManagerCommunicationThread_TetheringPairingToken L"TetheringPairingToken"
	
	#define TTetheringManagerCommunicationThread_TetheringGeneratedToken L"TetheringGeneratedToken"
	
	#define TTetheringManagerCommunicationThread_EMPTYTOKEN L"EMPTYTOKEN"
	
	#define TTetheringManagerCommunicationThread_TetheringOk L"Ok"
	
	#define TTetheringManagerCommunicationThread_TetheringError L"Error"
	
	#define TTetheringManagerCommunicationThread_TetheringEmpty L""
	
	static const System::WideChar TetheringVersion = (System::WideChar)(0x31);
...
#ifndef _WIN64
	System::DynamicArray<System::UnicodeString> FAllowedAdapters;
#else /* _WIN64 */
...
#ifndef _WIN64
	static bool __fastcall IsInArray(const System::UnicodeString AItem, const System::DynamicArray<System::UnicodeString> AnArray);
#else /* _WIN64 */
...
public:
	...
	void __fastcall DiscoverManagersFiltered(const System::DynamicArray<System::UnicodeString> AProfileGroups, const System::DynamicArray<System::UnicodeString> AProfileTexts, const System::UnicodeString ATarget = System::UnicodeString())/* overload */;
	void __fastcall DiscoverManagersFiltered(const System::DynamicArray<System::UnicodeString> AProfileGroups, const System::DynamicArray<System::UnicodeString> AProfileTexts, unsigned Timeout, const System::UnicodeString ATarget = System::UnicodeString())/* overload */;
	void __fastcall DiscoverManagersFiltered(const System::DynamicArray<System::UnicodeString> AProfileGroups, const System::DynamicArray<System::UnicodeString> AProfileTexts, const System::DynamicArray<System::UnicodeString> ATargetList)/* overload */;
	void __fastcall DiscoverManagersFiltered(const System::DynamicArray<System::UnicodeString> AProfileGroups, const System::DynamicArray<System::UnicodeString> AProfileTexts, unsigned Timeout, const System::DynamicArray<System::UnicodeString> ATargetList)/* overload */;
#else /* _WIN64 */
...
private:
	...
	System::UnicodeString FIdentifier;
#ifndef _WIN64
	System::DynamicArray<System::Generics::Collections::TPair__2<System::UnicodeString,System::UnicodeString> > FImplementedProtocolAdapters;
#else /* _WIN64 */
...
#ifndef _WIN64
	void __fastcall SetImplementedProtocols(const System::DynamicArray<System::Generics::Collections::TPair__2<System::UnicodeString,System::UnicodeString> > Value);
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual __classmethod System::DynamicArray<System::Generics::Collections::TPair__2<System::UnicodeString,System::UnicodeString> > __fastcall GetAllowedProtocolsAdapters() = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::TMetaClass* TTetheringProfileClass;
#else /* _WIN64 */
...
#ifndef _WIN64
	static System::DynamicArray<System::UnicodeString> __fastcall GetProfiles();
#else /* _WIN64 */
