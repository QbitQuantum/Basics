...
// (DO NOT EDIT: machine generated header) 'Data.DBXTrace.pas' rev: 34.00 (Windows)
...
class DELPHICLASS TDBXDebugStrTraceOutput;
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TDBXDebugStrTraceOutput : public TDBXTraceOutput
{
...
public:
	/* TDBXTraceOutput.Create */ inline __fastcall TDBXDebugStrTraceOutput() : TDBXTraceOutput() { }
	/* TDBXTraceOutput.Destroy */ inline __fastcall virtual ~TDBXDebugStrTraceOutput() { }
...
#define sConsoleOutput L":con"
#define sDebugStrOutput L":dbgstr"
}	/* namespace Dbxtrace */
}	/* namespace Data */
