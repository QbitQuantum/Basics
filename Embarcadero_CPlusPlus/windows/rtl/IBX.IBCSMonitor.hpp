...
// (DO NOT EDIT: machine generated header) 'IBX.IBCSMonitor.pas' rev: 34.00 (Windows)
...
private:
#ifndef _WIN64
	System::Generics::Collections::TThreadList__1<System::DynamicArray<System::Byte> >* FQueue;
#else /* _WIN64 */
...
#ifndef _WIN64
	void __fastcall AddMsgToQueue(const System::DynamicArray<System::Byte> Msg);
	System::Generics::Collections::TList__1<System::DynamicArray<System::Byte> >* __fastcall GetQueuedMsgs();
#else /* _WIN64 */
