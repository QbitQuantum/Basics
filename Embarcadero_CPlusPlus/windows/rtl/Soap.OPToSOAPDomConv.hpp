...
// (DO NOT EDIT: machine generated header) 'Soap.OPToSOAPDomConv.pas' rev: 34.00 (Windows)
...
#ifndef _WIN64
	static bool __fastcall HasMultipleElemNamespaces(const System::TClass ClsType, /* out */ Soap::Invokeregistry::InvStringDynArray &PropNamespaces, /* out */ System::DynamicArray<int> &PropNamespaceIndex);
#else /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
#define SVarArrayType L"VarArrayType"
