...
// (DO NOT EDIT: machine generated header) 'REST.Backend.ParsePushDevice.pas' rev: 34.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "REST.Backend.ParsePushDevice"
...
private:
	#define TParsePushDeviceAPI_sParse L"Parse"
