...
// (DO NOT EDIT: machine generated header) 'Xml.Internal.AdomCore_4_3.pas' rev: 34.00 (Windows)
...
protected:
	...
	virtual void __fastcall SetIncludeXmlDecl(const bool Value);
	virtual void __fastcall SetUseActiveCodePage(const bool Value);
...
__published:
	...
	__property bool UseActiveCodePage = {read=FUseActiveCodePage, write=SetUseActiveCodePage, default=0};
...
static const int AS_UNBOUNDED = int(2147483647);
