...
void _Mtxunlock(_Rmtx *);
 ...
 #else /* _IS_WRS */
_CRTIMP2P void _Mtxinit(_Rmtx *);
_CRTIMP2P void _Mtxdst(_Rmtx *);
_CRTIMP2P void _Mtxlock(_Rmtx *);
_CRTIMP2P void _Mtxunlock(_Rmtx *);
 #endif /* _IS_WRS */
...
void __clrcall _Once(_Once_t *, void (__cdecl *)(void));
  ...
  #else /* _M_CEE_PURE */
_MRTIMP2 void _Once(_Once_t *, void (__cdecl *)(void));
  #endif /* _M_CEE_PURE */
