...
unsigned int Quad(double *, int);
unsigned int Quadph(double *, double);
...
unsigned int FQuad(float *, int);
unsigned int FQuadph(float *, float);
...
unsigned int LQuad(long double *, int);
unsigned int LQuadph(long double *, long double);
