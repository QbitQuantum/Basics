...
#if !defined(__clang__) && !defined(__EDG__) // TRANSITION, unknown C1XX bug (was DevCom-1331017, fixed in VS2022)
...
#endif // TRANSITION, unknown C1XX bug (was DevCom-1331017, fixed in VS2022)
