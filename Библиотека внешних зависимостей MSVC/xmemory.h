...
private:
    ...
    _CONSTEXPR20_CONTAINER void _Orphan_me_unlocked_v3() noexcept {
...
_CONSTEXPR20_CONTAINER void _Container_base12::_Orphan_all_unlocked_v3() noexcept {
...
struct _Alloc_temporary2 {
    ...
    _NODISCARD _CONSTEXPR20_CONTAINER value_type& _Get_value() noexcept {
        return _Storage._Value;
    }

    _NODISCARD _CONSTEXPR20_CONTAINER const value_type& _Get_value() const noexcept {
        return _Storage._Value;
    }
    ...
    _CONSTEXPR20_CONTAINER explicit _Alloc_temporary2(_Alloc& _Al_, _Args&&... _Vals) noexcept(
    ...
    _CONSTEXPR20_CONTAINER ~_Alloc_temporary2() {
