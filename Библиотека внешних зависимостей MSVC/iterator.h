...
public:
    constexpr common_iterator() requires default_initializable<_Iter>
    = default;
    ...
    friend constexpr void iter_swap(const common_iterator& _Left, const common_iterator<_OIter, _OSe>& _Right) noexcept(
        ...
        _STL_VERIFY(_Left._Val._Contains == _Variantish_state::_Holds_iter
                        && _Right_val._Contains == _Variantish_state::_Holds_iter,
...
public:
    ...
    // [counted.iter.const]
    constexpr counted_iterator() requires default_initializable<_Iter>
    = default;
